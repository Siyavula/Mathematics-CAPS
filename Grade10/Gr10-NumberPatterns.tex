...
So for each table added, the number of people increased by $2$.}%\end{wex}
...
In some sequences, there is a constant difference between any two successive terms. 
\\This is called a \textit{common difference}.
...
\begin{wex}{Study table continued...}{As before, you and $3$ friends are studying for Maths and are sitting together at a square table. 
...
\\
Find the expression for the number of people seated at $n$ tables. \\
Use the general formula to determine how many people can sit around twelve tables.\\
How many tables are needed to seat $20$ people?\\}{
...
How many people can sit around $12$ tables? We are calculating $T_{12}$, where $n = 12$:
\begin{eqnarray*}
...
In mathematics, a conjecture is a mathematical statement which appears to be true, but has not been formally proven. 
...
\\ For example: make a conjecture about the next number in the pattern $2;~6;~11;~17;\ldots$\\
The terms increase by $4$, then $5$, and then $6$.\\
...
\westep{Express algebraically}
Any two-digit number can be written as $10a+b$. For example $34= 10(3)+4$ \\
Any three-digit number can be written as $100a+10b+c$. For example $582=100(5)+ 10(8) +2$\\
\begin{equation*}
...
\item There are several special sequences of numbers: 
    \begin{itemize}[noitemsep]
    \item Triangular numbers  $1;~3;~6;~10;~15;~21;~28;~36;~45;~...$\
    ...
    \end{itemize}
\item The general term is expressed as the ${n}^{th}$ term and written as ${T}_{n}$
