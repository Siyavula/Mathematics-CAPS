...
\mindsetvid{finding the nth term}{VMarr}
...
\westep{Calculate the $12^{th}$ term, in other words, find $T_n$ if $n=12$}
...
\mindsetvid{from patterns to introducing functions}{VMasj}
