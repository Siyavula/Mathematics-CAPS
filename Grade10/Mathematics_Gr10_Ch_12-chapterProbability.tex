...
the sample space.\par 
    ...
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m39377*uid12!!!underscore!!!media}\label{m39377*uid12!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39377_MG10C17_001.png} % m39377;MG10C17\_001.png;;;6.0;8.5;
...
statistical experiment and an event is a subset of the sample space.
 ...
 \end{figure}   
    ...
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m39377*uid1211!!!underscore!!!media}\label{m39377*uid1211!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39377_venn1.png} % m39377;venn1.png;;;6.0;8.5;
 ...
 \end{figure}   
    ...
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m39377*uid1222!!!underscore!!!media}\label{m39377*uid1222!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39377_venn2.png} % m39377;venn2.png;;;6.0;8.5;
...
\begin{tabular}{cc}
    ...
    \begin{center}
    \label{m39377*id7888!!!underscore!!!media}\label{m39377*id7888!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39377_venn_ifact.png} % m39377;venn\_ifact.png;;;6.0;8.5;
...
union and intersection between events in a sample space (Figure~11.5 and Figure~11.6).\par 
    ...
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m39377*uid13!!!underscore!!!media}\label{m39377*uid13!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39377_union.png} % m39377;union.png;;;6.0;8.5;
 ...
 \end{figure}   
    ...
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m39377*uid1381!!!underscore!!!media}\label{m39377*uid1381!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39377_intersect.png} % m39377;intersect.png;;;6.0;8.5;
...
\}\end{math}\end{itemize}
    ...
    \begin{center}
    \label{m39377*id110668!!!underscore!!!media}\label{m39377*id110668!!!underscore!!!printimage}\includegraphics{col11306.imgs/m39377_MG10C17_003.png} % ;MG10C17\_003.png;;;6.0;8.5;
...
We draw the following diagram to represent the data:
    ...
    \begin{center}
    \label{m39377*id1368!!!underscore!!!media}\label{m39377*id1368!!!underscore!!!printimage}\includegraphics{col11306.imgs/m39377_Vennwex1.png} % ;Vennwex1.png;;;6.0;8.5;
...
We can redraw the part of the Venn diagram that is of interest:
    ...
    \begin{center}
    \label{m39377*id533!!!underscore!!!media}\label{m39377*id533!!!underscore!!!printimage}\includegraphics{col11306.imgs/m39377_Vennwex2.png} % ;Vennwex2.png;;;6.0;8.5;
...
The Venn diagram with that represents all this information is given:
    ...
    \begin{center}
    \label{m39377*id1106!!!underscore!!!media}\label{m39377*id1106!!!underscore!!!printimage}\includegraphics{col11306.imgs/m39377_Vennwex3.png} % ;Vennwex3.png;;;6.0;8.5;
...
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 ...
 (1.) lqu  &  (2.) lqJ  &  (3.) lqS  & \end{tabular}
            ...
            \subsubsection{ Probability Identities}
            \nopagebreak
...
\label{m39377*eip-41}We can demonstrate this last result using a Venn diagram. The union of A and B is the set of all elements in A or in B or in both.
    ...
    \begin{center}
    \label{m39377*uid743!!!underscore!!!media}\label{m39377*uid743!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39377_venn1.png} % m39377;venn1.png;;;6.0;8.5;
...
\par \label{m39377*eip-227}The probability of event A occurring is given by \begin{math}\mathrm{P\left(A\right)}\end{math} and the probability of event B occurring is given by \begin{math}\mathrm{P\left(B\right)}\end{math}. However, if we look closely at the circle representing either of these events, we notice that the probability includes a small part of the other event. So event A includes a bit of event B and vice versa. This is shown in the following figure:
    ...
    \begin{center}
    \label{m39377*id1112!!!underscore!!!media}\label{m39377*id1112!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39377_identity1.png} % m39377;identity1.png;;;6.0;8.5;
...
\label{m39377*eip-366}We can represent mutually exclusive events on a Venn diagram. In this case, the two circles do not touch each other, but are instead completely separate parts of the sample space.
    ...
    \begin{center}
    \label{m39377*id6899!!!underscore!!!media}\label{m39377*id6899!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39377_mutualexclusive.png} % m39377;mutualexclusive.png;;;6.0;8.5;
...
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 ...
 (1.) lqe  &  (2.) lqt  &  (3.) lqz  & \end{tabular}
    ...
    \label{m39373*cid5}
            \subsection{ Relative Frequency \textsl{vs.}
Probability}
            \nopagebreak
...
\label{m39373*secfhsst!!!underscore!!!id1154}
            \subsection{ Interpretation of Probability Values - (not in CAPS, included for completeness)}
            \nopagebreak
...
\label{m39373*uid14547}
    \begin{center}
    \label{m39373*uid14547!!!underscore!!!media}\label{m39373*uid14547!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39373_union.png} % m39373;union.png;;;6.0;8.5;
...
\label{m39373*uid14587}
    \begin{center}
    \label{m39373*uid14587!!!underscore!!!media}\label{m39373*uid14587!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39373_intersect.png} % m39373;intersect.png;;;6.0;8.5;
...
\label{m39373*uid14567}
    \begin{center}
    \label{m39373*uid14567!!!underscore!!!media}\label{m39373*uid14567!!!underscore!!!printimage}\includegraphics{col11306.imgs/m39373_complement.png} % m39373;complement.png;;;6.0;8.5;
...
\label{m39373*uid14767}
    \begin{center}
    \label{m39373*uid14767!!!underscore!!!media}\label{m39373*uid14767!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39373_a-b.png} % m39373;a-b.png;;;6.0;8.5;
...
Fanta, what is the probability that one pupil chosen at random has:
