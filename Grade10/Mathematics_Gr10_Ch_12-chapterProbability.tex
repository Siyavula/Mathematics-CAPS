...
$A$ and \begin{math}B\end{math} is the set of all elements in \begin{math}A\end{math} or in \begin{math}B\end{math} (or in both). \begin{math}A\phantom{\rule{4pt}{0ex}}\mathbf{or}\phantom{\rule{4pt}{0ex}}B\end{math} is also written \begin{math}A\cup B\end{math}. The \textsl{intersection} of \begin{math}A\end{math} and \begin{math}B\end{math} is the set of all elements in both
$A$ and \begin{math}B\end{math}. 
...
\label{m39377*id734}\nopagebreak\noindent{}\settowidth{\mymathboxwidth}{\begin{equation}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    \mathrm{n\left(N\; or\; S\right)}=\mathrm{n\left(N\right)}+\mathrm{n\left(S\right)}--\mathrm{n\left(N\; and\; S\right)}28=23+19--\mathrm{n\left(N\; and\; S\right)}\mathrm{n\left(N\; and\; S\right)}=14$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (11.2)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
they are simply the total probability (e.g. 1 if our total measure is 1) minus the probability of the event in question. So,\par \label{m39377*eip-936}\nopagebreak\noindent{}\settowidth{\mymathboxwidth}{\begin{equation}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    P\left({A}^{\text{'}}\right)=1-P\left(A\right)$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (11.3)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
$S$ and two events \begin{math}A\end{math} and \begin{math}B\end{math}, within \begin{math}S\end{math}.\par 
      \label{m39377*uid57}\nopagebreak\noindent{}
        \settowidth{\mymathboxwidth}{\begin{equation}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    P\left(A\cap B\right)=P\left(A\right)\ensuremath{\times}P\left(B\right)$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (11.5)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
with one single pick from a pack of 52 cards \par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    P\left(\mathrm{club}\cup \mathrm{ace}\right)=\mathrm{P}\left(\mathrm{club}\right)+\mathrm{P}\left(\mathrm{ace}\right)-\mathrm{P}\left(\mathrm{club}\cap \mathrm{ace}\right)$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (11.7)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    =\frac{1}{4}+\frac{1}{13}-\left(\frac{1}{4}\ensuremath{\times}\frac{1}{13}\right)=\frac{1}{4}+\frac{1}{13}-\frac{1}{52}=\frac{16}{52}=\frac{4}{13}$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (11.8)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
equation (11.6) becomes:\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    P\left(A\cup B\right)=P\left(A\right)+P\left(B\right)$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (11.9)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
performed 100 times. Therefore, there were 100 trials, in total.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    \mathrm{Probability\; of\; H}=\frac{\mathrm{frequency\; of\; outcome}}{\mathrm{number\; of\; trials}}=\frac{44}{100}=0,44\mathrm{Relative\; Frequency\; of\; T}=\frac{\mathrm{frequency\; of\; outcome}}{\mathrm{number\; of\; trials}}=\frac{56}{100}=0,56$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (11.10)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
weighted coin landing on either of its faces. \par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    \mathrm{Relative\; Frequency\; of\; H}=\frac{\mathrm{number\; of\; favourable\; outcomes}}{\mathrm{total\; number\; of\; outcomes}}=\frac{1}{2}=0,5\mathrm{Relative\; Frequency\; of\; T}=\frac{\mathrm{number\; of\; favourable\; outcomes}}{\mathrm{total\; number\; of\; outcomes}}=\frac{1}{2}=0,5$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (11.11)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\label{m39373*uid14547}
    ...
    \label{m39373*uid14547!!!underscore!!!media}\label{m39373*uid14547!!!underscore!!!printimage}\includegraphics[width=80px]{col11306.imgs/m39373_union.png} % m39373;union.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{.1in}
    \end{center}    % make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | '' || col4 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}
      %--------------------------------------------------------------------
    % align/colidx: left,1
