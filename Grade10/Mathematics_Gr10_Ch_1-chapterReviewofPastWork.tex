...
numbers} and mathematicians use the symbol $\mathbb{R}$ to represent the \textsl{set of all real numbers}, which simply means all of the real numbers. Some of these real numbers can be written in ways that others cannot. Different types of numbers are described in detail in Section 1.12.\par 
    \section{Sets}
      ...
      \label{m38346*id171604}Now we come to the idea of a \textbf{union}, which is used to combine things. The symbol for \textbf{union} is $\cup $. Here, we use it to combine two or more intervals. For example, if \begin{math}x\end{math} is a real number such that \begin{math}1\lessthan{}x\le 3\end{math} or \begin{math}6\le x\lessthan{}10\end{math}\hspace{1ex}, then the set of all the possible \begin{math}x\end{math} values is:\par 
      \label{m38346*uid1}\nopagebreak\noindent{}
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
      \label{m38346*id172141}These letters are referred to as \textbf{variables}, since they can take on any value depending on what is required. For example, $x=1$ in (4), but \begin{math}x=26\end{math}\hspace{1ex} in \begin{math}2+x=28\end{math}.\par 
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
      \label{m38346*id172278}can be used to describe the situation of finding how much change can be expected for buying an item. In this equation, $y$ represents the price of the item you are buying, \begin{math}x\end{math} represents the amount of change you should get back and \begin{math}z\end{math} is the amount of money given to the cashier. So, if the price is R10 and you gave the cashier R15, then write R15 instead of \begin{math}z\end{math} and R10 instead of \begin{math}y\end{math} and the change is then \begin{math}x\end{math}.\par 
      \label{m38346*uid5}\nopagebreak\noindent{}
        \settowidth{\mymathboxwidth}{\begin{equation}
    x+10=15\tag{6}
      \end{equation}
...
$a$ again:\par 
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
      \label{m38346*id172553}The sign $\ne $ means ``is not equal to''. For example, \begin{math}2+3=5\end{math} and \begin{math}3+2=5\end{math}, but \begin{math}5-3=2\end{math} and \begin{math}3-5=-2\end{math}. \begin{math}-2\end{math} is a negative number, which is explained in detail in "Negative Numbers" (Section~: Negative Numbers).\par 
...
\textsl{commutative} property for addition. \par 
    \section{Multiplication and Division}
      ...
      \label{m38346*id172708}Just like addition and subtraction, multiplication ($\ensuremath{\times}$, \begin{math}\ensuremath{\cdot}\end{math}) and
...
right. So although $4x$ and \begin{math}x4\end{math} are the same thing, it looks better to
...
you do any $\ensuremath{\times}÷$ before any \begin{math}+-\end{math}.}. You can always put your own brackets
...
sign ($+$) and a negative number has a negative sign (\begin{math}-\end{math}).\par 
        \label{m38346*id173907}Subtraction is actually the same as adding a \textsl{negative number}.\par 
        \label{m38346*id173916}In this example, $a$ and \begin{math}b\end{math} are positive numbers, but \begin{math}-b\end{math} is a negative number\par 
        \label{m38346*uid23}\nopagebreak\noindent{}
          \settowidth{\mymathboxwidth}{\begin{equation}
...
number and instead of writing $a+\left(-b\right)$, we write \begin{math}a-b\end{math}. This also means that
$-b+a$ is the same as \begin{math}a-b\end{math}. Now, which do you find easier to work out?\par 
...
$-3+12$, even though they are the same thing. So \begin{math}a-b\end{math}, which looks neater and
...
column shows what sign the answer will be.\par 
    ...
    % rowcount: '0' | start: 'false' | colidx: '3'
        % Formatting a regular cell and recurring on the next sibling
        $a\ensuremath{\times}b$ or \begin{math}a÷b\end{math}% make-rowspan-placeholders
...
$-2\ensuremath{\times}-3=6$, but \begin{math}-2\ensuremath{\times}3=-6\end{math} and \begin{math}2\ensuremath{\times}-3=-6\end{math}.\par 
...
is $-7+11$?'' looks a lot more complicated than ``What is \begin{math}11-7\end{math}?'', even though
...
the answer the sign of the larger number. In this equation, $F$ is bigger than \begin{math}e\end{math}.\par 
          \label{m38346*uid32}\nopagebreak\noindent{}
            \settowidth{\mymathboxwidth}{\begin{equation}
...
$-10+3$ to get \begin{math}3-10\end{math} and then use Tip 3 to get \begin{math}-\left(10-3\right)=-7\end{math}.\par 
\label{m38346*secfhsst!!!underscore!!!id1324}
    ...
    \par
          \label{m38346*uid34}\item Say whether the sign of the answer is $+$ or \begin{math}-\end{math}
...
change ($x$) we can expect if we know how much an item costs (\begin{math}y\end{math}) and how much
...
$z$ and R10 instead of \begin{math}y\end{math}.\par 
      \label{m38346*uid36}\nopagebreak\noindent{}
        \settowidth{\mymathboxwidth}{\begin{equation}
    x+10=15\tag{25}
      \end{equation}
...
equation, so that only $x$ is on the left hand side of the \begin{math}=\end{math} sign and
...
\label{m38346*secfhsst!!!underscore!!!id1732}
        ...
        \label{m38346*id176734}\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
            \label{m38346*uid43}\item If $3\left(2r-5\right)=27$, then \begin{math}2r-5=.....\end{math}\hspace{1ex}        \label{m38346*uid44}\item Find the value for \begin{math}x\end{math} if \begin{math}0,5\left(x-8\right)=0,2x+11\end{math}\hspace{1ex}        \label{m38346*uid45}\item Solve \begin{math}9-2n=3\left(n+2\right)\end{math}\hspace{1ex}        \label{m38346*uid46}\item Change the formula \begin{math}P=A+Akt\end{math} \hspace{1ex}to \begin{math}A=\end{math}\hspace{1ex}        \label{m38346*uid47}\item Solve for \begin{math}x\end{math}: \begin{math}\frac{1}{ax}+\frac{1}{bx}=1\end{math}\hspace{1ex}        \end{enumerate}
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 \par \begin{tabular}[h]{cccccc}
...
write a number divided by another one, such as $a÷b$, \begin{math}a/b\end{math} and \begin{math}\frac{a}{b}\end{math}.
...
$1/5$ or \begin{math}\frac{1}{5}\end{math}, the numerator is 1 and the denominator is 5.\par 
...
the numerator. So, the reciprocal of $\frac{2}{3}$ is \begin{math}\frac{3}{2}\end{math}.\par 
...
which is written as a comma in South African schools. For example the number $3\frac{14}{100}$ can be written much more neatly as \begin{math}3,14\end{math}.\par 
...
many zeros should appear to the right of $a$. If \begin{math}m\end{math} is negative, then it
represents how many times the decimal place in $a$ should be moved to the left.
For example $3,2\ensuremath{\times}{10}^{3}$ represents 32~000 and \begin{math}3,2\ensuremath{\times}{10}^{-3}\end{math} represents
$0,0032$.\par 
...
number after the 9 is a 7, $a=3,00$.\par 
      \label{m38346*id178057}So the number is $3,00\ensuremath{\times}{10}^{m}$, where \begin{math}m=8\end{math}, because there are 8 digits
...
This is equal to $1,2\ensuremath{\times}0,0000001\phantom{\rule{3pt}{0ex}}m$, which is \begin{math}0,00000012\phantom{\rule{3pt}{0ex}}m\end{math}.\par 
...
numbers $\mathbb{Q}$, the integers \begin{math}\mathbb{Z}\end{math} and the natural numbers \begin{math}\mathbb{N}\end{math}. The irrational numbers are the numbers not inside the set of rational
...
describe the apples. This type of number is known as a rational number.\par 
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        \label{m38346*id178652}where $a$ and \begin{math}b\end{math} are integers and \begin{math}b\ne 0\end{math}.\par 
...
numbers $\frac{a}{b}$ when \begin{math}a\end{math} and \begin{math}b\end{math} are integers''. \par 
...
end, which is very useful. If we have 4 integers $a,b,c$ and \begin{math}d\end{math}, then the
...
\label{m38346*secfhsst!!!underscore!!!id2239}
            \subsubsection{  Notation Tip }
            \nopagebreak
        \label{m38346*id179027}The statement "4 integers $a,b,c$ and \begin{math}d\end{math}" can be
written formally as $\{a,b,c,d\}\in \mathbb{Z}$ because the \begin{math}\in \end{math} symbol means
\textsl{in} and we say that $a,b,c$ and \begin{math}d\end{math} are \textsl{in} the set of
integers. \par 
        \label{m38346*id179148}Two rational numbers ($\frac{a}{b}$ and \begin{math}\frac{c}{d}\end{math}) represent the same number if \begin{math}ad=bc\end{math}. It is always best to simplify any rational number, so that the
denominator is as small as possible. This can be achieved by dividing both the numerator and the denominator by the same integer. For example, the rational number $1000/10000$ can be divided by 1000 on the top and the bottom, which gives \begin{math}1/10\end{math}. \begin{math}\frac{2}{3}\end{math} of a pizza is the same as \begin{math}\frac{8}{12}\end{math} (Figure~4).\par 
    ...
    \rule[.1in]{\figurerulewidth}{.005in} \\
      ...
      \vspace{2pt}
    \vspace{\rubberspace}\par \begin{cnxcaption}
	  \small \textbf{Figure 4: }$\frac{8}{12}$ of the pizza is the same as \begin{math}\frac{2}{3}\end{math} of the pizza.
	\end{cnxcaption}
    \vspace{.1in}
    \rule[.1in]{\figurerulewidth}{.005in} \\
    \end{center}
...
leaving a remainder. The following numbers all have a factor of 3\par 
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m38346*id179428}For example, if we wish to add $\frac{3}{4}+\frac{2}{3}$, we first need to write both fractions so that their denominators are the same by finding the lowest common denominator, which we know is 12. We can do this by multiplying \begin{math}\frac{3}{4}\end{math} by \begin{math}\frac{3}{3}\end{math} and \begin{math}\frac{2}{3}\end{math} by \begin{math}\frac{4}{4}\end{math}. \begin{math}\frac{3}{3}\end{math} and \begin{math}\frac{4}{4}\end{math} are really just complicated ways of writing 1. Multiplying a number by 1 doesn't change the number.\par 
        \label{m38346*uid64}\nopagebreak\noindent{}
          \settowidth{\mymathboxwidth}{\begin{equation}
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
      ...
      \label{m38346*uid67}
            ...
            \nopagebreak
        \label{m38346*id179954}An \textsl{irrational number} is any real number that is not a rational number. When expressed as decimals, these numbers can never be fully written out as they have an infinite number of decimal places which never fall into a repeating pattern. For example, $\sqrt{2}=1,41421356...$, \begin{math}\pi =3,14159265...\end{math}. \begin{math}\pi \end{math} is a Greek letter and is pronounced ``pie''.\par 
...
\label{m38346*id180040}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \label{m38346*uid69}\item $\frac{c}{d}$ if \begin{math}c\end{math} is an integer and if \begin{math}d\end{math} is irrational.
...
Explain.
$\sqrt{4}$;\begin{math}\frac{1}{8}\end{math}\hspace{1ex}        \end{enumerate}
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 \par \begin{tabular}[h]{cccccc}
 (1.) l3b  &  (2.) l3j  & \end{tabular}
    ...
    \par
      \label{m38346*id180360}So if we write $x\greatthan{}5$, we say that \begin{math}x\end{math} is greater than 5 and if we write \begin{math}x\ge y\end{math}, we mean that \begin{math}x\end{math} can be greater than or equal to \begin{math}y\end{math}. Similarly, \begin{math}\lessthan{}\end{math} means `is less than' and \begin{math}\le \end{math} means `is less than or equal to'. Instead of saying that \begin{math}x\end{math} is between 6 and 10, we often write \begin{math}6\lessthan{}x\lessthan{}10\end{math}. This directly means `six is less than \begin{math}x\end{math}\hspace{1ex} which in turn is less than ten'.\par 
...
\label{m38346*uid78}\item $y$ is less than or equal to \begin{math}z\end{math}\label{m38346*uid79}\item \begin{math}a\end{math} is greater than or equal to 21
\label{m38346*uid80}\item $p$ is greater than or equal to 21 and \begin{math}p\end{math} is less than or equal to 25
\end{enumerate}
...
\label{m38346*id180675}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \label{m38346*uid82}\item $18-6\ensuremath{\times}2$\label{m38346*uid83}\item \begin{math}10+3\left(2+6\right)\end{math}\label{m38346*uid84}\item \begin{math}50-10\left(4-2\right)+6\end{math}\label{m38346*uid85}\item \begin{math}2\ensuremath{\times}9-3\left(6-1\right)+1\end{math}\label{m38346*uid86}\item \begin{math}8+24÷4\ensuremath{\times}2\end{math}\label{m38346*uid87}\item \begin{math}30-3\ensuremath{\times}4+2\end{math}\label{m38346*uid88}\item \begin{math}36÷4\left(5-2\right)+6\end{math}\label{m38346*uid89}\item \begin{math}20-4\ensuremath{\times}2+3\end{math}\label{m38346*uid90}\item \begin{math}4+6\left(8+2\right)-3\end{math}\label{m38346*uid91}\item \begin{math}100-10\left(2+3\right)+4\end{math}\end{enumerate}
        \hspace{1ex}        \label{m38346*uid92}\item If $p=q+4r$, then \begin{math}r=.....\end{math}\hspace{1ex}        \label{m38346*uid93}\item Solve \begin{math}\frac{x-2}{3}=x-3\end{math}\hspace{1ex}        \end{enumerate}
  \label{m38346**end}
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 \par \begin{tabular}[h]{cccccc}
