...
%     \begin{caption}{\small\bfseries Table 3.1}: Abbreviations and symbols for some common currencies.\end{caption}
\end{table}
%       
%     \par
%   
...
%     \begin{caption}{\small\bfseries Table 3.2}: Examples of exchange rates\end{caption}
\end{table}
%       
%     \par
%   
