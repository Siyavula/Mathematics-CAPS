...
\Identity{Distance}{\begin{center}$\mbox{Distance  } (d)=\sqrt{{({x}_{1}-{x}_{2})}^{2}+{({y}_{1}-{y}_{2})}^{2}}$\end{center}}
\Note{Note that $(x_1 - x_2)^2 = (x_2 - x_1)^2$, but remember to be consistent or you will get the wrong answer.\\
$AB \neq \\ \sqrt{(x_1 - x_2)^2 + (y_2 - y_1)^2}$.}
...
\usefont{T1}{ppl}{m}{n}
\rput(2.5290625,2.3832812){$y$}
\usefont{T1}{ppl}{m}{n}
\rput(5.5190635,0.75328124){$x$}
...
\Identity{Gradient}{\begin{center}Gradient $(m)= \dfrac{y_{2} - y_{1}}{x_{2} - x_{1}}$ or $\dfrac{y_{1} - y_{2}}{x_{1} - x_{2}}$\end{center}}
...
\usefont{T1}{ppl}{m}{n}
\rput(5.7745314,-0.71015626){$m_{GH} = 3$}
\end{pspicture} 
}
\end{center}
\westep{Assign values to $(x_1;y_1)$ and $(x_2;y_2)$}
...
If line $WX \perp $ line $YZ$, then $m_{WX} \times m_{YZ} = -1$. Perpendicular lines have gradients that are the negative inverse of each other. This means that when you multiply the gradients together, the answer will be -1.: $-\frac{1}{m_{AB}}=m_{CD}$
...
\usefont{T1}{ppl}{m}{n}
\rput(7.5245314,-0.5367187){$x$}
\usefont{T1}{ppl}{m}{n}
\rput(3.4445312,3.4632812){$y$}
\usefont{T1}{ppl}{m}{n}
...
\rput(3.01,-1.6667187){\psaxes[linewidth=0.04,arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.4,ticksize=0.10583333cm,dx=0.5cm,dy=0.5cm]{<-<}(0,0)(-3,-1)(3,4)}
...
\Identity{Midpoint}{\begin{center}$M(x;y)=(\dfrac{{x}_{1} + {x}_{2}}{2};\dfrac{{y}_{1}+{y}_{2}}{2}) $\end{center}}
...
\usefont{T1}{ppl}{m}{n}
\rput(7.164531,1.2207812){$x$}
\usefont{T1}{ppl}{m}{n}
\rput(3.3045313,4.020781){$y$}
\usefont{T1}{ppl}{m}{n}
...
M(x;y) = \Big(\frac{x_1+x_2}{2}; \frac{y_1+y_2}{2}\Big)
\end{equation*}
\westep{Substitue values and solve for $x_2$ and $y_2$}
\begin{equation*}
\begin{array}{rllrl}
...
\pspolygon[linewidth=1pt,fillstyle=solid,fillcolor=lightgray](2,0)(1,5)(3,7)(7,2)(2,0)
% \psline[linewidth=.05cm](0,0)(3,3.5)
% \psline[linewidth=.05cm](0,0)(3,2)
% \psline[linewidth=.05cm](0,0)(3,0.5)
% \uput[ur](.9,3.5){\Large{$T$}}
