...
\item $\Delta ABC$ has vertices $A(-3;4)$, $B(3;-2)$ and $R(-5;-2)$. $M$ is the midpoint of $AC$  and $N$ the midpoint of $BC$. Use $\Delta ABC$ to prove the midpoint theorem using analytical geometrical methods. 
  \end{enumerate}
\practiceinfo
\par 
\par \begin{tabular}[h]{cccccc}
