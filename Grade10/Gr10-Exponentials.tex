...
\begin{enumerate}[itemsep=5pt, label=\textbf{\arabic*}.]
 \item For $a \in \mathbb{R}, n \in \mathbb{N},~~~~$ $a^n = a \times a \times a \times \ldots \times a ~~ (n ~ \textrm{times}) $
...
\begin{equation*}
      \begin{array}{ccll}\hfill {a}^{m}\ensuremath{\times}{a}^{n}& =& a\ensuremath{\times}a\ensuremath{\times} \ldots \ensuremath{\times}a\hfill & \left(\mathrm{m\; times}\right)\hfill \\ 
...
$$ \frac{ {a}^{m} }{ {a}^{n} }={a}^{m-n}$$
\begin{eqnarray*}
\frac{a^m}{a^n} &=& \frac{a \times a \times a \ldots \times a ~ (m~\textrm{times})} {a \times a \times a \ldots \times a ~ (n~\textrm{times})} \\
&= & a \times a \times a \ldots \times a ~ (m-n~\textrm{times}) \\
&= & a^{m-n}
\end{eqnarray*}
...
\begin{eqnarray*}
 ...
 \Big(\frac{a}{b}\Big)^n & = & \Big(\frac{a}{b}\Big) \times \Big(\frac{a}{b}\Big) \times \Big(\frac{a}{b}\Big) \times \ldots \times \Big(\frac{a}{b}\Big) ~~~(n~\textrm{times}) \\
                         & = & \frac{a \times a \times a \times \ldots \times a ~~~(n~\textrm{times})}{b \times b \times b \times \ldots \times b ~~~(n~\textrm{times})}\\
                         & = & \frac{a^n}{b^n}
\end{eqnarray*}
...
\begin{equation*}
    \begin{array}{ccll}\hfill {\left({a}^{m}\right)}^{n}& =& {a}^{m}\ensuremath{\times}{a}^{m}\ensuremath{\times}\ldots\ensuremath{\times}{a}^{m}\hfill & \left(\mathrm{n\; times}\right)\hfill \\
...
$$ \frac{2^{2n} \cdot 4^n \cdot 2 }{ 16^n} ~~ = ~~ \frac{2^{2n} \cdot (2^2)^n \cdot 2 }{ (2^4)^n} $$
...
{%answer
\westep{Expand the expression}
\begin{eqnarray*}
\frac{2^t-2^{t-2}}{3\cdot2^t-2^t} & = & \frac{2t-(2^t\cdot2^{-2})}{3\cdot2^t-2^t} \\
\end{eqnarray*}
...
\begin{exercises}{Simplifying exponents}
...
{% Answer
\westep{First change the negative exponent}
\begin{eqnarray*}
...
Exponential equations have the unknown variable as the exponent. The following are examples of exponential equations:
\begin{eqnarray*}
 3^{x+1} & = & 9 \\
5^t + 3 \cdot 5^{t-1} & = & 400
\end{eqnarray*}

Solving exponential equations is simple, we just need to apply the laws of exponents.

\Note{If $a$ is a positive number such that $a>0$ and $a \ne 0$ and
$$ a^x = a^y $$
because they have the same base, we can write
$$ x = y $$
...
\westep{Make all bases prime numbers}
\begin{eqnarray*}
 3^{x+1} & = & 3^2 \\
\end{eqnarray*}
...
\Note{To solve exponential equations, you use the all the strategies for solving linear and quadratic equations.}
...
\begin{itemize}[noitemsep, label=\textbullet{}]
    ...
    \item Definition: 
	  \begin{itemize}[noitemsep]
	   \item ${a}^{n}=a\ensuremath{\times}a\ensuremath{\times}\cdots \ensuremath{\times}a\phantom{\rule{2.em}{0ex}}\left(\mathrm{n\; times}\right)$
	   \item ${a}^{0}=1,a\ne 0$
