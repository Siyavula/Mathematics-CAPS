...
A right prism is a geometric solid that has a polygon as its base and one or more sides perpendicular to the base. The base and top surface are the same shape and size. We
call it a ``right`` prism because the angles between the base and sides are right-angles.
\par
A prism with a square base is called a cube, a rectangular prism has a rectangle as its
base, and triangular prism has a triangle as its base. A cylinder is another type of right
...
\hspace{10pt}
	...
	\vspace{0.75cm}
	\begin{caption*}{Examples of right prisms: a rectangular prism, a square prism (or cube), a triangular prism and a cylinder.}\end{caption}
    \end{center}
\end{figure}   
...
$\mbox{large rectangle} + 2 \times \mbox{small rectangle} = 140 + 20 = 180$
\westep{Write the final answer}
The surface area of the rectangular prism is 180~cm$^2$.
\
}
\end{wex}
