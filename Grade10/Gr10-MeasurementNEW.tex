...
\newcolumntype{D}{>{\centering\arraybackslash} m{2in} }
\newcolumntype{E}{>{\centering\arraybackslash} m{4.2in} }
\begin{tabular}{|C|D|E|}
\hline
...
&
$\begin{aligned}
\mbox{Surface area} &=  \mbox{sum of all the areas of all the faces}\\
&= \mbox{area of base} +\frac{1}{2} \times \mbox{perimeter of base} \times \mbox{slant height of pyramid}
 \end{aligned}$
\\ \hline
...
$\begin{aligned}
\mbox{Surface area} &=  \mbox{area of base }+\mbox{ area of walls}\\
