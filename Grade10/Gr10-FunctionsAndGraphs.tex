...
\end{enumerate}
 ...
 \end{figure}       
      \label{m39337*uid40}
            \subsubsubsection{ Dependent and Independent Variables}
            \nopagebreak
      ...
      \label{m39337*uid41}
            \subsubsubsection{ Domain and Range}
            \nopagebreak
    ...
    x:\mathrm{conditions,\; more\; conditions}\tag{1.5}
      \end{equation}
        ...
        \label{m39337*uid44}
            \subsubsubsection{ Interval Notation}
            \nopagebreak
    ...
    \left(2;8\right]\tag{1.6}
      ...
      \label{m39337*uid46}
            \subsubsubsection{ Intercepts with the Axes}
            \nopagebreak
      ...
      \label{m39337*uid47}
            \subsubsubsection{ Turning Points}
            \nopagebreak
 ...
 \end{figure}       
      ...
      \label{m39337*uid50}
            \subsubsubsection{ Lines of Symmetry}
            \nopagebreak
 ...
 \end{figure}       
      \label{m39337*uid52}
            \subsubsubsection{ Intervals on which the Function Increases/Decreases}
            \nopagebreak
      ...
      \label{m39337*uid53}
            \subsubsubsection{ Discrete or Continuous Nature of the Graph}
            \nopagebreak
...
\label{m39337*secfhsst!!!underscore!!!id796}
            \subsubsubsection{Exercise:  Domain and Range }
            \nopagebreak
...
%     
 \label{m39338*uid68}
            ...
            \nopagebreak
 \subsubsubsection{Plotting the Graph}       
...
\label{m39338*secfhsst!!!underscore!!!id833}
            \subsubsubsubsection{  Investigating the effects of a and q}
            \nopagebreak
...
\label{m39338*id238365}
    ...
    \par
 \subsubsubsection{Discovering the characteristics} 
        \label{m39338*uid83}
            \subsubsubsection{ Domain and Range}
            \nopagebreak
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39338*uid88}
            \subsubsubsection{ Axes of Symmetry}
            \nopagebreak
        ...
        \label{m39338*uid89}
            \subsubsubsection{ Sketching Graphs of the Form $f\left(x\right)=ax+q$}
            \nopagebreak
...
\label{m39338*secfhsst!!!underscore!!!id1359}
            \subsubsubsection{ Exercise: Straight line graphs }
            \nopagebreak
...
\label{m39345*secfhsst!!!underscore!!!id1384}
            \subsubsubsection{  Investigating the effects of a and q }
            \nopagebreak
...
\label{m39345*id242029}
    ...
    \par
  \subsubsubsection{Discovering the characterstics}
        \label{m39345*uid117}
            \subsubsubsubsection{ Domain and Range}
            \nopagebreak
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39345*uid118}
            \subsubsubsubsection{ Intercepts}
            \nopagebreak
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39345*uid123}
            \subsubsubsection{ Sketching Graphs of the Form $f\left(x\right)=a{x}^{2}+q$}
            \nopagebreak
...
\label{m39345*eip-297}The following video shows one method of graphing parabolas. Note that in this video the term vertex is used in place of turning point. The vertex and the turning point are the same thing.
 ...
 \end{figure}   
    ...
    \par \label{m39345*secfhsst!!!underscore!!!id2745}
            \subsubsubsection{Exercise:  Parabolas }
            \nopagebreak
...
\subsubsubsection{Discovering the characteristics}  
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39341*uid157}
            \subsubsubsection{ Sketching Graphs of the Form $f\left(x\right)=\frac{a}{x}+q$}
            \nopagebreak
...
\label{m39341*secfhsst!!!underscore!!!id3460}
            \subsubsubsection{Exercises: Hyperbolic Graphs }
            \nopagebreak
...
\par 
        ...
        \label{m39348*uid192}
            \subsubsubsection{ Sketching Graphs of the Form $f\left(x\right)=a{b}^{\left(x\right)}+q$}
            \nopagebreak
...
\label{m39348*secfhsst!!!underscore!!!id4260}
            \subsubsubsection{ Exercise: Exponential Functions and Graphs }
            \nopagebreak
...
\end{table}
 ...
 \end{figure}       
      \label{m39414*uid32}
            \subsubsubsection{ Functions of the form $y=asin\left(x\right)+q$}
            \nopagebreak
...
\end{table}
 ...
 \end{figure}       
      \label{m39414*uid51}
            \subsubsubsection{ Functions of the form $y=acos\left(x\right)+q$}
            \nopagebreak
...
\label{m39414*id88246}
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
      ...
      \label{m39414*uid68}
            \subsubsubsection{ Comparison of Graphs of $y=sin~\theta $ and $y=cos~\theta $}
            \nopagebreak
...
\end{table}
 ...
 \end{figure}       
      \label{m39414*uid72}
            \subsubsubsection{ Functions of the form $y=atan\left(x\right)+q$}
            \nopagebreak
...
\label{m39414*secfhsst!!!underscore!!!id3393}
            \subsubsubsection{  Exercise: Trigonometric Functions }
            \nopagebreak
