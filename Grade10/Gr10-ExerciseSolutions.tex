...
\subsubsection*{Exercise 1-5} %p. 23
...
\subsubsection*{Exercise 1-6} %p. 30
...
\subsubsection*{Exercise 1-8} %p. 35-36
...
\subsubsection*{Exercise 1-9} %p. 39
...
% \item $2$
\item  $1$ or $-5\frac{3}{8}$%$\frac{a+1}{3a-4}+\frac{9}{2a+5}+\frac{2a+3}{2a+5}=0$
\item  $0$ or $\frac{2}{3}$%$\frac{3}{9a^2-3a+1}-\frac{3a+4}{27a^3+1}=\frac{1}{9a^2-1}$  
\end{enumerate}
...
\begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ] 
\item $y = \frac{-3}{2}$ and $x=-7$%$3x-14y=0$, $x-4y+1=0$
\item $y = 3$ and $x = 5$%$x+y=8$, $3x + 2y = 21$
\item $x = -1$ and $y = -1$%$y=2x+1$, $x + 2y + 3 = 0$
\item $a=5\frac{1}{3}$ and $b=1\frac{1}{3}$%$\frac{a}{2}+b=4$ and $\frac{a}{4} -\frac{b}{4}=1$
\item $x=\frac{1}{7}$ and $y=-\frac{1}{4}$%$\frac{1}{x}+\frac{1}{y}=3$ and $\frac{1}{x}-\frac{1}{y}=11$
\end{enumerate}

\item % $x+2y=1$, $\frac{x}{3} + \frac{y}{2} = 1$ %Solve graphically and check your answer algebraically:
...
% \psline[arrows=<->](-4,1)(4,1)
\end{pspicture}\normalsize}
% $\frac{x}{4}=\frac{y}{2}-1$  and $\frac{y}{4}+\frac{x}{2}=1$ 
...
\end{pspicture}\normalsize
 ...
 %$2x+y=5$ and $3x-2y=4$ NEEDS GRAPHIC
...
\item $9$ and $11$ %The sum of two consecutive odd numbers is $20$ and their difference is $2$. Find the two numbers. 
\item $\frac{1}{2}$ %The denominator of a fraction is 1 more than the numerator. The sum of the fraction and its reciprocal is $\frac{5}{2}$. Find the fraction.
\item $8$ years old %Thembi is 21 years older than her daughter, Phumzi. The sum of their ages is 37. How old is Phumzi?     
\item Murunwa is $7$ and Tshamano is $35$ %Mark is now five times as old as his son Sam. In seven years from now, Mark will be three times as old as his son. Find their ages now.    
\end{enumerate}
...
\item $x=-a$ or $x=-b$ %Solve for $x$: $x^2+x(a+b)+ab=0$
...
\scalebox{0.6}{
\footnotesize\begin{pspicture}(-5,-5)(5,5)
%\psgrid
...
\scalebox{0.6}{
\footnotesize\begin{pspicture}(-5,-5)(5,1)
%\psgrid
\psset{yunit=0.5,xunit=0.5}
...
\scalebox{0.6}{
\footnotesize\begin{pspicture}(-5,-1)(5,6)
%\psgrid
\psset{yunit=0.5,xunit=0.5}
...
\item %$y=tan~\theta -2$
\scalebox{0.6}{
\footnotesize\begin{pspicture}(0,-2.5)(4,2)
\psset{yunit=0.5}
\psaxes[Dx=180, dx=2, Dy=1, dy=1, labels=none, ticks=x]{<->}(0,0)(-0.5,-5.1)(4.5,2)
...
\item $(-3;12)$ and $(2;2)$%Calculate the points of intersection of $f$ and $g$.
...
\item $1,6$ units%After a ball is dropped, the rebound height of each bounce decreases. The equation $y=5{(0,8)}^{x}$ shows the relationship between the number of bounces ($x$) and the height of the bounce ($y$) for a certain ball. 
...
\item %$f(x)=4^x$ and $g(x)=4x^2+q$ and sketched below. The points $A(0;1)$, $B(1;4)$ and $C(1,-3)$ are given. Answer the questions that follow:\\
 ...
 \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
\item $g(x) = -4x^2 + q\\
$Substitute in values of point $A(0;1)$:\\
$\therefore 1 = -4(0)^2 + q\\
\therefore q=1$%
\item Substitute in values of point $B(1;4)$:\\
$g(1) = -4(1)^2) + 1\\
=-4+1\\
=-3\\
\therefore BC = 4+3 = 7$ units.
\item $y=-4^{x}$%
\item $y=4^{x}+1$%G.
\item $x=0$%
...
\item %The graphs of $y=x$ and $y=\frac{8}{x}$ are shown in the following diagram.\\
    %Calculate:
    \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
    \item $A(\sqrt{8};\sqrt{8})$ and $B(-\sqrt{8};-\sqrt{8})$ %the coordinates of points $A$ and $B$.
    \item $CD = 2\sqrt{8}$ units%the length of $CD$.
    \item $AB=8$ units%the length of $AB$.
    \item $EF=2$ units%the length of $EF$, given $G(-2;0)$.
  \end{enumerate}

\item %Given the diagram with $y=-3x^2+3$ and $y=-\frac{18}{x}$.\\
    \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
    \item $A(-1;0), B(1;0)$ and $C(0;3)$\\%Calculate the coordinates of $A$, $B$ and $C$.
    \item The two graphs intersect in the fourth quadrant.%Descibe in words what happens at point $D$.
...
{
\footnotesize\begin{pspicture}(0,-3.1967187)(6.6445317,3.2367187)
...
\end{enumerate} 
\item $19,47^{\circ}$%A ladder of length $15$ m is resting against a wall, the base of the ladder is $5$ m from the wall. Find the angle between the wall and the ladder. 
...
\begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
\item On same line%$E(0;3)$, $F(-2;5)$, $G(2;1)$.
\item On same line%$H(-3;-5)$, $I(-0;0)$, $J(6;10)$.
\item Not on same line %$K(-6;2)$, $L(-3;1)$, $M(1;-1)$.
\end{enumerate}
...
\scalebox{0.4} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-5.0)(10.0,5.0)
...
% \begin{center}
\scalebox{.4}{
\footnotesize\begin{pspicture}(-5,-5)(5.5,5.5)
% \psaxes{<->}(0,0)(5,5)
...
\end{enumerate}
% \item %$\Delta PQR$ has vertices $P(1;8)$, $Q(8;7)$ and $R(7;0)$. Show through calculation that $\Delta PQR$ is a right angled isosceles triangle.
% \item %$\Delta ABC$ has vertices $A(-3;4)$, $B(3;-2)$ and $R(-5;-2)$. $M$ is the midpoint of $AC$  and $N$ the midpoint of $BC$. Use $\Delta ABC$ to prove the midpoint theorem using analytical gemoetrical methods. 
\end{enumerate}
\end{multicols}
% \end{eocexercises}
...
\scalebox{0.4} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-5.0875)(8.385716,5.0475)
...
\scalebox{0.4} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-3.62375)(11.17442,3.58375)
    ...
    \item
	  ...
	  \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
		...
		\item %Draw a Venn diagram to illustrate all this information.
		      \scalebox{0.5} % Change this value to rescale the drawing.
		      {
		      \footnotesize\begin{pspicture}(0,-2.393125)(4.7790623,2.393125)
...
\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ]
      ...
      %     from a die be rolled:
	    \scalebox{0.5} % Change this value to rescale the drawing.
	    {
	    \footnotesize\begin{pspicture}(0,-1.8767188)(3.62,1.9167187)
      ...
      %     \end{enumerate}
    \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
    \item $\frac{1}{6}$%a multiple of $5$ and an odd number
...
% 		  \item %Find a set for the event, $N$, of drawing a numbered card.
		  \item %Represent the above events in a Venn diagram.
			\scalebox{0.5} % Change this value to rescale the drawing.
			{
			\footnotesize\begin{pspicture}(0,-2.4442186)(8.7890625,2.4442186)
...
% 			\scalebox{0.5} % Change this value to rescale the drawing.
% 			{
% 			\footnotesize\begin{pspicture}(0,-1.6082911)(3.7028239,1.6165534)
...
{
\footnotesize\begin{pspicture}(0,-1.97)(5.0,1.97)
...
\item %If a litre of paint covers an area of $2$ m$^{2}$, how much paint does a painter need to cover:
    \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
	  % \setcounter{enumi}{3}
	  \item $24~\ell$ %a rectangular swimming pool with dimensions $4$ m $\times~3$ m $\times~2,5$ m (the inside walls and floor only).
	  \item $22~\ell$%the inside walls and floor of a circular reservoir with diameter $4$ m and height $2,5$ m.
    \end{enumerate}
\end{enumerate}       
...
\item %Consider the solids below and answer the questions that follow (correct to one decimal place, if necessary):
      \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
	  \item Cylinder$ = 352$ cm$^2$\\  Tri prism$= 384$ cm$^2$\\Rect prism$ = 72$ cm$^2$%%Calculate the surface area of each solid.
	  \item Cylinder$ = 502$ cm$^3$\\ Tri prism $= 240$ cm$^3$\\Rect prism$ = 40$ cm$^3$ %Calculate volume of each solid.
\item Cyl$=3166,7$ cm$^2$\\ Tri prism $=3~456$ cm$^2$\\Rect prism$=684$ cm$^2$%If each dimension of the solid is increased by a factor of $3$, calculate the new surface area of each solid.
\item Cy$=13571,9$ cm$^3$\\ Tri prism $=6~480$ cm$^3$\\Rect prism $=1~080$ cm$^3$ %If each dimension of the solid is increased by a factor of $3$, calculate the new volume of each solid.
      \end{enumerate}
\item %Consider the solids below:
      \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
      % \setcounter{enumi}{4}
	  \item Cone$= 225$ cm$^2$\\Sq pyramid$= 585$ cm$^2$\\Half sphere$= 100$ cm$^2$%Calculate the surface area of each solid.
	  \item Cone$ = 94$ cm$^3$\\Sq pyramid$= 900$ cm$^3$ \\Half sphere$= 134$ cm$^3$ %Calculate the volume of each solid.
      \end{enumerate}
\item Volume$=335~103,2$ cm$^3$ S.A$=35~185,9$ cm$^2$%Calculate the volume and surface area of the solid below (correct to $1$ decimal place):
\end{enumerate}
\end{multicols}
