...
\item %$\frac{x}{4}=\frac{y}{2}-1$  and $\frac{y}{4}+\frac{x}{2}=1$ NEEDS GRAPHIC
$-\frac{4}{5}$ and $2\frac{2}{5}$
\item %$2x+y=5$ and $3x-2y=4$ NEEDS GRAPHIC
$2$ and $1$
\end{enumerate}
\end{enumerate}
...
\item $x \leq 1$ , $x \geq -12$ %$3 \leq 4 - x \leq 16$
\item $y < \frac{6}{7}$ %$\frac{-7y}{3} - 5 > -7$
\item $y \leq 0$, $y>-4$ %$1 \leq 1 - 2y < 9$
\item $x<7$, $x>-20$ %$-2 < \frac{x-1}{-3}<7$
    \end{enumerate}
