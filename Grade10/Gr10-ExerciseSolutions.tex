...
\begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ] 
\item $3,142$ $\frac{1571}{500}$
\item $1,618$ $\frac{809}{500}$
\item $1,414$ $\frac{707}{500}$
\item $2,718$ $\frac{1359}{500}$
    \end{enumerate}
...
\item $\frac{3}{2}$ or $\frac{-3}{2}$% $(4x)(x-3)=-9$       
...
\item $2$% ${x}^{2}-4x=-4$      
\item no roots% $-{x}^{2}+4x-6=4{x}^{2}-5x+3$       
\item $0$ or $3$% ${t}^{2}=3t$  
\item $5$% ${x}^{2}-10x=-25$      
\item $\sqrt{18}$ or $\sqrt{-18}$% ${x}^{2}=18$
\item $-1$ or $7$% ${p}^{2}-6p=7$
\item $7$ or $\sqrt{-11}{4}$% $4{x}^{2}-17x-77=0$
\item $\frac{-6}{7}$ or $\frac{1}{2}$% $14{x}^{2}+5x=6$
...
% \psline[arrows=<->](-4,1)(4,1)
\end{pspicture}}
\item$\frac{1}{5}$ and $\frac{3}{10}$ %$3x - 2y = 0$, $x - 4y + 1 = 0$%$3x - 2y = 0$, $x - 4y + 1 = 0$
...
\item $x = 0,883$ or $x = 18,117$%The diagonal of a rectangle is $25~$cm more than its width. The length of the rectangle is $17~$cm more than its width. What are the dimensions of the rectangle?  
\item $-34$%The sum of $27$ and $12$ is equal to $73$ more than an unknown number. Find the unknown number.
\item$30$ and $60$  %The two smaller angles in a right-angled triangle are in the ratio of $1:2$. What are the sizes of the two angles? 
...
\item $x = 7,099$ or $x = -3,099$%If $4$ times a number is increased by $7$, the result is $15$ less than the square of the number. Find the number.
...
\item$\%38$ %Stephen has $1~l$ of a mixture containing $69\%$ of salt. How much water must Stephen add to make the mixture $50\%$ salt? Write your answer as a fraction of a litre.
...
\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
    \item $x \lt -2$%$3x+4>5x+8$
    \item $x \geq -3$%$3(x-1)-2\leq 6x+4$ 
    \item $x \lt \frac{-5}{4}$ %$\dfrac{x-7}{3}>\dfrac{2x-3}{2}$
    \item $0$%$-4(x-1)<x+2$
    \item $-1 \leq x \lt 4$%$\dfrac{1}{2}x+\dfrac{1}{3}(x-1)\geq \dfrac{5}{6}x-\dfrac{1}{3}$ 
    \item $-1 \lt x \leq 5$%$-2\leq x-1<3$ 
    \item $x \gt 2$%$-5<2x-3\leq7$ 
...
\item %Find the general formula for the following sequences and then find ${T}_{10}$, ${T}_{50}$ and ${T}_{100}$
  \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
  \item $T_n=3n-1; ~T_10=29; ~T_50=149; ~T_100=299$%$2;~5;~8;~11;~14;\ldots$
  \item $T_n=4n-9; ~T_10=36; ~T_50=196; ~T_100=396$%$0;~4;~8;~12;~16;\ldots$
  \item $T_n=5-3n; ~T_10=-25; ~T_50=-145; ~T_100=-295$%$2;-1;-4;-7;-10;\ldots$
  \end{enumerate}
\end{enumerate}
...
\begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ] 
   ...
   \item $a=1$ and $p=-9$%Find the values of $a$ and $p$.
    ...
    \item $x\leq-4$ or $x\ge4$%Find the values of $x$ for which $g(x)\ge h(x)$.
    \item $x\ge0$ %For what values of $x$ is $g$ increasing?
...
\end{enumerate}
	\item \item $h=1,6$ units%After a ball is dropped, the rebound height of each bounce decreases. The equation $y=5{(0,8)}^{x}$ shows the relationship between the number of bounces ($x$) and the height of the bounce ($y$) for a certain ball. 
...
\uput[dl](0,0){$0$}
\end{pspicture}}
    \item \item $x=6$ and $y=9$%What is the solution?
    \end{enumerate}
...
\item $y=2^{-1}x$%Give the equation of $y=2^x$ reflected about the $y$-axis.
\item Range for $y=2^x$: $(0;\infty)$\\
      Range for $y=-2^x$: $(-\infty;0)$%Give the range of both graphs.
\end{enumerate}
...
\item Domain for $h$: $(-\infty;\infty)$\\
      Range for $h$: $[-4;\infty)$%Give the domain and range of $h$.
\end{enumerate}
...
\item $MN=12,86$ units and $NP=15,32$ units %In $\triangle MNP$, $\hat{N}=90^{\circ}$, $MP=20$ and $\hat{P}=40^{\circ}$. Calculate $NP$ and $MN$ (correct to $2$ decimal places).
...
\item $8,35$ mm and $9,96$ mm%A right-angled triangle has hypotenuse $13$ mm. Find the length of the other two sides if one of the angles of the triangle is $50^{\circ}$.
\item %One of the angles of a rhombus with perimeter $20$ cm is $30^{\circ}$. 
\begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
\item $5$ cm%Find the sides of the rhombus. 
\item $4,83$ mm and $1,29$ mm%Find the length of both diagonals. 
\end{enumerate} 
...
\item $5,65$ cm and $8,70$ cm% A triangle with angles $40^{\circ}$; $40^{\circ}$ and $100^{\circ}$ has a perimeter of $20$ cm. Find the length of each side of the triangle. 
...
\item $q=6$%Line $PQ$ with $P(-1;-7)$ and $Q(q;0)$ has a gradient of $1$. Find $q$.
\end{enumerate}
% }
% \end{exercises}
...
\uput[ul](1.4,7){\LARGE{$B (1;7)$}}
\uput[u](4.3,5){\LARGE{$C (4;5)$}}
\uput[l](1.6,2.7){\LARGE{$D (1;3)$}}
\uput[l](7,0){\LARGE{$x$}}
\uput[d](0,8){\LARGE{$y$}}
...
\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ]
    \item %Let $S$ denote the set of whole numbers from $1$ to $16$, $X$
	  ...
	  \usefont{T1}{ppl}{m}{n}
	  \rput(1.0045313,1.37){\LARGE$X$}
	  \usefont{T1}{ppl}{m}{n}
	  \rput(2.4945312,1.83){\LARGE$Y$}
	  \usefont{T1}{ppl}{m}{n}
    ...
    \item
	  ...
	  \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
		...
		\item %Draw a Venn diagram to illustrate all this information.
		      ...
		      \usefont{T1}{ppl}{m}{n}
		      \rput(4.094531,0.6096875){\LARGE$G:41$}
		      \usefont{T1}{ppl}{m}{n}
		      \rput(0.77453125,-2.1903124){\LARGE$H:36$}
		      \usefont{T1}{ppl}{m}{n}
    ...
    %     out and then replaced.
	  \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
	      ...
	      \item ${1;2;\ldots;12}$%What is the sample space, $S$?
...
\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ]
      ...
      %     out a pink sweet is $\frac{7}{12}$.
		...
		\item ANSWER?%If $44$ if the sweets are yellow, how many sweets are pink?
	    \end{enumerate}
...
\item $x=y=72^{\circ}$
\item $x=98^{\circ}$
\item $x=44^{\circ}$ and $y=112^{\circ}$
\item $x=19$ units
\item $x=25$ units
\item $x=18$ units and $y=4$ units
\item $x=12$ units and $y=13$ units
      \end{enumerate}
...
\item$x=3,5$ units
\item$x=5$ units
\item$x=28$ units and $y=80^{\circ}$
\item$x=24^{\circ}$ and $y=12$ units
	    \end{enumerate}
...
\item F%Both diagonals of a kite bisect the interior angles.
	...
	\item $x=25^{\circ}$
\item $x=145^{\circ}$
\item $x=10$ units and $y=12,5$ units
\item $x=60^{\circ}$
\item $x=36^{\circ}$
\item $x=6$ units and $y=10$ units
	  \end{enumerate}
...
\item $x=40$ mm%
      ...
      %Question 9
      \item  $x=2,75$ units and $y=30^{\circ}$%Explain why $\triangle PQR$ is similar to $\triangle TRS$ and calculate the values of $x$ and $y$.\\

%Question 10
      \item  $a=5$ units and $b=12$ units%Calculate $a$ and $b$:\\
...
\item $3166,7$ cm$^2$; $3456$ cm$^2$; $684$ cm$^2$%If each dimension of the solid is increased by a factor of $3$, calculate the new surface area of each solid.
\item $13571,9$ cm$3$; $6480$ cm$^3$; $1080$ cm$^3$ %If each dimension of the solid is increased by a factor of $3$, calculate the new volume of each solid.
      \end{enumerate}
\item %Consider the solids below:
      ...
      \end{enumerate}
\item $335103,2$ cm$^3$ AND SURFACE AREA?!%Calculate the volume and surface area of the solid below (correct to $1$ decimal place):
\end{enumerate}
\end{multicols}
