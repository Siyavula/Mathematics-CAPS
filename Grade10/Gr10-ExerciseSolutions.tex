...
\uput[ul](1.7,7){\Large{$B (1;7)$}}
\uput[u](4.3,5){\Large{$C (4;5)$}}
\uput[l](1.7,2.5){\Large{$D (1;3)$}}
\uput[l](7,0){\Large{$x$}}
\uput[d](0,8){\Large{$y$}}
...
\item \scalebox{.6} % Change this value to rescale the drawing.
{
...
\item %Consider the solids below:
      ...
      \end{enumerate}
\item Volume$=335~103,2$ cm$^3$ S.A$=35~185,9$ cm$^3$%Calculate the volume and surface area of the solid below (correct to $1$ decimal place):
\end{enumerate}
\end{multicols}
