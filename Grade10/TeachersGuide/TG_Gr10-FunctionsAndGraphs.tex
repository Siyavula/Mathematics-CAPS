...
%     \item %GRAPH ON SAME SET OF AXES ABOVE %Draw the graph of $y=\frac{8}{x}+3$ on the same set of axes, showing asymptotes, axes of symmetry and the coordinates of one point on the graph.
    \end{enumerate}
 \end{enumerate}
...
$y = -(9) + 15\\
= 6$\\
Mark has $9$ R $5$ coins and $6$ R~$2$ coins.
    \end{enumerate}
