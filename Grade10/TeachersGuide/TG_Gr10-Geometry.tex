...
$\therefore$ if $\parallel$ sum would be $180^circ \therefore$ not parallel.

\item $K_2 = 180^\circ - 124^\circ  - 56^\circ$\\
if $MN \parallel OP$ then $\hat{K}_2 = 56$ would be equal to $\hat{L} = 45^\circ$\\
$\therefore MN$ not parallel to $OP$.

\item Given something that doesn't exist, who made this diagram?
...
and $EF \parallel AB$\\
the we know that $EF \parallel CD$
\end{enumerate}}
\end{solutions}
