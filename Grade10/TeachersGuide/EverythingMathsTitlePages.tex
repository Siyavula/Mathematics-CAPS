...
\begin{center}
   ...
   {\vspace*{2in}
     by Siyavula and volunteers \\[20pt]
...
To watch the videos on-line, practise your skills or post a question, go to the \textit{Everything Science} website at underline{www.everythingmaths.co.za} on your mobile or PC and enter the short-code in the navigation box.
}
...
{\Large
We understand that educators are not always available when every learner has a question, especially not after hours. You can now direct your learners to open the textbook on their mobile phone or computer, and pin their question at the exact spot where it cropped up. They will be able to see whether the question has been asked before by other learners, and what the given answer to that question is. \par

Learners should use the short-codes at section headings to navigate to the place in the book, and the short-codes for the exercises for help with specific questions. \par
