...
&=a^{3x−x}\\
&=a^{2x}$\end{array*}
\item \begin{array*}$\dfrac{32p^2}{4p^8}\\
&=8p^{2−8}\\
&=8p^{−6}\\
...
&=3^{2n+6}$\end{array*}
\item \begin{array*}$\dfrac{3^n 9^{n-3}}{27^{n-1}}\\
&=\dfrac{3^{n}.(3^{2})^{n−3}}{(3^{3})^{n−1}}\\
&=\dfrac{3^{n}.3^{2n−6}}{3^{3n−3}}\\
&=3^{n+2n−6−(3n−3)}\\
&=3^{3n−6−3n+3}\\
&=3^{−3}\\
&=\dfrac{1}{3^{3}}\\
...
2.5^{2}.5^{−x}=5+5^{x}\\
\dfrac{2.5^2}{5^x}−5−5^{x}=0\\
(\dfrac{50}{5^{x}}) \times 5^{x} − 5 \times (5^{x})−5^{x} \times (5^{x})=0\\
50−5.5^{x}−(5^{x})^{2}=0\\
(5^{x})^{2}+5.5^{x}−50=0\\
(5^{x}−5)(5^{x}+10)=0\\
5^{x}−5=0~\text{ or }~5^{x}+10=0\\
5^{x}=5~\text{ or } ~5^{x}=−10\\
\text{if }~5^{x}=−10:~ \text{ no solution}\\
\text{if }~5^{x}=5:\\
5^{x}=5^{1}\\
x=1$\end{array*}
\item \begin{array*}$9^{m}+3^{3−2m}=28\\
3^{2m}+3^{3}.3^{−2m}=28\\
3^{2m}+\dfrac{27}{3^{2m}}−28=0\\
(3^{2m})^{2}−28(3^{2m})+27=0\\
(3^{2m}−27)(3^{2m}−1)=0\\
3^{2m}−27=0~\text{ or }~3^{2m}−1=0\\
3^{2m}=27~\text{ or }~3^{2m}=1\\
\text{if }~3^{2m}=27\\
3^{2m}=3^{3}\\
2m=3\\
m=\frac{3}{2}\\
...
=5^{5x+y+3z}$
%c
\item $(b^{k+1})^{k}=b^{k^{2}+k}$
%d
\item $ \dfrac{6^{5p}}{9^p}\\
=\dfrac{2^{5p}.3^{5p}}{3^{2p}}\\
=2^{5p}.3^{5p−2p}\\
=2^{5p}.3^{3p}\\
=(2^{5}.3^{3})^{p}\\
=(32.27)^{p}\\
...
%h
\item $\dfrac{{2}^{a-2} {3}^{a+3}}{{6}^{a}}\\
=\dfrac{2^{a−2}.3^{a+3}}{(2.3)^{a}}\\
=\dfrac{2^{a−2}.3^{a+3}}{2^{a}.3^{a}}\\
=2^{a−2−a}.3^{a+3−a}\\
=2^{−2}.3^{3}\\
=\dfrac{3^3}{2^2}\\
=\frac{27}{4}$
...
%j
\item ${\left(\dfrac{2{x}^{2a}}{{y}^{-b}}\right)}^{3}\\
=\dfrac{2^{3}(x^{2a})^{3}}{(y^{−b})^{3}}\\
=\dfrac{2^{3}x^{6a}}{y^{−3b}}\\
=2^{3}x^{6a}y^{3b}\\
=8x^{6a}y^{3b}$
%k
\item $\dfrac{{2}^{3x-1} {8}^{x+1}}{{4}^{2x-2}}\\
=\dfrac{2^{3x−1}.2^{3(x+1)}}{2^{2(2x−2)}}\\
=2^{3x−1+3x+3−4x+4}\\
=2^{2x+6}\\
=4^{x+3}$
%l
\item $\dfrac{{6}^{2x} {11}^{2x}}{{22}^{2x-1} {3}^{2x}}\\
=\dfrac{(3.2)^{2x}.11^{2x}}{(2.11)^{2x−1}.3^{2x}}\\
=\dfrac{3^{2x}.2^{2x}.11^{2x}}{2^{2x−1}.11^{2x−1}.3^{2x}}\\
=3^{2x−2x}.2^{2x−2x+1}.11^{2x−2x+1}\\
=3^{0}.2^{1}.11^{1}\\
=1.2.11\\
=22$
%m
...
%o
\item $\dfrac{{9}^{n-1} {27}^{3-2n}}{{81}^{2-n}}\\
=\dfrac{3^{2(n−1)}.3^{3(3−2n)}}{3^{4(2−n)}}\\
...
%q
\item $\dfrac{3^{t+3} + 3^t}{2 \times 3^t} \\
=\dfrac{3^{t}.3^{3}+3^{t}}{2.3^{t}}\\
=\dfrac{3^{t}(3^{3}+1)}{2.3^{t}}\\
=\dfrac{3^{3}+1}{2}\\
=\frac{28}{2}\\
=14$
%r
\item $\dfrac{2^{3p} +1}{2^p + 1} \\
=\dfrac{(2^{p}+1)(2^{2p}−2^{p}+1)}{(2^{p}+1)}\\
=2^{2p}−2^{p}+1$
\end{enumerate}
\item \begin{enumerate}[label=\textbf{(\alph*)}, itemsep=7pt]
\setcounter{enumi}{18}
...
\item $ z^{\frac{3}{2}} = 64 \\
z^{\frac{3}{2}}=4^{3}\\
(z^{\frac{3}{2}})^{\frac{2}{3}}=(4^{3})^{\frac{2}{3}}\\
z=4^{2}\\
z=16$
%g
\item $ 16x^{\frac{1}{2}} - 4 = 0 \\
...
t^{\frac{1}{4}}−1=0~\text{ or }~t^{\frac{1}{4}}−2=0\\
\text{if }~t^{\frac{1}{4}}−1=0:\\
t^{\frac{1}{4}}=1\\
(t^{\frac{1}{4}})^{4}=1^{4}\\
t=1\\
\text{if }~t^{\frac{1}{4}}−2=0:\\
t^{\frac{1}{4}}=2\\
(t^{\frac{1}{4}})^{4}=2^{4}\\
t=16$
%j
...
k^{-\frac{1}{2}}−9=0~\text{ or }~k^{-\frac{1}{2}}+2=0\\
k^{-\frac{1}{2}}=9 ~\text{ or }~k^{-\frac{1}{2}}=−2\\
\text{if }~k^{-\frac{1}{2}}=9:\\
(k^{-\frac{1}{2}})^{−2}=9^{−2}\\
k=\frac{1}{81}\\
\text{if }~k^{-\frac{1}{2}}=−2:\\
...
x^{\frac{1}{4}}+6=0~\text{ or }~x^{\frac{1}{4}}−3=0\\
x^{\frac{1}{4}}=−6~\text{ or }~x^{\frac{1}{4}}=3\\
\text{if }~x^{\frac{1}{4}}=−6:\\
(x^{\frac{1}{4}})^{4}=(−6)^{4}\\
x=1296\\
\text{if }~x^{\frac{1}{4}}=3:\\
