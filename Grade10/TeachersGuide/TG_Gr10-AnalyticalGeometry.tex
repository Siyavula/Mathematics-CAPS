...
\usefont{T1}{ptm}{m}{n}
\rput(0.99671876,-4.1892185){O}
\psline[linewidth=0.04](9.0,2.7807813)(2.0,3.7807813)(8.04,-4.179219)(8.98,2.8007812)
\usefont{T1}{ptm}{m}{n}
\rput(2.1214063,4.0307813){$P(1;8)$}
\usefont{T1}{ptm}{m}{n}
\rput(9.441406,3.0707812){$Q(8;7)$}
\usefont{T1}{ptm}{m}{n}
\rput(7.891406,-4.4892187){$R(7;0)$}
\usefont{T1}{ptm}{m}{n}
\rput(9.181406,-4.1692185){$x$}
\usefont{T1}{ptm}{m}{n}
\rput(0.9714062,5.0107813){$y$}
\end{pspicture} 
}\\
$m_PQ = \frac{8 - 7}{1 - 8} \\
 = -\frac{1}{7}\\
m_RQ = \frac{7 - 0}{8 - 7}\\
 = \frac{7}{1}\\
m_PR \times m_RQ = -\frac{1}{7} \frac{7}{1}\\
 = -1\\
\text{therefore } P\hat{Q}R = 90^{\circ}\\
\text{Length}_PQ = \sqrt{(1-8)^2 + (8 -7)^2}\\
 = \sqrt{49 + 1}\\
 = \sqrt{50}\\
\text{Length}_RQ = \sqrt{(8-7)^2 + (7 - 0)^2}\\
 = \sqrt{1 + 49}\\
 = \sqrt{50}\\
\text{Therefore } PQ = RQ$\\
Therefore $\Delta PQR$ is a rightangled, isosceles triangle.
\item %solution12
\scalebox{.4} % Change this value to rescale the drawing.
{
...
\usefont{T1}{ptm}{m}{n}
\rput(6.016719,-1.2192187){O}
\psline[linewidth=0.04](8.94,-3.2692187)(2.94,2.7507813)(0.94,-3.1892188)(8.94,-3.2692187)
\usefont{T1}{ptm}{m}{n}
\rput(2.9714062,2.9607813){$A(-3;4)$}
\usefont{T1}{ptm}{m}{n}
\rput(8.991406,-3.5392187){$B(3;-2)$}
\usefont{T1}{ptm}{m}{n}
\rput(0.89140624,-3.4392188){$C(-5;-2)$}
...
\usefont{T1}{ptm}{m}{n}
\rput(6.5114064,-0.19921875){$N$}
\usefont{T1}{ptm}{m}{n}
\rput(1.4414062,-0.19921875){$M$}
\usefont{T1}{ptm}{m}{n}
\rput(10.321406,-1.2192187){$x$}
\usefont{T1}{ptm}{m}{n}
\rput(5.9514065,4.040781){$y$}
\end{pspicture} 
}\\
...
N = (\frac{-3 + 3}{2} ; \frac{4 - 2}{2})\\
    = (0;1)\\
m_CB = 0~~(\text{parallel to } x\text{-axis})\\
m_MN = 0\\
MN \text{ parallel } CB\\
