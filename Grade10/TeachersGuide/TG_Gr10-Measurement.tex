...
\item \begin{enumerate}[itemsep=5pt, label=\textbf{\alph*}.]
  \item $\text{large rectangle} = \text{perimeter of small rectangle} \times \text{length} \\
= (10 + 7 + 10 + 7) \times 6 \\
= 34 \times 6 \\
= 204 ~cm^2 \\
2 \times \text{small rectangle} = 2(7 \times 10) \\
= 2(70) \\
= 140 ~cm^2\\
\text{large rectangle} + 2 \times \text{(small rectangle)} = 204 + 140 = 344 ~cm^2$
  \item $\text{area of large rectangle} = \text{circumference of circle} \times \text{length}\\
= 2 \pi \times r \times l \\
...
x = \sqrt{50} \\
x = 7,07 ~cm \\
\text{perimeter of triangle} = 10 + 7,07 + 7,07 \\
= 24,14 ~cm\\
...
= 532,8 ~cm^2$
      \end{enumerate}
  \item \begin{enumerate}[itemsep=5pt, label=\textbf{\alph*}.]
  \item $\text{Surface area} = \text{area of bottom of pool} + 2\text{(area of long sides)} + 2\text{(area of short sides)}\\
...
= 56,55~m$\\
The painter will need $\frac{57}{2} = 29$ litres of paint (rounded up to the nearest litre).
      \end{enumerate}
\end{enumerate}}
\end{solutions}
...
= 1~256,64 ~cm^2$
      \end{enumerate}
\item \begin{enumerate}[itemsep=5pt, label=\textbf{\alph*}.]
       \item $\text{Volume} = \frac{1}{3} \times \pi (r)^2 \times H\\
= \frac{1}{3} \pi (5)^2 (13) \\
= 108,33 ~cm^3$
...
= 27 \\
h = 5,20 ~cm$\\
 $\text{Volume} = \frac{1}{3} \times \frac{1}{2} bh \times H \\
= \frac{1}{3} \times \frac{1}{2}(27)(6) \times (10) \\
= 270 ~cm^{3}$
  \item $\text{Volume} = \frac{1}{3} \times b^{2} \times H \\
= \frac{1}{3} (6)^2(12) \\
= 144 ~cm^{3}$
  \item $\text{Volume} = \frac{4}{3} \pi r^{3}\\
= \frac{4}{3} \pi (10)^{3}\\
= 4~188,79~cm^{3}$
      \end{enumerate}
\item $\text{Volume} = \text{volume of cube} + \text{volume of square pyramid}\\
