...
%6
\item
We first need to construct the perpendicular height. If we do this such that we divide th base in half we get:\\
$h^2 = 3^2 + 5^2 \\
h = \sqrt{34}\\
h = 5,83 \mbox{ cm}\\
A = \frac{1}{2}\mbox{base} \times \mbox{height}\\
...
\item \begin{enumerate}[itemsep=5pt, label=\textbf{(\alph*)}]
  \item $\mbox{Area large rectangle} = \mbox{perimeter of small rectangle} \times \mbox{length} \\
= (10 + 7 + 10 + 7) \times 6 \\
= 34 \times 6 \\
= 204$ cm$^2$ \\
Area of 2 \times \mbox{small rectangle} = 2(7 \times 10) \\
= 2(70) \\
= 140$ cm$^2$\\
\mbox{Area of large rectangle} + 2 \times \mbox{(small rectangle)} = 204 + 140 = 344 ~cm^2$
...
new volume = area of base $\times 2 \times$ height \\
...
= 83~775,8 ~$cm$^{3}$\\
Total volume $= 251~327,4 + 83~775,8 = 335~103,2 ~$cm$^{3}$\\
\end{enumerate}}
\end{eocsolutions}
