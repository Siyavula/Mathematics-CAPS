...
\scalebox{1.0}{
%	\begin{pspicture}(-1.5,-1.5)(1,1)
%	    \psset{yunit=0.1,xunit=0.1}
% 	    \psset{viewpoint=0 0 200}
%	    \psSolid[object=prisme,action=draw,axe=0 0 1,base=-0.4 0 0 0.3 0.4 0,h=1.2, RotX=90]
%            \psLineIIID[linestyle=dashed]
%	\end{pspicture}}
%\end{center}



% vertices of the prism. Easiest way to do it it seems. Bah!
\savedata{\mydata}[{0, 0, 0}, {8,0,0}, {4,3,0}, {0,0,0}, {0,0,12}, {4,3,12}, {4,3,0}]
\begin{pspicture}(-1.5,-1.5)(1,1)
    \psset{yunit=0.1,xunit=0.1}
    \listplotThreeD{\mydata}
\end{pspicture}}
\end{center}
