  ...
  \begin{center}
    \scalebox{0.7}{% Change this value to rescale the drawing.
      \begin{pspicture}(0,-5.4207597)(13.96,5.741175)
        ...
        % \usefont{T1}{ptm}{m}{n}
        \rput{0.6029805}(0.004622919,-0.1373882){\rput(13.026947,0.3702635){$15$ cm}}
        % \usefont{T1}{ptm}{m}{n}
        \rput{-1.0300905}(-0.006498412,0.16914946){\rput(9.374943,0.4457077){$15$ cm}}
        % \usefont{T1}{ptm}{m}{n}
        \rput{90.771416}(14.303988,-7.492464){\rput(10.82,3.3058937){ $12$ cm}}
        ...
        % \usefont{T1}{ptm}{m}{n}
        \rput{14.285164}(-0.57707244,-1.0637248){\rput(3.9257896,-2.8347287){$4$ cm}}
      \end{pspicture} 
    }
  \end{center}
  \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
