...
\begin{tabular}{|C|D|E|}
    ...
    \begin{center}
      \scalebox{0.9}{
        \footnotesize\begin{pspicture}(-2,-0.5)(5,2)
    ...
    \begin{center} 
      \scalebox{0.9}{
        \footnotesize\begin{pspicture}(0,-0.5)(5,2)
...
{
\footnotesize\begin{pspicture}(0,-1.403125)(5.6790624,1.403125)
...
\begin{center}
\scalebox{0.9}{
\footnotesize\begin{pspicture}(0,-4.758281)(14.921875,4.758281)
...
\begin{figure}[H]
    \begin{center}
	%% Rectangular Prism
	\footnotesize\begin{pspicture}(-2,-3.5)(3,1.5)
...
\begin{figure}[H]
	...
	%% Triangular Prism
    \scalebox{0.8}{
	\footnotesize\begin{pspicture}(-1.5,-1.5)(1,1)
	    \psset{yunit=0.9,xunit=0.9}
% 	    \psset{Alpha=60,Beta=30}
...
\scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-1.8707813)(4.78,1.8484201)
...
\scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-3.538172)(7.78,3.5381718)
...
\scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-0.8885703)(2.856284,0.844914)
...
\item Calculate the surface area of the following prisms:
  ...
  \begin{figure}[H]
    \begin{center}
      \scalebox{1}{% Change this value to rescale the drawing.
        \footnotesize\begin{pspicture}(0,-4.3556247)(11.315155,4.3556247)
...
\item If a litre of paint covers an area of $2$ m$^{2}$, how much paint does a painter need to cover:
  ...
  \begin{figure}[H] % horizontal\label{m39357*id62926}
    \begin{center}
      \scalebox{1}{% Change this value to rescale the drawing.
        \footnotesize\begin{pspicture}(0,-1.6)(3.8067188,1.6)
...
&
\begin{center}
\footnotesize\begin{pspicture}(0,-1.3537499)(4.565781,1.3337499)
...
\scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-1.8337499)(4.9209375,1.8137499)
...
\scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-1.05)(2.761875,1.05)
...
\scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-0.96908206)(5.3072424,1.2741187)
...
\scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-1.8489062)(4.7628126,1.8289062)
...
\scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-4.0576563)(12.394375,4.0376563)
...
{
\footnotesize\begin{pspicture}(0,-0.9969445)(9.265889,0.99705553)
...
{
\footnotesize\begin{pspicture}(0,-1.9993507)(4.767494,1.9734617)
...
\scalebox{0.7} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-2.0793507)(4.2198644,2.0534618)
...
{
\footnotesize\begin{pspicture}(0,-3.1099448)(4.5657654,3.1100557)
...
\scalebox{0.7} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-1.9)(3.8,1.9)
...
\scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-2.1164062)(4.2998643,2.0964062)
...
{
\footnotesize\begin{pspicture}(0,-2.1564062)(4.64,2.097329)
...
\scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-2.07)(6.5141115,2.0841112)
...
\begin{center}
 \scalebox{1} % Change this value to rescale the drawing. 
{ \footnotesize\begin{pspicture}(0,-1.2046875)(7.8553123,1.1646875) 
...
\scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-1.9993507)(4.767494,1.9734619)
\pspolygon[linewidth=0.028222222,fillstyle=solid](0.095092274,-0.42983752)(2.4242375,1.9593507)(3.794405,-0.18333401)
\pspolygon[linewidth=0.028222222,fillstyle=solid](4.753383,-1.2623826)(2.4242375,1.9593507)(1.0540702,-1.5190883)
\pspolygon[linewidth=0.028222222,fillstyle=solid](1.0593361,-1.5190883)(2.3858888,1.9269619)(0.0,-0.46889564)
\psline[linewidth=0.022cm,linestyle=dashed,dash=0.16cm 0.16cm](0.0,-0.46889564)(3.0107446,-0.23551947)
...
\scalebox{0.8} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-2.89)(5.58,2.89)
% \usefont{T1}{ptm}{m}{n}
...
\scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-2.0893507)(4.2198644,2.0634618)
...
\begin{center}
  \scalebox{1}{% Change this value to rescale the drawing.
    \footnotesize\begin{pspicture}(0,-2.0664062)(5.57,2.0464063)
...
\scalebox{0.8} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-6.555141)(11.58,6.555141)
...
\begin{center}
 \scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-1.8370537)(6.719142,2.2091963)
...
\scalebox{0.8} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-0.9664062)(2.8190625,0.94640625)
...
{
\footnotesize\begin{pspicture}(0,-1.4867684)(2.0090625,1.4667684)
...
\scalebox{.8} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-1.696225)(4.1590624,1.716225)
...
{
\footnotesize\begin{pspicture}(0,-1.8564062)(5.8090625,1.8764062)
...
\scalebox{0.65} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-1.8990625)(6.586406,1.8690625)
...
\scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-1.2891959)(5.494142,1.2016168)
...
\scalebox{1} % Change this value to rescale the drawing.
{
\footnotesize\begin{pspicture}(0,-1.1364063)(4.0990624,1.1164062)
...
{Consider a cylinder with a radius of $r$ and a height of
  ...
  $k$.
\begin{center}
\footnotesize\begin{pspicture}(0,-1.6)(3.5434375,1.6) 
\psellipse[linewidth=0.04,dimen=outer](1.29,-1.09)(1.27,0.51) 
\psellipse[linewidth=0.04,dimen=outer](1.27,1.09)(1.27,0.51) 
\psline[linewidth=0.04cm](0.04,-1.1)(0.02,1.14) 
\psline[linewidth=0.04cm](2.54,1.12)(2.56,-1.1) 
...
\item Consider the solids below and answer the questions that follow (correct to $1$ decimal place, if necessary):
  \begin{center}
    \scalebox{0.8}{% Change this value to rescale the drawing.
      \footnotesize\begin{pspicture}(0,-3.9464064)(10.693593,3.9264061)
...
\item Consider the solids below:
  \begin{center}
    \scalebox{0.7}{% Change this value to rescale the drawing.
      \footnotesize\begin{pspicture}(0,-5.4207597)(13.96,5.741175)
...
\item Calculate the volume and surface area of the solid below (correct to $1$ decimal place):
  \begin{center}
    \scalebox{1}{% Change this value to rescale the drawing.
      \footnotesize\begin{pspicture}(0,-1.4992187)(4.081249,1.5192188)
