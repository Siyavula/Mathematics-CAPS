...
\label{m38359*fhsst!!!underscore!!!id74}\begin{definition}
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
      ...
      \label{m38359*id62750}The \begin{math}{n}^{\mathrm{th}}\end{math} power of \begin{math}a\end{math} is defined as:\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {a}^{n}=a\ensuremath{\times}a\ensuremath{\times}\cdots \ensuremath{\times}a\phantom{\rule{2.em}{0ex}}\left(\mathrm{n\; times}\right)\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (5.2)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
      ...
      \label{m38359*id62819}with \begin{math}a\end{math} multiplied by itself \begin{math}n\end{math} times.\par 
      \label{m38359*id62840}We can also define what it means if we have a negative exponent \begin{math}-n\end{math}. Then,\par 
      \label{m38359*uid2}\nopagebreak\noindent{}\settowidth{\mymathboxwidth}{\begin{equation}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {a}^{-n}=\frac{1}{a\ensuremath{\times}a\ensuremath{\times}\cdots \ensuremath{\times}a\phantom{\rule{2.em}{0ex}}\left(\mathrm{n\; times}\right)}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (5.3)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\begin{tabular}{cc}
	...
	\par
      ...
      \label{m38359*id62918}If \begin{math}n\end{math} is an even integer, then \begin{math}{a}^{n}\end{math} will always be positive for any non-zero real number \begin{math}a\end{math}. For example, although \begin{math}-2\end{math} is negative, \begin{math}{\left(-2\right)}^{2}=-2\ensuremath{\times}-2=4\end{math} is positive and so is \begin{math}{\left(-2\right)}^{-2}=\frac{1}{-2\ensuremath{\times}-2}=\frac{1}{4}\end{math}.\par \label{m38359*eip-180}
 ...
 \end{figure}   
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {a}^{0}=1{a}^{m}\ensuremath{\times}{a}^{n}={a}^{m+n}{a}^{-n}=\frac{1}{{a}^{n}}{a}^{m}÷{a}^{n}={a}^{m-n}{\left(ab\right)}^{n}={a}^{n}{b}^{n}{\left({a}^{m}\right)}^{n}={a}^{mn}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (5.4)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 ...
 \end{figure}   
    ...
    \addtocounter{footnote}{-0}
    \par \label{m38359*id63888}Our definition of exponential notation shows that\par 
        \label{m38359*uid12}\nopagebreak\noindent{}\settowidth{\mymathboxwidth}{\begin{equation}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {2}^{7}\ensuremath{\times}{2}^{3}=\left(2\ensuremath{\times}2\ensuremath{\times}2\ensuremath{\times}2\ensuremath{\times}2\ensuremath{\times}2\ensuremath{\times}2\right)\ensuremath{\times}\left(2\ensuremath{\times}2\ensuremath{\times}2\right)={2}^{7+3}={2}^{10}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (5.7)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 ...
 (1.) lO7  & \end{tabular}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {a}^{-n}=1÷a÷...÷a\left(\mathrm{n\; times}\right)=\frac{1}{1\ensuremath{\times}a\ensuremath{\times}\cdots \ensuremath{\times}a}\left(\mathrm{n\; times}\right)=\frac{1}{{a}^{n}}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (5.8)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {2}^{-7}=\frac{1}{2\ensuremath{\times}2\ensuremath{\times}2\ensuremath{\times}2\ensuremath{\times}2\ensuremath{\times}2\ensuremath{\times}2}=\frac{1}{{2}^{7}}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (5.9)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\settowidth{\mymathboxwidth}{\begin{equation}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \frac{{a}^{-3}}{{a}^{4}}=\frac{1}{{a}^{3}{a}^{4}}=\frac{1}{{a}^{7}}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (5.10)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 ...
 (1.) lcx  & \end{tabular}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \frac{{a}^{m}}{{a}^{n}}={a}^{m}{a}^{-n}={a}^{m-n}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (5.11)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {2}^{7}÷{2}^{3}=\frac{2\ensuremath{\times}2\ensuremath{\times}2\ensuremath{\times}2\ensuremath{\times}2\ensuremath{\times}2\ensuremath{\times}2}{2\ensuremath{\times}2\ensuremath{\times}2}=2\ensuremath{\times}2\ensuremath{\times}2\ensuremath{\times}2={2}^{4}={2}^{7-3}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (5.12)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 ...
 (1.) lOA  & \end{tabular}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {\left(ab\right)}^{n}=a\ensuremath{\times}b\ensuremath{\times}a\ensuremath{\times}b\ensuremath{\times}...\ensuremath{\times}a\ensuremath{\times}b\left(\mathrm{n\; times}\right)=a\ensuremath{\times}a\ensuremath{\times}...\ensuremath{\times}a\left(\mathrm{n\; times}\right)\phantom{\rule{-0.166667em}{0ex}}\phantom{\rule{-0.166667em}{0ex}}\phantom{\rule{-0.166667em}{0ex}}\phantom{\rule{-0.166667em}{0ex}}\ensuremath{\times}b\ensuremath{\times}b\ensuremath{\times}...\ensuremath{\times}b\left(\mathrm{n\; times}\right)={a}^{n}{b}^{n}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (5.13)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 ...
 (1.) lOs  & \end{tabular}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {\left({a}^{m}\right)}^{n}={a}^{m}\ensuremath{\times}{a}^{m}\ensuremath{\times}...\ensuremath{\times}{a}^{m}\left(\mathrm{n\; times}\right)=a\ensuremath{\times}a\ensuremath{\times}...\ensuremath{\times}a\left(\mathrm{m}\ensuremath{\times}\mathrm{n\; times}\right)={a}^{mn}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (5.15)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {\left({2}^{2}\right)}^{3}=\left({2}^{2}\right)\ensuremath{\times}\left({2}^{2}\right)\ensuremath{\times}\left({2}^{2}\right)=\left(2\ensuremath{\times}2\right)\ensuremath{\times}\left(2\ensuremath{\times}2\right)\ensuremath{\times}\left(2\ensuremath{\times}2\right)=\left({2}^{6}\right)={2}^{\left(2\ensuremath{\times}3\right)}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (5.16)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\label{m38359*eip-323}\par
    ...
    \label{m38359*id117610}Simplify: \begin{math}\frac{{5}^{2x-1}\ensuremath{\cdot}{9}^{x-2}}{{15}^{2x-3}}\end{math} \par 
    \vspace{5pt}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    =\frac{{5}^{2x-1}\ensuremath{\cdot}{\left({3}^{2}\right)}^{x-2}}{{\left(5.3\right)}^{2x-3}}=\frac{{5}^{2x-1}\ensuremath{\cdot}{3}^{2x-4}}{{5}^{2x-3}\ensuremath{\cdot}{3}^{2x-3}}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (5.17)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    ={5}^{2x-1-2x+3}\ensuremath{\cdot}{3}^{2x-4-2x+3}={5}^{2}\ensuremath{\cdot}{3}^{-1}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (5.18)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
