...
%             
%       
%       \label{m39250*id143934}This chapter is all about solving different types of equations for one or two variables. In general, we want to get the unknown variable alone on the left hand side of the equation with all the constants on the right hand side of the equation. For example, in the equation $x-1=0$\hspace{1ex}, we want to be able to write the equation as \begin{math}x=1\end{math}.\par 
...
%         \label{m39250*id144333}For example, in the equation $x+5-1=-6$\hspace{1ex}, we want to get \begin{math}x\end{math} alone on the left hand side of the equation. This means we need to subtract 5 and add 1 on the left hand side. However, because we need to keep the equation balanced, we also need to subtract 5 and add 1 on the right hand side.\par 
...
%     x+5-1=-6x+5-5-1+1=-6-5+1x+0+0=-11+1x=-10$}\hfill
...
%     
%         
%         \label{m39250*id144503}In another example, $\frac{2}{3}x=8$, we must divide by 2 and multiply by 3 on the left hand side in order to get \begin{math}x\end{math} alone. However, in order to keep the equation balanced, we must also divide by 2 and multiply by 3 on the right hand side.\par 
...
%     \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
%     \parbox[t]{\mymathboxwidth}{\large$
%     \frac{2}{3}x=8\frac{2}{3}xÃ\ensuremath{\cdot}2Ã---3=8Ã\ensuremath{\cdot}2Ã---3\frac{2}{2}Ã---\frac{3}{3}Ã---x=\frac{8Ã---3}{2}1Ã---1Ã---x=12x=12$}\hfill
%     \parbox[t]{48pt}{\raggedleft 
%     (9.2)}
%     \end{minipage}\vspace{12pt}\par
%     }% end of conditional for this bit of math
...
% \label{m39250*uid3}\item If $\frac{x}{y}=0$, then \begin{math}x=0\end{math} and \begin{math}y\^{a}‰~0\end{math}, because division by 0 is
% undefined.
% \end{enumerate}
%         
% 
...
%     \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
%     \parbox[t]{\mymathboxwidth}{\large$
%     x=24x-8=3x-64\left(x-2\right)=3\left(x-2\right)\frac{4\left(x-2\right)}{\left(x-2\right)}=\frac{3\left(x-2\right)}{\left(x-2\right)}4=3$}\hfill
%     \parbox[t]{48pt}{\raggedleft 
%     (9.3)}
%     \end{minipage}\vspace{12pt}\par
%     }% end of conditional for this bit of math
...
following are examples of linear equations.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    2x+2=1\frac{2-x}{3x+1}=2\frac{4}{3}x-6=7x+2$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.4)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
chapter.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    2x+2=12x=1-2\left(\mathrm{like\; terms\; together}\right)2x=-1\left(\mathrm{simplified\; as\; much\; as\; possible}\right)$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.5)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    \mathrm{LHS}=2x+2=2\left(-\frac{1}{2}\right)+2=-1+2=1\mathrm{and}\mathrm{RHS}=1$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.7)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
Bearing in mind that the sign of the terms will change from ($+$) to (\begin{math}-\end{math}) or vice
...
\label{m39241*eip-126}
 ...
 \end{figure}       \par \label{m39241*secfhsst!!!underscore!!!id646}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.1:  Solving Linear Equations }
        ...
        \label{m39241*id145728}Solve for $x$: \begin{math}4-x=4\end{math} \par 
        \vspace{5pt}
        ...
        \label{m39241*id145775}We are given $4-x=4$ and are required to solve for \begin{math}x\end{math}.\par 
        \item  
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    4-x=4-x=4-4\left(\mathrm{Rearrange}\right)-x=0\left(\mathrm{group\; like\; terms}\right)\^{a}ˆ´x=0$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.8)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \item  
        \label{m39241*id146070}The solution of $4-x=4$ is \begin{math}x=0\end{math}.
 \par 
        \end{enumerate}
    \end{exercise}
    \end{mdframed}
...
\label{m39241*secfhsst!!!underscore!!!id822}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.2:  Solving Linear Equations }
        ...
        \label{m39241*id146127}Solve for $x$: \begin{math}4\left(2x-9\right)-4x=4-6x\end{math} \par 
        \vspace{5pt}
        \label{m39241*solfhsst!!!underscore!!!id826}\noindent\textbf{Solution to Exercise } \label{m39241*listfhsst!!!underscore!!!id826}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39241*id146196}We are given $4\left(2x-9\right)-4x=4-6x$ and are required to solve for \begin{math}x\end{math}.\par 
        \item  
...
simplifying.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    4\left(2\left(4\right)-9\right)-4\left(4\right)=4-6\left(4\right)4\left(8-9\right)-16=4-244\left(-1\right)-16=-20-4-16=-20-20=-20$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.11)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \item  
        \label{m39241*id146854}The solution of $4\left(2x-9\right)-4x=4-6x$ is \begin{math}x=4\end{math}.
 \par 
        \end{enumerate}
    \end{exercise}
    \end{mdframed}
...
\label{m39241*secfhsst!!!underscore!!!id1189}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.3:  Solving Linear Equations }
        ...
        \label{m39241*id146935}Solve for $x$: \begin{math}\frac{2-x}{3x+1}=2\end{math} \par 
        \vspace{5pt}
        \label{m39241*solfhsst!!!underscore!!!id1193}\noindent\textbf{Solution to Exercise } \label{m39241*listfhsst!!!underscore!!!id1193}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39241*id146999}We are given $\frac{2-x}{3x+1}=2$ and are required to solve for \begin{math}x\end{math}.\par 
        \item  
...
is a restriction on a value for x. ($x\^{a}‰~\frac{-1}{3}$)\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    \frac{2-\left(0\right)}{3\left(0\right)+1}=2\frac{2}{1}=2$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.13)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \item  
        \label{m39241*id147525}The solution of $\frac{2-x}{3x+1}=2$ is \begin{math}x=0\end{math}.
 \par 
        \end{enumerate}
    \end{exercise}
    \end{mdframed}
...
\label{m39241*secfhsst!!!underscore!!!id1472}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.4:  Solving Linear Equations }
        ...
        \label{m39241*id147599}Solve for $x$: \begin{math}\frac{4}{3}x-6=7x+2\end{math} \par 
        \vspace{5pt}
        \label{m39241*solfhsst!!!underscore!!!id1476}\noindent\textbf{Solution to Exercise } \label{m39241*listfhsst!!!underscore!!!id1476}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39241*id147662}We are given $\frac{4}{3}x-6=7x+2$ and are required to solve for \begin{math}x\end{math}.\par 
        \item  
...
grouping like terms and then simplifying.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    \frac{4}{3}x-6=7x+24x-18=21x+6\left(\mathrm{each\; term\; is\; multiplied\; by}\phantom{\rule{3pt}{0ex}}3\right)4x-21x=6+18\left(\mathrm{rearrange}\right)-17x=24\left(\mathrm{simplify\; grouped\; terms}\right)\frac{-17}{-17}x=\frac{24}{-17}\left(\mathrm{divide\; both\; sides\; by}\phantom{\rule{2pt}{0ex}}-17\right)x=\frac{-24}{17}$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.14)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    \frac{4}{3}Ã---\frac{-24}{17}-6=7Ã---\frac{-24}{17}+2\frac{4Ã---\left(-8\right)}{\left(17\right)}-6=\frac{7Ã---\left(-24\right)}{17}+2\frac{\left(-32\right)}{17}-6=\frac{-168}{17}+2\frac{-32-102}{17}=\frac{\left(-168\right)+34}{17}\frac{-134}{17}=\frac{-134}{17}$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.15)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \item  
        \label{m39241*id148321}The solution of $\frac{4}{3}x-6=7x+2$ is,\ensuremath{\hat{A}}~\ensuremath{\hat{A}}~\ensuremath{\hat{A}}~\begin{math}x=\frac{-24}{17}\end{math}.
 \par 
        \end{enumerate}
    \end{exercise}
    \end{mdframed}
...
\label{m39241*secfhsst!!!underscore!!!id1862}
        ...
        \label{m39241*id148396}\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
            \label{m39241*uid11}\item Solve for $y$: \begin{math}2y-3=7\end{math}\hspace{1ex}        
\label{m39241*uid12}\item Solve for $y$: \begin{math}-3y=0\end{math}\hspace{1ex}        
\label{m39241*uid13}\item Solve for $y$: \begin{math}4y=16\end{math}\hspace{1ex}        
\label{m39241*uid14}\item Solve for $y$: \begin{math}12y+0=144\end{math}\hspace{1ex}        
\label{m39241*uid15}\item Solve for $y$: \begin{math}7+5y=62\end{math}\hspace{1ex}        
\label{m39241*uid16}\item Solve for $x$: \begin{math}55=5x+\frac{3}{4}\end{math}\hspace{1ex}        
\label{m39241*uid17}\item Solve for $x$: \begin{math}5x=3x+45\end{math}\hspace{1ex}        
\label{m39241*uid18}\item Solve for $x$: \begin{math}23x-12=6+2x\end{math}\hspace{1ex}        
\label{m39241*uid19}\item Solve for $x$: \begin{math}12-6x+34x=2x-24-64\end{math}\hspace{1ex}        
\label{m39241*uid20}\item Solve for $x$: \begin{math}6x+3x=4-5\left(2x-3\right)\end{math}\hspace{1ex}        
\label{m39241*uid21}\item Solve for $p$: \begin{math}18-2p=p+9\end{math}\hspace{1ex}        
\label{m39241*uid22}\item Solve for $p$: \begin{math}\frac{4}{p}=\frac{16}{24}\end{math}\hspace{1ex}        
\label{m39241*uid23}\item Solve for $p$: \begin{math}\frac{4}{1}=\frac{p}{2}\end{math}\hspace{1ex}        
\label{m39241*uid24}\item Solve for $p$: \begin{math}-\left(-16-p\right)=13p-1\end{math}\hspace{1ex}        
\label{m39241*uid25}\item Solve for $p$: \begin{math}6p-2+2p=-2+4p+8\end{math}\hspace{1ex}        
\label{m39241*uid26}\item Solve for $f$: \begin{math}3f-10=10\end{math}\hspace{1ex}        
\label{m39241*uid27}\item Solve for $f$: \begin{math}3f+16=4f-10\end{math}\hspace{1ex}        
\label{m39241*uid28}\item Solve for $f$: \begin{math}10f+5+0=-2f+-3f+80\end{math}\hspace{1ex}        
\label{m39241*uid29}\item Solve for $f$: \begin{math}8\left(f-4\right)=5\left(f-4\right)\end{math}\hspace{1ex}        
\label{m39241*uid30}\item Solve for $f$: \begin{math}6=6\left(f+7\right)+5f\end{math}\hspace{1ex}        
\end{enumerate}
\label{m39241**end}
...
2. The following are examples of quadratic equations.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    2{x}^{2}+2x=1\frac{2-x}{3x+1}=2x\frac{4}{3}x-6=7{x}^{2}+2$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.16)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
a product of two expressions in brackets. For example, we know that:\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    \left(x+1\right)\left(2x-3\right)=2{x}^{2}-x-3.$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.17)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
      \label{m39247*id149590}we need to be able to write $2{x}^{2}-x-3$ as \begin{math}\left(x+1\right)\left(2x-3\right)\end{math}, which we already know
% how to do. The reason for equating to zero and factoring is that if we attempt to solve it in a 'normal' way, we may miss one of the solutions. On the other hand, if we have the (non-linear) equation $f\left(x\right)g\left(x\right)=0$, for some functions \begin{math}f\end{math} and \begin{math}g\end{math}, we know that the solution is \begin{math}f\left(x\right)=0\end{math} OR \begin{math}g\left(x\right)=0\end{math}, which allows us to find BOTH solutions (or know that there is only one solution if it turns out that \begin{math}f=g\end{math}).\par 
...
% $\left(x-1\right)\left(x-2\right)=0$. This means that both \begin{math}x-1=0\end{math} and \begin{math}x-2=0\end{math}, which gives \begin{math}x=1\end{math} and
% $x=2$ as the two solutions to the quadratic equation \begin{math}{x}^{2}-3x-2=0\end{math}.\par 
      \label{m39247*uid36}
...
so as to obtain an equation of the form $a{x}^{2}+bx+c=0$ where \begin{math}a\end{math}, \begin{math}b\end{math} and
$c$ have no common factors. For example, \begin{math}2{x}^{2}+4x+2=0\end{math}\hspace{1ex} can be written as
${x}^{2}+2x+1=0$\hspace{1ex} by dividing by 2.
\label{m39247*uid38}\item Write $a{x}^{2}+bx+c$ in terms of its factors \begin{math}\left(rx+s\right)\left(ux+v\right)\end{math}.
...
follows that the two solutions are $x=-\frac{s}{r}$ or \begin{math}x=-\frac{u}{v}\end{math}.
...
\label{m39247*eip-388}
 ...
 \end{figure}       \par \label{m39247*secfhsst!!!underscore!!!id2133}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.5: Solving Quadratic Equations }\label{m39247*probfhsst!!!underscore!!!id2134}
        \label{m39247*id150403}Solve for $x$: \begin{math}3{x}^{2}+2x-1=0\end{math} \par 
        \vspace{5pt}
        \label{m39247*solfhsst!!!underscore!!!id2137}\noindent\textbf{Solution to Exercise } \label{m39247*listfhsst!!!underscore!!!id2137}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39247*id150496}As we have seen the factors of $3{x}^{2}+2x-1$ are \begin{math}\left(x+1\right)\end{math} and \begin{math}\left(3x-1\right)\end{math}.\par 
        \item  
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    \left(x+1\right)\left(3x-1\right)=0$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.19)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        \label{m39247*id150664}Therefore, $x=-1$ or \begin{math}x=\frac{1}{3}\end{math}.\par 
        ...
        \label{m39247*id150708}$3{x}^{2}+2x-1=0$\hspace{1ex} for \begin{math}x=-1\end{math} or \begin{math}x=\frac{1}{3}\end{math}.
 \par 
        \end{enumerate}
    \end{exercise}
    \end{mdframed}
...
%     \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
%     \parbox[t]{\mymathboxwidth}{\large$
%     ax+b=\frac{c}{x}x\left(ax+b\right)=x\left(\frac{c}{x}\right)a{x}^{2}+bx=c$}\hfill
%     \parbox[t]{48pt}{\raggedleft 
%     (9.22)}
%     \end{minipage}\vspace{12pt}\par
%     }% end of conditional for this bit of math
...
%     \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
%     \parbox[t]{\mymathboxwidth}{\large$
%     \frac{1}{a{x}^{2}+bx}=c{\left(\frac{1}{a{x}^{2}+bx}\right)}^{-1}={\left(c\right)}^{-1}\frac{a{x}^{2}+bx}{1}=\frac{1}{c}a{x}^{2}+bx=\frac{1}{c}$}\hfill
%     \parbox[t]{48pt}{\raggedleft 
%     (9.23)}
%     \end{minipage}\vspace{12pt}\par
%     }% end of conditional for this bit of math
...
%     \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
%     \parbox[t]{\mymathboxwidth}{\large$
%     \sqrt{a{x}^{2}+bx}=c{\left(\sqrt{a{x}^{2}+bx}\right)}^{2}={c}^{2}a{x}^{2}+bx={c}^{2}$}\hfill
%     \parbox[t]{48pt}{\raggedleft 
%     (9.24)}
%     \end{minipage}\vspace{12pt}\par
%     }% end of conditional for this bit of math
...
%     \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
%     \parbox[t]{\mymathboxwidth}{\large$
%     \frac{1}{\sqrt{a{x}^{2}+bx}}=c{\left(\frac{1}{a{x}^{2}+bx}\right)}^{-1}={\left(c\right)}^{-1}\left(\mathrm{invert\; both\; sides}\right)\frac{\sqrt{a{x}^{2}+bx}}{1}=\frac{1}{c}\sqrt{a{x}^{2}+bx}=\frac{1}{c}{\left(\sqrt{a{x}^{2}+bx}\right)}^{2}={\left(\frac{1}{c}\right)}^{2}\left(\mathrm{square\; both\; sides}\right)a{x}^{2}+bx=\frac{1}{{c}^{2}}$}\hfill
%     \parbox[t]{48pt}{\raggedleft 
%     (9.25)}
%     \end{minipage}\vspace{12pt}\par
%     }% end of conditional for this bit of math
...
%         \label{m39247*id151608}Solve for $x$: \begin{math}\sqrt{x+2}=x\end{math} \par 
%         \vspace{5pt}
...
%     \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
%     \parbox[t]{\mymathboxwidth}{\large$
%     x+2={x}^{2}\left(\mathrm{subtract}\phantom{\rule{2pt}{0ex}}{\mathrm{x}}^{2}\phantom{\rule{2pt}{0ex}}\mathrm{from\; both\; sides}\right)x+2-{x}^{2}=0\left(\mathrm{divide\; both\; sides\; by}\phantom{\rule{2pt}{0ex}}-1\right)-x-2+{x}^{2}=0{x}^{2}-x+2=0$}\hfill
%     \parbox[t]{48pt}{\raggedleft 
%     (9.27)}
%     \end{minipage}\vspace{12pt}\par
%     }% end of conditional for this bit of math
...
%     
%         
%         \label{m39247*id151944}The factors of ${x}^{2}-x+2$ are \begin{math}\left(x-2\right)\left(x+1\right)\end{math}.\par 
%         \item  
...
%     \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
%     \parbox[t]{\mymathboxwidth}{\large$
%     \left(x-2\right)\left(x+1\right)=0$}\hfill
%     \parbox[t]{48pt}{\raggedleft 
%     (9.29)}
%     \end{minipage}\vspace{12pt}\par
%     }% end of conditional for this bit of math
...
%     
%         
%         \label{m39247*id152096}Therefore, $x=-1$ or \begin{math}x=2\end{math}.\par 
%         \item  
%         \label{m39247*id152138}Substitute $x=-1$\hspace{1ex}into the original equation \begin{math}\sqrt{x+2}=x\end{math}:\par 
...
%     \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
%     \parbox[t]{\mymathboxwidth}{\large$
%     \mathrm{LHS}=\sqrt{\left(-1\right)+2}=\sqrt{1}=1\mathrm{but}\mathrm{RHS}=\left(-1\right)$}\hfill
%     \parbox[t]{48pt}{\raggedleft 
%     (9.32)}
%     \end{minipage}\vspace{12pt}\par
%     }% end of conditional for this bit of math
...
%         \label{m39247*id152325}Now substitute $x=2$ into original equation \begin{math}\sqrt{x+2}=x\end{math}:\par 
...
%     \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
%     \parbox[t]{\mymathboxwidth}{\large$
%     \mathrm{LHS}=\sqrt{2+2}=\sqrt{4}=2\mathrm{and}\mathrm{RHS}=2$}\hfill
%     \parbox[t]{48pt}{\raggedleft 
%     (9.33)}
%     \end{minipage}\vspace{12pt}\par
%     }% end of conditional for this bit of math
...
%         \item  
%         \label{m39247*id152489}$\sqrt{x+2}=x$ for \begin{math}x=2\end{math} only.
%  \par 
%         \end{enumerate}
%          
% 
...
So the factors are:\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    {x}^{2}+3x-4=\left(x-1\right)\left(x+4\right)=0$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.34)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
        \label{m39247*id152772}Therefore $x=1$ or \begin{math}x=-4\end{math}.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    {\left(-4\right)}^{2}+3\left(-4\right)-4=0$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.36)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\item  
        \label{m39247*id152812}Therefore the solutions are $x=1$ or \begin{math}x=-4\end{math}.
 \par 
        \end{enumerate}
    \end{exercise}
    \end{mdframed}
...
Therefore, divide both sides of the equation by -2.\par 
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39247*id153108}If we multiply out $\left(x-1\right)\left(x-1\right)$, we get \begin{math}{x}^{2}-2x+1\end{math}.\par 
        \item  
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    {x}^{2}-2x+1=\left(x-1\right)\left(x-1\right)=0$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.38)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
for $x$: \begin{math}x=1\end{math}.\par 
        \item  
        \label{m39247*id1532632}$-2{\left(1\right)}^{2}+4\left(1\right)-2=0$.
 \par 
        \item  
        \label{m39247*id153262}The root of $0=-2{x}^{2}+4x-2$ is \begin{math}x=1\end{math}.
 \par 
        \end{enumerate}
    \end{exercise}
    \end{mdframed}
...
\label{m39247*secfhsst!!!underscore!!!id2946}
        ...
        \label{m39247*id153332}\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
            \label{m39247*uid44}\item Solve for $x$: \begin{math}\left(3x+2\right)\left(3x-4\right)=0\end{math}\hspace{1ex}        
\label{m39247*uid45}\item Solve for $x$: \begin{math}\left(5x-9\right)\left(x+6\right)=0\end{math}\hspace{1ex}        
\label{m39247*uid46}\item Solve for $x$: \begin{math}\left(2x+3\right)\left(2x-3\right)=0\end{math}\hspace{1ex}        
\label{m39247*uid47}\item Solve for $x$: \begin{math}\left(2x+1\right)\left(2x-9\right)=0\end{math}\hspace{1ex}        
\label{m39247*uid48}\item Solve for $x$: \begin{math}\left(2x-3\right)\left(2x-3\right)=0\end{math}\hspace{1ex}        
\label{m39247*uid49}\item Solve for $x$: \begin{math}20x+25{x}^{2}=0\end{math}\hspace{1ex}        
\label{m39247*uid50}\item Solve for $x$: \begin{math}4{x}^{2}-17x-77=0\end{math}\hspace{1ex}        
\label{m39247*uid51}\item Solve for $x$: \begin{math}2{x}^{2}-5x-12=0\end{math}  \hspace{1ex}        
\label{m39247*uid52}\item Solve for $x$: \begin{math}-75{x}^{2}+290x-240=0\end{math}\hspace{1ex}        
\label{m39247*uid53}\item Solve for $x$: \begin{math}2x=\frac{1}{3}{x}^{2}-3x+14\frac{2}{3}\end{math}\hspace{1ex}        
\label{m39247*uid54}\item Solve for $x$: \begin{math}{x}^{2}-4x=-4\end{math}\hspace{1ex}        
\label{m39247*uid55}\item Solve for $x$: \begin{math}-{x}^{2}+4x-6=4{x}^{2}-5x+3\end{math}\hspace{1ex}        
\label{m39247*uid56}\item Solve for $x$: \begin{math}{x}^{2}=3x\end{math}\hspace{1ex}        
\label{m39247*uid57}\item Solve for $x$: \begin{math}3{x}^{2}+10x-25=0\end{math}\hspace{1ex}        
\label{m39247*uid58}\item Solve for $x$: \begin{math}{x}^{2}-x+3\end{math}\hspace{1ex}\hspace{1ex}        
\label{m39247*uid59}\item Solve for $x$: \begin{math}{x}^{2}-4x+4=0\end{math}\hspace{1ex}        \label{m39247*uid60}\item Solve for \begin{math}x\end{math}: \begin{math}{x}^{2}-6x=7\end{math}\hspace{1ex}        
\label{m39247*uid61}\item Solve for $x$: \begin{math}14{x}^{2}+5x=6\end{math}\hspace{1ex}        
\label{m39247*uid62}\item Solve for $x$: \begin{math}2{x}^{2}-2x=12\end{math}\hspace{1ex}        
\label{m39247*uid63}\item Solve for $x$: \begin{math}3{x}^{2}+2y-6={x}^{2}-x+2\end{math}\hspace{1ex}        
\end{enumerate}
\label{m39247**end}
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 \par \begin{tabular}[h]{cccccc}
...
\label{m39257*id158940}Thus far, all equations that have been encountered have one unknown variable that must be solved for. When two unknown variables need to be solved for, two equations are required and these equations are known as simultaneous equations. The solutions to the system of simultaneous equations are the values of the unknown variables which satisfy the system of equations simultaneously, that means at the same time. In general, if there are $n$ unknown variables, then \begin{math}n\end{math} equations are required to obtain a solution for each of the \begin{math}n\end{math} variables.\par 
 ...
 \label{m39257*uid97}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    \frac{2-x}{3y+1}=2\frac{2-\left(\frac{1}{2}-y\right)}{3y+1}=22-\left(\frac{1}{2}-y\right)=2\left(3y+1\right)2-\frac{1}{2}+y=6y+2y-6y=-2+\frac{1}{2}+2-5y=\frac{1}{2}y=-\frac{1}{10}$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.72)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    \^{a}ˆ´x=\frac{1}{2}-y=\frac{1}{2}-\left(-\frac{1}{10}\right)=\frac{6}{10}=\frac{3}{5}$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.73)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\par
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    4y+3x=1003x=100-4yx=\frac{100-4y}{3}$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.76)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    4y-19\left(\frac{100-4y}{3}\right)=1212y-19\left(100-4y\right)=3612y-1900+76y=3688y=1936y=22$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.77)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    x=\frac{100-4\left(22\right)}{3}=\frac{100-88}{3}=\frac{12}{3}=4$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.78)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    4\left(22\right)+3\left(4\right)=88+12=1004\left(22\right)-19\left(4\right)=88-76=12$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.79)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\subsubsection{Solution by Elimination}
    ...
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m39257*uid96!!!underscore!!!media}\label{m39257*uid96!!!underscore!!!printimage}\includegraphics[width=.8\columnwidth]{col11306.imgs/m39257_MG10C10_006.png} % m39257;MG10C10\_006.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{.1in}
    \rule[.1in]{\figurerulewidth}{.005in} \\
    \end{center}
 \end{figure}       
        \label{m39257*id159137}The intersection of the two graphs is $\left(2,1\right)$. So the solution to the system of simultaneous equations in (9.65) is \begin{math}y=1\end{math} and \begin{math}x=2\end{math}.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    x=2y\^{a}ˆ´y=2\left(2y\right)-3y-4y=-3-3y=-3y=1\mathrm{Substitute\; into\; the\; first\; equation:}\phantom{\rule{2.em}{0ex}}\mathrm{x}=2\left(1\right)=2$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.66)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\par
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    4y+3x=1004y=100-3xy=25-\frac{3}{4}x$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.68)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    4y-19x=124y=19x+12y=\frac{19}{4}x+3$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.69)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
$3a-2b7=0$ , \begin{math}a-4b+1=0\end{math}\hspace{1ex}        
\label{m39257*uid99}\item Solve algebraically: $15c+11d-132=0$, \begin{math}2c+3d-59=0\end{math}\hspace{1ex}        
\label{m39257*uid100}\item Solve algebraically: $-18e-18+3f=0$, \begin{math}e-4f+47=0\end{math}\hspace{1ex}        
\label{m39257*uid101}\item Solve graphically: $x+2y=7$, \begin{math}x+y=0\end{math}\hspace{1ex}        
\end{enumerate}
\label{m39257**end}
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 \par \begin{tabular}[h]{cccccc}
...
%             
        ...
        \label{m39262*id161565}Let's help Jane find out what her marks are. We have two unknowns, Tom's mark (which we shall call $t$) and Jane's mark (which we shall call \begin{math}j\end{math}). Tom has 2 more marks than Jane. Therefore,\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    t+j=14j+2+j=142j+2=142\left(j+1\right)=14j+1=7j=7-1=6$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.86)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\end{enumerate}
    ...
    \noindent\textbf{Exercise 9.18:  Mathematical Modelling: Two variables }
        ...
        \label{m39262*solfhsst!!!underscore!!!id6180}\noindent\textbf{Solution to Exercise } \label{m39262*listfhsst!!!underscore!!!id6180}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39262*id162412}Let the cost of one ruler be $x$ rand and the cost of one pen be \begin{math}y\end{math} rand.\par 
        \item  
        \label{m39262*uid111}\nopagebreak\noindent{}
          \settowidth{\mymathboxwidth}{\begin{equation}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    3x+2\left(8-x\right)=213x+16-2x=21x=5$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.90)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
 ...
 \label{m39257*secfhsst!!!underscore!!!id5599}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.16:  Bicycles and Tricycles }
        ...
        \item  
        \label{m39257*id160923}If $b$ is the number of bicycles and \begin{math}t\end{math} is the number of tricycles, then:\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    b=7-t\mathrm{Into\; second\; equation:}2\left(7-\mathrm{t}\right)+3\mathrm{t}=1914-2t+3t=19t=5\mathrm{Into\; first\; equation:}:\mathrm{b}=7-5=2$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.81)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    2+5=72\left(2\right)+3\left(5\right)=4+15=19$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.82)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\label{m39262*secfhsst!!!underscore!!!id6031}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.19: Mathematical Modelling: One variable }\label{m39262*probfhsst!!!underscore!!!id6032}
        ...
        \label{m39262*solfhsst!!!underscore!!!id6035}\noindent\textbf{Solution to Exercise } \label{m39262*listfhsst!!!underscore!!!id6035}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39262*eip-121}Let the price of a chocolate milkshake be $x$ and the price of a fruitshake be \begin{math}y\end{math}.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    3\left(x+2\right)+5x=783x+6+5x=788x=72x=9y=x+2=9+2=11$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.93)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
%             \nopagebreak
%             
\label{m39258*eip-224}A literal equation is one that has several letters or variables. Examples include the area of a circle ($A=\mathrm{Ï€}{r}^{2}$) and the formula for speed (\begin{math}s=\frac{d}{t}\end{math}). In this section you will learn how to solve literal equations in terms of one variable. To do this, you will use the principles you have learnt about solving equations and apply them to rearranging literal equations. Solving literal equations is also known as changing the subject of the formula.
\par 
...
on number lines:\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    2x+2\^{a}‰¤1\frac{2-x}{3x+1}\^{a}‰¥2\frac{4}{3}x-6\lessthan{}7x+2$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.55)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
that $8\greatthan{}6$. If both sides of the inequality are divided by \begin{math}-2\end{math}, \begin{math}-4\end{math} is not
...
a minus sign, the direction of the inequality changes. For this reason you cannot divide or multiply by a variable.
	...
	\end{tabular}
	\par
      \label{m39254*id157457}For example, if $x\lessthan{}1$, then \begin{math}-x\greatthan{}-1\end{math}.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    2x+2=12x=1-22x=-1x=-\frac{1}{2}$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.56)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \begin{center}
    \label{m39254*id157630!!!underscore!!!media}\label{m39254*id157630!!!underscore!!!printimage}\includegraphics[width=.8\columnwidth]{col11306.imgs/m39254_MG10C10_001.png} % m39254;MG10C10\_001.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{.1in}
    \end{center}
 \end{figure}       
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    2x+2\^{a}‰¤12x\^{a}‰¤1-22x\^{a}‰¤-1x\^{a}‰¤-\frac{1}{2}$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.57)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \begin{center}
    \label{m39254*id157774!!!underscore!!!media}\label{m39254*id157774!!!underscore!!!printimage}\includegraphics[width=.8\columnwidth]{col11306.imgs/m39254_MG10C10_002.png} % m39254;MG10C10\_002.png;;;6.0;8.5;
      \vspace{2pt}
    \vspace{.1in}
    \end{center}
 \end{figure}       
...
\label{m39254*eip-441}
 ...
 \end{figure}       \par \label{m39254*secfhsst!!!underscore!!!id4213}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.11:  Linear Inequalities }
      ...
      \label{m39254*id157808}Solve for $r$: \begin{math}6-r\greatthan{}2\end{math} \par 
      \vspace{5pt}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    -r\greatthan{}2-6-r\greatthan{}-4$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.58)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\label{m39254*secfhsst!!!underscore!!!id4271}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.12:  Linear Inequalities }
      ...
      \label{m39254*id157972}Solve for $q$: \begin{math}4q+3\lessthan{}2\left(q+3\right)\end{math} and represent the solution on a number line. \par 
      \vspace{5pt}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    4q+3\lessthan{}2\left(q+3\right)4q+3\lessthan{}2q+6$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.60)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    4q+3\lessthan{}2q+64q-2q\lessthan{}6-32q\lessthan{}3$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.61)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large$
    2q\lessthan{}3\mathrm{Divide\; both\; sides\; by}\phantom{\rule{2pt}{0ex}}2q\lessthan{}\frac{3}{2}$}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.62)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\label{m39254*secfhsst!!!underscore!!!id4447}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.13:  Compound Linear Inequalities }
      ...
      \label{m39254*id158322}Solve for $x$: \begin{math}5\^{a}‰¤x+3\lessthan{}8\end{math} and represent solution on a number line. \par 
      \vspace{5pt}
...
\label{m39254*id158514}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \label{m39254*uid83}\item $3x+4\greatthan{}5x+8$\label{m39254*uid84}\item \begin{math}3\left(x-1\right)-2\^{a}‰¤6x+4\end{math}\label{m39254*uid85}\item \begin{math}\frac{x-7}{3}\greatthan{}\frac{2x-3}{2}\end{math}\label{m39254*uid86}\item \begin{math}-4\left(x-1\right)\lessthan{}x+2\end{math}\label{m39254*uid87}\item \begin{math}\frac{1}{2}x+\frac{1}{3}\left(x-1\right)\^{a}‰¥\frac{5}{6}x-\frac{1}{3}\end{math}\end{enumerate}
        \hspace{1ex}        
...
\end{enumerate}
\label{m39254*uid91}\item Solve for $x$: \begin{math}7\left(3x+2\right)-5\left(2x-3\right)\greatthan{}7\end{math}\hspace{1ex}Illustrate this answer on a number line.\hspace{1ex}        
\end{enumerate}
\label{m39254**end}
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 \par \begin{tabular}[h]{cccccc}
...
\hspace{1ex}        
\label{m39263*uid122}\item In the equation $y=2{x}^{2}-5x-18$, which is a value of \begin{math}x\end{math} when \begin{math}y=0\end{math}\hspace{1ex}?
\hspace{1ex}        
...
\label{m39263*uid128}\item if $x\^{a}ˆˆ\mathbb{Z}$ and \begin{math}x\lessthan{}51\end{math}, write the solution as a set of integers.
\end{enumerate}
        \hspace{1ex}        
\label{m39263*uid129}\item Solve for $a$: \begin{math}\frac{1-a}{2}-\frac{2-a}{3}\greatthan{}1\end{math}\hspace{1ex}        
\label{m39263*uid130}\item Solve for $x$: \begin{math}x-1=\frac{42}{x}\end{math}\hspace{1ex}        
\label{m39263*uid131}\item Solve for $x$ and \begin{math}y\end{math}: \begin{math}7x+3y=13\end{math} and \begin{math}2x-3y=-4\end{math}\hspace{1ex}        
\end{enumerate}
    \label{m39263**end}
