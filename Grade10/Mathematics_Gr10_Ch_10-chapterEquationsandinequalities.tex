    ...
    x+5-1=-6x+5-5-1+1=-6-5+1x+0+0=-11+1x=-10\end{math}}\hfill
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39250*id144503}In another example, \begin{math}\frac{2}{3}x=8\end{math}, we must divide by 2 and multiply by 3 on the left hand side in order to get \begin{math}x\end{math} alone. However, in order to keep the equation balanced, we must also divide by 2 and multiply by 3 on the right hand side.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \frac{2}{3}x=8\frac{2}{3}xÃ\ensuremath{\cdot}2Ã---3=8Ã\ensuremath{\cdot}2Ã---3\frac{2}{2}Ã---\frac{3}{3}Ã---x=\frac{8Ã---3}{2}1Ã---1Ã---x=12x=12\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.2)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\label{m39250*uid3}\item If \begin{math}\frac{x}{y}=0\end{math}, then \begin{math}x=0\end{math} and \begin{math}y\^{a}‰~0\end{math}, because division by 0 is
undefined.
\end{enumerate}
...
identify what is wrong.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    x=24x-8=3x-64\left(x-2\right)=3\left(x-2\right)\frac{4\left(x-2\right)}{\left(x-2\right)}=\frac{3\left(x-2\right)}{\left(x-2\right)}4=3\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.3)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
equation where the power of the variable(letter, e.g. \begin{math}x\end{math}) is 1(one). The
following are examples of linear equations.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    2x+2=1\frac{2-x}{3x+1}=2\frac{4}{3}x-6=7x+2\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.4)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
chapter.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    2x+2=12x=1-2\left(\mathrm{like\; terms\; together}\right)2x=-1\left(\mathrm{simplified\; as\; much\; as\; possible}\right)\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.5)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
      ...
      \label{m39241*id145430}Now we see that \begin{math}2x=-1\end{math}. This means if we divide both sides by 2, we will get:\par 
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
      ...
      \label{m39241*id145475}If we substitute \begin{math}x=-\frac{1}{2}\end{math}, back into the original equation, we get:\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \mathrm{LHS}=2x+2=2\left(-\frac{1}{2}\right)+2=-1+2=1\mathrm{and}\mathrm{RHS}=1\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.7)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
substitute the solution into the original equation, to check your answer.
	...
	\par
      ...
      \label{m39241*uid4}
            \subsubsection{ Method: Solving Linear Equations}
            \nopagebreak
...
Bearing in mind that the sign of the terms will change from (\begin{math}+\end{math}) to (\begin{math}-\end{math}) or vice
...
\label{m39241*eip-126}
 ...
 \end{figure}   
    ...
    \par \label{m39241*secfhsst!!!underscore!!!id646}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.1:  Solving Linear Equations }
        ...
        \label{m39241*id145728}Solve for \begin{math}x\end{math}: \begin{math}4-x=4\end{math} \par 
        \vspace{5pt}
        ...
        \label{m39241*id145775}We are given \begin{math}4-x=4\end{math} and are required to solve for \begin{math}x\end{math}.\par 
        \item  
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    4-x=4-x=4-4\left(\mathrm{Rearrange}\right)-x=0\left(\mathrm{group\; like\; terms}\right)\^{a}ˆ´x=0\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.8)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \item  
        \label{m39241*id146070}The solution of \begin{math}4-x=4\end{math} is \begin{math}x=0\end{math}.
 \par 
        \end{enumerate}
...
\label{m39241*secfhsst!!!underscore!!!id822}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.2:  Solving Linear Equations }
        ...
        \label{m39241*id146127}Solve for \begin{math}x\end{math}: \begin{math}4\left(2x-9\right)-4x=4-6x\end{math} \par 
        \vspace{5pt}
        \label{m39241*solfhsst!!!underscore!!!id826}\noindent\textbf{Solution to Exercise } \label{m39241*listfhsst!!!underscore!!!id826}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39241*id146196}We are given \begin{math}4\left(2x-9\right)-4x=4-6x\end{math} and are required to solve for \begin{math}x\end{math}.\par 
        \item  
...
simplifying.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    4\left(2x-9\right)-4x=4-6x8x-36-4x=4-6x\left(\mathrm{expand\; the\; brackets}\right)8x-4x+6x=4+36\left(\mathrm{Rearrange}\right)\left(8x-4x+6x\right)=\left(4+36\right)\left(\mathrm{group\; like\; terms}\right)10x=40\left(\mathrm{simplify\; grouped\; terms}\right)\frac{10}{10}x=\frac{40}{10}\left(\mathrm{divide\; both\; sides\; by}\phantom{\rule{2pt}{0ex}}10\right)x=4\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.10)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    4\left(2\left(4\right)-9\right)-4\left(4\right)=4-6\left(4\right)4\left(8-9\right)-16=4-244\left(-1\right)-16=-20-4-16=-20-20=-20\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.11)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39241*id146831}Since both sides are equal to \begin{math}-20\end{math}, the answer is correct.\par 
        \item  
        \label{m39241*id146854}The solution of \begin{math}4\left(2x-9\right)-4x=4-6x\end{math} is \begin{math}x=4\end{math}.
 \par 
        \end{enumerate}
...
\label{m39241*secfhsst!!!underscore!!!id1189}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.3:  Solving Linear Equations }
        ...
        \label{m39241*id146935}Solve for \begin{math}x\end{math}: \begin{math}\frac{2-x}{3x+1}=2\end{math} \par 
        \vspace{5pt}
        \label{m39241*solfhsst!!!underscore!!!id1193}\noindent\textbf{Solution to Exercise } \label{m39241*listfhsst!!!underscore!!!id1193}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39241*id146999}We are given \begin{math}\frac{2-x}{3x+1}=2\end{math} and are required to solve for \begin{math}x\end{math}.\par 
        \item  
        \label{m39241*id147046}Since there is a denominator of (\begin{math}3x+1\end{math}), we can start by multiplying both sides
of the equation by (\begin{math}3x+1\end{math}). But because division by 0 is not permissible, there
is a restriction on a value for x. (\begin{math}x\^{a}‰~\frac{-1}{3}\end{math})\par 
        \item  
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \frac{2-x}{3x+1}=2\left(2-x\right)=2\left(3x+1\right)2-x=6x+2\left(\mathrm{expand\; brackets}\right)-x-6x=2-2\left(\mathrm{rearrange}\right)-7x=0\left(\mathrm{simplify\; grouped\; terms}\right)x=0Ã\ensuremath{\cdot}\left(-7\right)\^{a}ˆ´\; \; \phantom{\rule{2.em}{0ex}}x=0\left(\mathrm{zero\; divided\; by\; any\; number\; is}\phantom{\rule{3pt}{0ex}}0\right)\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.12)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \frac{2-\left(0\right)}{3\left(0\right)+1}=2\frac{2}{1}=2\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.13)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \item  
        \label{m39241*id147525}The solution of \begin{math}\frac{2-x}{3x+1}=2\end{math} is \begin{math}x=0\end{math}.
 \par 
        \end{enumerate}
...
\label{m39241*secfhsst!!!underscore!!!id1472}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.4:  Solving Linear Equations }
        ...
        \label{m39241*id147599}Solve for \begin{math}x\end{math}: \begin{math}\frac{4}{3}x-6=7x+2\end{math} \par 
        \vspace{5pt}
        \label{m39241*solfhsst!!!underscore!!!id1476}\noindent\textbf{Solution to Exercise } \label{m39241*listfhsst!!!underscore!!!id1476}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39241*id147662}We are given \begin{math}\frac{4}{3}x-6=7x+2\end{math} and are required to solve for \begin{math}x\end{math}.\par 
        \item  
...
grouping like terms and then simplifying.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \frac{4}{3}x-6=7x+24x-18=21x+6\left(\mathrm{each\; term\; is\; multiplied\; by}\phantom{\rule{3pt}{0ex}}3\right)4x-21x=6+18\left(\mathrm{rearrange}\right)-17x=24\left(\mathrm{simplify\; grouped\; terms}\right)\frac{-17}{-17}x=\frac{24}{-17}\left(\mathrm{divide\; both\; sides\; by}\phantom{\rule{2pt}{0ex}}-17\right)x=\frac{-24}{17}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.14)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \frac{4}{3}Ã---\frac{-24}{17}-6=7Ã---\frac{-24}{17}+2\frac{4Ã---\left(-8\right)}{\left(17\right)}-6=\frac{7Ã---\left(-24\right)}{17}+2\frac{\left(-32\right)}{17}-6=\frac{-168}{17}+2\frac{-32-102}{17}=\frac{\left(-168\right)+34}{17}\frac{-134}{17}=\frac{-134}{17}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.15)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\label{m39241*uid29}\item Solve for \begin{math}f\end{math}: \begin{math}8\left(f-4\right)=5\left(f-4\right)\end{math}\hspace{1ex}        
\label{m39241*uid30}\item Solve for \begin{math}f\end{math}: \begin{math}6=6\left(f+7\right)+5f\end{math}\hspace{1ex}        
\end{enumerate}
...
2. The following are examples of quadratic equations.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    2{x}^{2}+2x=1\frac{2-x}{3x+1}=2x\frac{4}{3}x-6=7{x}^{2}+2\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.16)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
a product of two expressions in brackets. For example, we know that:\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \left(x+1\right)\left(2x-3\right)=2{x}^{2}-x-3.\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.17)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\label{m39247*eip-388}
 ...
 \end{figure}   
    ...
    \noindent\textbf{Exercise 9.5: Solving Quadratic Equations }\label{m39247*probfhsst!!!underscore!!!id2134}
        \label{m39247*id150403}Solve for \begin{math}x\end{math}: \begin{math}3{x}^{2}+2x-1=0\end{math} \par 
        \vspace{5pt}
        \label{m39247*solfhsst!!!underscore!!!id2137}\noindent\textbf{Solution to Exercise } \label{m39247*listfhsst!!!underscore!!!id2137}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39247*id150496}As we have seen the factors of \begin{math}3{x}^{2}+2x-1\end{math} are \begin{math}\left(x+1\right)\end{math} and \begin{math}\left(3x-1\right)\end{math}.\par 
        \item  
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \left(x+1\right)\left(3x-1\right)=0\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.19)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39247*id150664}Therefore, \begin{math}x=-1\end{math} or \begin{math}x=\frac{1}{3}\end{math}.\par 
        ...
        \label{m39247*id150708}\begin{math}3{x}^{2}+2x-1=0\end{math}\hspace{1ex} for \begin{math}x=-1\end{math} or \begin{math}x=\frac{1}{3}\end{math}.
 \par 
        \end{enumerate}
...
\label{m39247*id150815}\nopagebreak\noindent{}\settowidth{\mymathboxwidth}{\begin{equation}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    ax+b=\frac{c}{x}x\left(ax+b\right)=x\left(\frac{c}{x}\right)a{x}^{2}+bx=c\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.22)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
    \label{m39247*uid41}\item This is raising both sides to the power of \begin{math}-1\end{math}. For example,
\label{m39247*id150952}\nopagebreak\noindent{}\settowidth{\mymathboxwidth}{\begin{equation}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \frac{1}{a{x}^{2}+bx}=c{\left(\frac{1}{a{x}^{2}+bx}\right)}^{-1}={\left(c\right)}^{-1}\frac{a{x}^{2}+bx}{1}=\frac{1}{c}a{x}^{2}+bx=\frac{1}{c}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.23)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\label{m39247*id151148}\nopagebreak\noindent{}\settowidth{\mymathboxwidth}{\begin{equation}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \sqrt{a{x}^{2}+bx}=c{\left(\sqrt{a{x}^{2}+bx}\right)}^{2}={c}^{2}a{x}^{2}+bx={c}^{2}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.24)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \frac{1}{\sqrt{a{x}^{2}+bx}}=c{\left(\frac{1}{a{x}^{2}+bx}\right)}^{-1}={\left(c\right)}^{-1}\left(\mathrm{invert\; both\; sides}\right)\frac{\sqrt{a{x}^{2}+bx}}{1}=\frac{1}{c}\sqrt{a{x}^{2}+bx}=\frac{1}{c}{\left(\sqrt{a{x}^{2}+bx}\right)}^{2}={\left(\frac{1}{c}\right)}^{2}\left(\mathrm{square\; both\; sides}\right)a{x}^{2}+bx=\frac{1}{{c}^{2}}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.25)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\label{m39247*secfhsst!!!underscore!!!id2417}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.6:  Solving Quadratic Equations }
        ...
        \label{m39247*id151608}Solve for \begin{math}x\end{math}: \begin{math}\sqrt{x+2}=x\end{math} \par 
        \vspace{5pt}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    x+2={x}^{2}\left(\mathrm{subtract}\phantom{\rule{2pt}{0ex}}{\mathrm{x}}^{2}\phantom{\rule{2pt}{0ex}}\mathrm{from\; both\; sides}\right)x+2-{x}^{2}=0\left(\mathrm{divide\; both\; sides\; by}\phantom{\rule{2pt}{0ex}}-1\right)-x-2+{x}^{2}=0{x}^{2}-x+2=0\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.27)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39247*id151944}The factors of \begin{math}{x}^{2}-x+2\end{math} are \begin{math}\left(x-2\right)\left(x+1\right)\end{math}.\par 
        \item  
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \left(x-2\right)\left(x+1\right)=0\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.29)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39247*id152096}Therefore, \begin{math}x=-1\end{math} or \begin{math}x=2\end{math}.\par 
        \item  
        \label{m39247*id152138}Substitute \begin{math}x=-1\end{math}\hspace{1ex}into the original equation \begin{math}\sqrt{x+2}=x\end{math}:\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \mathrm{LHS}=\sqrt{\left(-1\right)+2}=\sqrt{1}=1\mathrm{but}\mathrm{RHS}=\left(-1\right)\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.32)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \mathrm{LHS}=\sqrt{2+2}=\sqrt{4}=2\mathrm{and}\mathrm{RHS}=2\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.33)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39247*id152464}Therefore \begin{math}x=2\end{math} is the only valid solution\par 
        \item  
        \label{m39247*id152489}\begin{math}\sqrt{x+2}=x\end{math} for \begin{math}x=2\end{math} only.
 \par 
        \end{enumerate}
...
\label{m39247*secfhsst!!!underscore!!!id2778}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.7:  Solving Quadratic Equations }
        ...
        \label{m39247*id152550}Solve the equation: \begin{math}{x}^{2}+3x-4=0\end{math}. \par 
        \vspace{5pt}
        \label{m39247*solfhsst!!!underscore!!!id2782}\noindent\textbf{Solution to Exercise } \label{m39247*listfhsst!!!underscore!!!id2782}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39247*id152636}The equation is in the required form, with \begin{math}a=1\end{math}.\par 
        \item  
        \label{m39247*id152658}You need the factors of 1 and 4 so that the middle term is \begin{math}+3\end{math}
So the factors are:\par 
        \label{m39247*id152673}
          \begin{math}\left(x-1\right)\left(x+4\right)\end{math}
        \par 
        \item  
        \label{m39247*uid43}\nopagebreak\noindent{}
          \settowidth{\mymathboxwidth}{\begin{equation}
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39247*id152772}Therefore \begin{math}x=1\end{math} or \begin{math}x=-4\end{math}.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {1}^{2}+3\left(1\right)-4=0\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.35)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {\left(-4\right)}^{2}+3\left(-4\right)-4=0\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.36)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\item  
        \label{m39247*id152812}Therefore the solutions are \begin{math}x=1\end{math} or \begin{math}x=-4\end{math}.
 \par 
        \end{enumerate}
...
equation \begin{math}0=-2{x}^{2}+4x-2\end{math}. \par 
        \vspace{5pt}
...
Therefore, divide both sides of the equation by -2.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    -2{x}^{2}+4x-2=0{x}^{2}-2x+1=0\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.37)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \item  
        \label{m39247*id153076}The middle term is negative. Therefore, the factors are \begin{math}\left(x-1\right)\left(x-1\right)\end{math}\par 
        \label{m39247*id153108}If we multiply out \begin{math}\left(x-1\right)\left(x-1\right)\end{math}, we get \begin{math}{x}^{2}-2x+1\end{math}.\par 
        \item  
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {x}^{2}-2x+1=\left(x-1\right)\left(x-1\right)=0\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.38)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\label{m39253*cid5}
            \subsection{ Equations and inequalities: Exponential equations}
            \nopagebreak
...
following are examples of exponential equations:\par 
      \label{m39253*id154451}\nopagebreak\noindent{}
        \settowidth{\mymathboxwidth}{\begin{equation}
    \begin{array}{ccc}\hfill {2}^{x}& =& 1\hfill \\ \hfill \frac{{2}^{-x}}{{3}^{x+1}}& =& 2\hfill \\ \hfill \frac{4}{3}-6& =& {7}^{x}+2\hfill \end{array}\tag{9.39}
      \end{equation}
    }
    \typeout{Columnwidth = \the\columnwidth}\typeout{math as usual width = \the\mymathboxwidth}
    \ifthenelse{\lengthtest{\mymathboxwidth < \columnwidth}}{% if the math fits, do it again, for real
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {2}^{x}=1\frac{{2}^{-x}}{{3}^{x+1}}=2\frac{4}{3}-6={7}^{x}+2\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.39)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\label{m39253*secfhsst!!!underscore!!!id3051}
      ...
      \label{m39253*id154568}Solve the following
equations by completing the table:\par 
      
    % \textbf{m39253*id154574}\par
...
that \begin{math}a\greatthan{}0\end{math}, (except when \begin{math}a=1\end{math}\hspace{1ex}) then:\par 
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
      ...
      \end{definition}
        ...
        \label{m39253*id155290}This means that if we can write all terms in an equation with the same base, we
...
\label{m39253*secfhsst!!!underscore!!!id3331}
          ...
          \label{m39253*id155428}Write the following with the same
...
\par
      ...
      \begin{mdframed}[linewidth=4, leftmargin=40, rightmargin=40]  
      \begin{exercise}
    \noindent\textbf{Exercise 9.9:  Solving Exponential Equations }
          \label{m39253*probfhsst!!!underscore!!!id3349}
          \label{m39253*id155596}Solve for \begin{math}x\end{math}: \begin{math}{2}^{x}=2\end{math} \par 
          \vspace{5pt}
          \label{m39253*solfhsst!!!underscore!!!id3352}\noindent\textbf{Solution to Exercise } \label{m39253*listfhsst!!!underscore!!!id3352}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
          \label{m39253*id155648}All terms are written with the same base.\par 
          \label{m39253*id155652}\nopagebreak\noindent{}
            \settowidth{\mymathboxwidth}{\begin{equation}
    {2}^{x}={2}^{1}\tag{9.45}
      \end{equation}
    }
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
          ...
          \item  
          \label{m39253*id155703}\nopagebreak\noindent{}\settowidth{\mymathboxwidth}{\begin{equation}
    \begin{array}{ccc}\hfill \mathrm{LHS}& =& {2}^{x}\hfill \\ & =& {2}^{1}\hfill \\ & =& 2\hfill \\ \hfill \mathrm{RHS}& =& {2}^{1}\hfill \\ & =& 2\hfill \\ & =& \mathrm{LHS}\hfill \end{array}\tag{9.47}
      \end{equation}
    }
    \typeout{Columnwidth = \the\columnwidth}\typeout{math as usual width = \the\mymathboxwidth}
    \ifthenelse{\lengthtest{\mymathboxwidth < \columnwidth}}{% if the math fits, do it again, for real
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \mathrm{LHS}={2}^{x}={2}^{1}=2\mathrm{RHS}={2}^{1}=2=\mathrm{LHS}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.47)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
          ...
          \label{m39253*id155766}Since both sides are equal, the answer is correct.\par 
          \item  
          \label{m39253*id155776}\nopagebreak\noindent{}
            \settowidth{\mymathboxwidth}{\begin{equation}
    x=1\tag{9.48}
      \end{equation}
    }
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
          ...
          \label{m39253*id155793}is the solution to \begin{math}{2}^{x}=2\end{math}.
 \par 
          \end{enumerate}
...
\label{m39253*secfhsst!!!underscore!!!id3440}\vspace{.5cm} 
      
      \noindent
      \hspace*{-30pt}\includegraphics[width=0.5in]{col11306.imgs/pspencil2.png}   \raisebox{25mm}{   
      \begin{mdframed}[linewidth=4, leftmargin=40, rightmargin=40]  
      \begin{exercise}
    \noindent\textbf{Exercise 9.10:  Solving Exponential Equations }
          \label{m39253*probfhsst!!!underscore!!!id3441}
          \label{m39253*id155842}Solve:\par 
          \label{m39253*id155848}\nopagebreak\noindent{}
            \settowidth{\mymathboxwidth}{\begin{equation}
    {2}^{x+4}={4}^{2x}\tag{9.49}
      \end{equation}
    }
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
          ...
          \vspace{5pt}
          \label{m39253*solfhsst!!!underscore!!!id3467}\noindent\textbf{Solution to Exercise } \label{m39253*listfhsst!!!underscore!!!id3467}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
          \label{m39253*id155907}\nopagebreak\noindent{}
            \settowidth{\mymathboxwidth}{\begin{equation}
    \begin{array}{ccc}\hfill {2}^{x+4}& =& {4}^{2x}\hfill \\ \hfill {2}^{x+4}& =& {2}^{2\left(2x\right)}\hfill \\ \hfill {2}^{x+4}& =& {2}^{4x}\hfill \end{array}\tag{9.50}
      \end{equation}
    }
    \typeout{Columnwidth = \the\columnwidth}\typeout{math as usual width = \the\mymathboxwidth}
    \ifthenelse{\lengthtest{\mymathboxwidth < \columnwidth}}{% if the math fits, do it again, for real
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {2}^{x+4}={4}^{2x}{2}^{x+4}={2}^{2\left(2x\right)}{2}^{x+4}={2}^{4x}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.50)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
          ...
          \item  
          \label{m39253*id156068}\nopagebreak\noindent{}
            \settowidth{\mymathboxwidth}{\begin{equation}
    \begin{array}{ccc}\hfill x+4& =& 4x\hfill \\ \hfill x-4x& =& -4\hfill \\ \hfill -3x& =& -4\hfill \\ \hfill x& =& \frac{-4}{-3}\hfill \\ \hfill x& =& \frac{4}{3}\hfill \end{array}\tag{9.52}
      \end{equation}
    }
    \typeout{Columnwidth = \the\columnwidth}\typeout{math as usual width = \the\mymathboxwidth}
    \ifthenelse{\lengthtest{\mymathboxwidth < \columnwidth}}{% if the math fits, do it again, for real
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    x+4=4xx-4x=-4-3x=-4x=\frac{-4}{-3}x=\frac{4}{3}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.52)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
          ...
          \item  
          \label{m39253*id156202}\nopagebreak\noindent{}
            \settowidth{\mymathboxwidth}{\begin{equation}
    \begin{array}{ccc}\hfill \mathrm{LHS}& =& {2}^{x+4}\hfill \\ & =& {2}^{\left(\frac{4}{3}+4\right)}\hfill \\ & =& {2}^{\frac{16}{3}}\hfill \\ & =& {\left({2}^{16}\right)}^{\frac{1}{3}}\hfill \\ \hfill \mathrm{RHS}& =& {4}^{2x}\hfill \\ & =& {4}^{2\left(\frac{4}{3}\right)}\hfill \\ & =& {4}^{\frac{8}{3}}\hfill \\ & =& {\left({4}^{8}\right)}^{\frac{1}{3}}\hfill \\ & =& {\left({\left({2}^{2}\right)}^{8}\right)}^{\frac{1}{3}}\hfill \\ & =& {\left({2}^{16}\right)}^{\frac{1}{3}}\hfill \\ & =& \mathrm{LHS}\hfill \end{array}\tag{9.53}
      \end{equation}
    }
    \typeout{Columnwidth = \the\columnwidth}\typeout{math as usual width = \the\mymathboxwidth}
    \ifthenelse{\lengthtest{\mymathboxwidth < \columnwidth}}{% if the math fits, do it again, for real
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \mathrm{LHS}={2}^{x+4}={2}^{\left(\frac{4}{3}+4\right)}={2}^{\frac{16}{3}}={\left({2}^{16}\right)}^{\frac{1}{3}}\mathrm{RHS}={4}^{2x}={4}^{2\left(\frac{4}{3}\right)}={4}^{\frac{8}{3}}={\left({4}^{8}\right)}^{\frac{1}{3}}={\left({\left({2}^{2}\right)}^{8}\right)}^{\frac{1}{3}}={\left({2}^{16}\right)}^{\frac{1}{3}}=\mathrm{LHS}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.53)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
          ...
          \label{m39253*id156509}Since both sides are equal, the answer is correct.\par 
          \item  
          \label{m39253*id156519}\nopagebreak\noindent{}
            \settowidth{\mymathboxwidth}{\begin{equation}
    x=\frac{4}{3}\tag{9.54}
      \end{equation}
    }
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
          ...
          \label{m39253*id156540}is the solution to \begin{math}{2}^{x+4}={4}^{2x}\end{math}.
 \par 
          \end{enumerate}
...
\label{m39253*uid74}\item The growth of an algae in a pond can be modeled by the function \begin{math}f\left(t\right)={2}^{t}\end{math}. Find the value of \begin{math}t\end{math} such that \begin{math}f\left(t\right)=128\end{math}\hspace{1ex}        
\label{m39253*uid75}\item Solve for \begin{math}x\end{math}: \begin{math}{25}^{\left(1-2x\right)}={5}^{4}\end{math}\hspace{1ex}        
\label{m39253*uid76}\item Solve for \begin{math}x\end{math}: \begin{math}{27}^{x}Ã---{9}^{x-2}=1\end{math}\hspace{1ex}        
\end{enumerate}
...
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 \par \begin{tabular}[h]{cccccc}
 (1.) lce  &  (2.) lct  &  (3.) lct  &  (4.) lcz  &  (5.) lcu  &  (6.) lcu  & \end{tabular}
...
on number lines:\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    2x+2\^{a}‰¤1\frac{2-x}{3x+1}\^{a}‰¥2\frac{4}{3}x-6\lessthan{}7x+2\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.55)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
that \begin{math}8\greatthan{}6\end{math}. If both sides of the inequality are divided by \begin{math}-2\end{math}, \begin{math}-4\end{math} is not
greater than \begin{math}-3\end{math}. Therefore, the inequality must switch around, making
\begin{math}-4\lessthan{}-3\end{math}.\par 
...
a minus sign, the direction of the inequality changes. For this reason you cannot divide or multiply by a variable.
	...
	\par
      ...
      \label{m39254*id157457}For example, if \begin{math}x\lessthan{}1\end{math}, then \begin{math}-x\greatthan{}-1\end{math}.\par 
      \label{m39254*id157494}In order to compare an inequality to a normal equation, we shall solve an equation first. Solve \begin{math}2x+2=1\end{math}.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    2x+2=12x=1-22x=-1x=-\frac{1}{2}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.56)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \begin{center}
    \label{m39254*id157630!!!underscore!!!media}\label{m39254*id157630!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39254_MG10C10_001.png} % m39254;MG10C10\_001.png;;;6.0;8.5;
 ...
 \end{figure}   
    ...
    \addtocounter{footnote}{-0}
      ...
      \par 
      \label{m39254*id157636}Now let us solve the inequality \begin{math}2x+2\^{a}‰¤1\end{math}.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    2x+2\^{a}‰¤12x\^{a}‰¤1-22x\^{a}‰¤-1x\^{a}‰¤-\frac{1}{2}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.57)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \begin{center}
    \label{m39254*id157774!!!underscore!!!media}\label{m39254*id157774!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39254_MG10C10_002.png} % m39254;MG10C10\_002.png;;;6.0;8.5;
...
\label{m39254*eip-441}
 ...
 \end{figure}   
    ...
    \addtocounter{footnote}{-0}
    \par \label{m39254*secfhsst!!!underscore!!!id4213}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.11:  Linear Inequalities }
      ...
      \label{m39254*id157808}Solve for \begin{math}r\end{math}: \begin{math}6-r\greatthan{}2\end{math} \par 
      \vspace{5pt}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    -r\greatthan{}2-6-r\greatthan{}-4\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.58)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \begin{center}
    \label{m39254*id157937!!!underscore!!!media}\label{m39254*id157937!!!underscore!!!printimage}\includegraphics{col11306.imgs/m39254_MG10C10_003.png} % ;MG10C10\_003.png;;;6.0;8.5;
...
\label{m39254*secfhsst!!!underscore!!!id4271}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.12:  Linear Inequalities }
      ...
      \label{m39254*id157972}Solve for \begin{math}q\end{math}: \begin{math}4q+3\lessthan{}2\left(q+3\right)\end{math} and represent the solution on a number line. \par 
      \vspace{5pt}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    4q+3\lessthan{}2\left(q+3\right)4q+3\lessthan{}2q+6\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.60)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    4q+3\lessthan{}2q+64q-2q\lessthan{}6-32q\lessthan{}3\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.61)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    2q\lessthan{}3\mathrm{Divide\; both\; sides\; by}\phantom{\rule{2pt}{0ex}}2q\lessthan{}\frac{3}{2}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.62)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \begin{center}
    \label{m39254*id158287!!!underscore!!!media}\label{m39254*id158287!!!underscore!!!printimage}\includegraphics{col11306.imgs/m39254_MG10C10_004.png} % ;MG10C10\_004.png;;;6.0;8.5;
...
\label{m39254*secfhsst!!!underscore!!!id4447}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.13:  Compound Linear Inequalities }
      ...
      \label{m39254*id158322}Solve for \begin{math}x\end{math}: \begin{math}5\^{a}‰¤x+3\lessthan{}8\end{math} and represent solution on a number line. \par 
      \vspace{5pt}
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    5-3\^{a}‰¤x+3-3\lessthan{}8-32\^{a}‰¤x\lessthan{}5\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.63)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \begin{center}
    \label{m39254*id158459!!!underscore!!!media}\label{m39254*id158459!!!underscore!!!printimage}\includegraphics{col11306.imgs/m39254_MG10C10_005.png} % ;MG10C10\_005.png;;;6.0;8.5;
...
\label{m39257*id158940}Thus far, all equations that have been encountered have one unknown variable that must be solved for. When two unknown variables need to be solved for, two equations are required and these equations are known as simultaneous equations. The solutions to the system of simultaneous equations are the values of the unknown variables which satisfy the system of equations simultaneously, that means at the same time. In general, if there are \begin{math}n\end{math} unknown variables, then \begin{math}n\end{math} equations are required to obtain a solution for each of the \begin{math}n\end{math} variables.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    2x+2y=1\frac{2-x}{3y+1}=2\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.64)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
 ...
 \end{figure}   
    ...
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m39257*uid96!!!underscore!!!media}\label{m39257*uid96!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39257_MG10C10_006.png} % m39257;MG10C10\_006.png;;;6.0;8.5;
 ...
 \end{figure}   
    ...
    \addtocounter{footnote}{-0}
        ...
        \label{m39257*id159137}The intersection of the two graphs is \begin{math}\left(2,1\right)\end{math}. So the solution to the system of simultaneous equations in (9.65) is \begin{math}y=1\end{math} and \begin{math}x=2\end{math}.\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    x=2y\^{a}ˆ´y=2\left(2y\right)-3y-4y=-3-3y=-3y=1\mathrm{Substitute\; into\; the\; first\; equation:}\phantom{\rule{2.em}{0ex}}\mathrm{x}=2\left(1\right)=2\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.66)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\par
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    4y+3x=1004y-19x=12\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.67)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    4y+3x=1004y=100-3xy=25-\frac{3}{4}x\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.68)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    4y-19x=124y=19x+12y=\frac{19}{4}x+3\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.69)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \begin{center}
    \label{m39257*id159679!!!underscore!!!media}\label{m39257*id159679!!!underscore!!!printimage}\includegraphics{col11306.imgs/m39257_MG10C10_007.png} % ;MG10C10\_007.png;;;6.0;8.5;
 ...
 \end{figure}   
    ...
    \addtocounter{footnote}{-0}
        ...
        \par 
        \item  
        \label{m39257*id159690}The graphs intersect at \begin{math}\left(4,22\right)\end{math}.\par 
        \item  
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \frac{2-x}{3y+1}=2\frac{2-\left(\frac{1}{2}-y\right)}{3y+1}=22-\left(\frac{1}{2}-y\right)=2\left(3y+1\right)2-\frac{1}{2}+y=6y+2y-6y=-2+\frac{1}{2}+2-5y=\frac{1}{2}y=-\frac{1}{10}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.72)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    \^{a}ˆ´x=\frac{1}{2}-y=\frac{1}{2}-\left(-\frac{1}{10}\right)=\frac{6}{10}=\frac{3}{5}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.73)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    x=\frac{3}{5}y=-\frac{1}{10}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.74)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\par
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    4y+3x=1003x=100-4yx=\frac{100-4y}{3}\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.76)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    4y-19\left(\frac{100-4y}{3}\right)=1212y-19\left(100-4y\right)=3612y-1900+76y=3688y=1936y=22\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.77)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    x=\frac{100-4\left(22\right)}{3}=\frac{100-88}{3}=\frac{12}{3}=4\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.78)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    4\left(22\right)+3\left(4\right)=88+12=1004\left(22\right)-19\left(4\right)=88-76=12\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.79)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\par
    ...
    \noindent\textbf{Exercise 9.16:  Bicycles and Tricycles }
        ...
        \item  
        \label{m39257*id160923}If \begin{math}b\end{math} is the number of bicycles and \begin{math}t\end{math} is the number of tricycles, then:\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    b=7-t\mathrm{Into\; second\; equation:}2\left(7-\mathrm{t}\right)+3\mathrm{t}=1914-2t+3t=19t=5\mathrm{Into\; first\; equation:}:\mathrm{b}=7-5=2\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.81)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    2+5=72\left(2\right)+3\left(5\right)=4+15=19\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.82)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\par
    ...
    \noindent\textbf{Exercise 9.17: Solving literal equations - 1}\label{m39258*probfhsst!!!underscore!!!id64377}
        \label{m39258*id162453587}The area of a triangle is \begin{math}A=\frac{1}{2}bÃ---h\end{math}. What is the height of the triangle in terms of the base and area?\par 
        \vspace{5pt}
...
\label{m39262*uid102}
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39262*id161635}The two equations make up a set of linear (because the highest power is one) simultaneous equations, which we know how to solve! Substitute for \begin{math}t\end{math} in the second equation to get:\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    t+j=14j+2+j=142j+2=142\left(j+1\right)=14j+1=7j=7-1=6\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.86)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\end{enumerate}
    ...
    \noindent\textbf{Exercise 9.18:  Mathematical Modelling: Two variables }
        ...
        \label{m39262*solfhsst!!!underscore!!!id6180}\noindent\textbf{Solution to Exercise } \label{m39262*listfhsst!!!underscore!!!id6180}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39262*id162412}Let the cost of one ruler be \begin{math}x\end{math} rand and the cost of one pen be \begin{math}y\end{math} rand.\par 
        \item  
        \label{m39262*uid111}\nopagebreak\noindent{}
          \settowidth{\mymathboxwidth}{\begin{equation}
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \item  
        \label{m39262*id162503}First solve the second equation for \begin{math}y\end{math}:\par 
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    3x+2\left(8-x\right)=213x+16-2x=21x=5\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.90)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\label{m39262*secfhsst!!!underscore!!!id6031}\vspace{.5cm} 
    ...
    \noindent\textbf{Exercise 9.19: Mathematical Modelling: One variable }\label{m39262*probfhsst!!!underscore!!!id6032}
        ...
        \label{m39262*solfhsst!!!underscore!!!id6035}\noindent\textbf{Solution to Exercise } \label{m39262*listfhsst!!!underscore!!!id6035}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39262*eip-121}Let the price of a chocolate milkshake be \begin{math}x\end{math} and the price of a fruitshake be \begin{math}y\end{math}.\par 
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39262*eip-840}\begin{math}y=x+2\end{math}\par 
        \item  
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    3\left(x+2\right)+5x=783x+6+5x=788x=72x=9y=x+2=9+2=11\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (9.93)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
