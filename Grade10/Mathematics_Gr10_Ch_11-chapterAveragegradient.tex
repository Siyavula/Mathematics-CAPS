...
\par
    ...
    \noindent\textbf{Exercise 10.1:  Average Gradient }
        ...
        \label{m39223*id191077}Find the average gradient of the curve $y=5{x}^{2}-4$ between the points \begin{math}x=-3\end{math} and \begin{math}x=3\end{math} \par 
        \vspace{5pt}
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \item  
        \label{m39223*id191219}We use the equation for the curve to calculate the $y$-value at \begin{math}{x}_{1}\end{math} and \begin{math}{x}_{2}\end{math}.\par 
