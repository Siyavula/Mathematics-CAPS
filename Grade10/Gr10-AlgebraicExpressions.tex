...
\Definition{Rational Number}{ \label{m38348*meaningfhsst!!!underscore!!!id138}
...
\label{m38348*secfhsst!!!underscore!!!id378}
      ...
      \label{m38348*id63882}\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
            \label{m38348*uid20}\item Write the following as fractions:\label{m38348*id7322}\begin{enumerate            {m38348*cid7} $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} {(subsection shortcode: MG10039 )} \par 
...
\label{m39394*eip-280}
 ...
 \end{figure}       \par \label{m39394*secfhsst!!!underscore!!!id2920}
  \subsubsubsection   {Exercise: Factorisation by Grouping }
            \nopagebreak
...
where $a$ and $b$ are integers and $b\ne 0$\item The following are rational numbers:
 ...
 \end{enumerate}
         \end{itemize}
  \subsubsubsection {Summary: Irrational Numbers and Rounding Off}  
            \nopagebreak
  ...
  \subsubsubsection {Summary: Estimating Surds}
%     \subsection{ Summary}
            \nopagebreak
  ...
  \subsubsubsection {Summary: Products and Factorisation}
