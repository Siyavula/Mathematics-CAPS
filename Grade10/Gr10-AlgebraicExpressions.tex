...
This means that
\begin{align*}
  10,589 &= 10 + \dfrac{5}{10} + \dfrac{8}{100} + \dfrac{9}{1000} \\
  &= 10 \dfrac{589}{1000} \\
  &= \dfrac{10589}{1000}
\end{align*}
...
second example, the decimal was multiplied by $1000$. This is because
...
three digits recurring, then multiply by $1000$ and so on.\par
