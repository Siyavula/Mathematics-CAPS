...
% 	\end{tabular}
    ...
    \begin{equation}
    \frac{\sqrt{2}}{7} \mbox{ and } \frac{\pi }{20}
      \end{equation}
...
\begin{exercises}{Rational Numbers }{
            \nopagebreak
...
\label{m38348*id734}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
    ...
    \item $\dfrac{1}{c}$\end{enumerate}
        \label{m38348*uid10}\item If $\dfrac{a}{1}$ is a rational number, which of the following are valid values for $a$?\label{m38348*id7432}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
...
\label{m38348*uid17}\item decimal numbers that have a repeating pattern of numbers, for example the fraction $\dfrac{1}{3}$ can be written as 
$0,\dot{3}$. 
The dot represents recurring $3$'s i.e.,
$0,333...=0,\dot{3}$.
\end{enumerate}
      \label{m38348*id63576}For example, the rational number $\dfrac{5}{6}$ can be written in decimal notation as $0,8\dot{3}$ and similarly, the decimal number 0,25 can be written as a rational number as $\dfrac{1}{4}$.\par 
...
\label{m38348*secfhsst!!!underscore!!!id378}
      ...
      \label{m38348*id63882}\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
            \label{m38348*uid20}\item Write the following as fractions:\label{m38348*id7322}\begin{enumerate} $ \hspace{-5pt}\begin{array}{cccccccccccc}   $ 
...
Irrational numbers are numbers that cannot be written as a fraction with the numerator and denominator as integers. This means that any number that is \textsl{not} a terminating decimal number or a repeating decimal number is irrational. Examples of irrational numbers are:\par 
...
{
%       \vspace{5pt}
%       \label{m38349*solfhsst!!!underscore!!!id212}\noindent\textbf{Solution to Exercise } \label{m38349*listfhsst!!!underscore!!!id212}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
%             \leftskip=20pt\rightskip=\leftskip\item  
%       \label{m38349*id325360}[noitemsep, label=\textbf{\alph*}. ] 
...
%       \label{m38349*id325626}[noitemsep, label=\textbf{\alph*}. ] 
...
% \label{m38347*probfhsst!!!underscore!!!id177}
%       \label{m38347*id259913}
{$\sqrt[3]{49}$ lies between: \label{m38347*id7432}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
...
%             \leftskip=20pt\rightskip=\leftskip\item  
 \westep{}     \label{m38347*id259980}If $1\lessthan{}\sqrt[3]{49}\lessthan{}2$ then cubing all terms gives $1\lessthan{}49\lessthan{}{2}^{3}$. Simplifying gives $1\lessthan{}49\lessthan{}8$ which is false. So $\sqrt[3]{49}$ does not lie between 1 and 2.\par 
%       \item  
      \westep{}\label{m38347*id260068}If $2\lessthan{}\sqrt[3]{49}\lessthan{}3$ then cubing all terms gives ${2}^{3}\lessthan{}49\lessthan{}{3}^{3}$. Simplifying gives $8\lessthan{}49\lessthan{}27$ which is false. So $\sqrt[3]{49}$ does not lie between 2 and 3.\par 
%       \item  
      \westep{}\label{m38347*id260160}If $3\lessthan{}\sqrt[3]{49}\lessthan{}4$ then cubing all terms gives ${3}^{3}\lessthan{}49\lessthan{}{4}^{3}$. Simplifying gives $27\lessthan{}49\lessthan{}64$ which is true. So $\sqrt[3]{49}$ lies between 3 and 4.
 \par 
%       \end{enumerate}
   }\end{wex}
...
%             \nopagebreak
    ...
    \begin{equation}
    \begin{array}{cc}\hfill a\ensuremath{\cdot}{x}^{k}+b\ensuremath{\cdot}x+{c}^{m}=0\\ \hfill d\ensuremath{\cdot}{y}^{p}+e\ensuremath{\cdot}y+f\le 0\end{array}
      \end{equation}
...
\end{table}
    ...
    \begin{equation}
    \begin{array}{ccc}\hfill \left(a\ensuremath{\cdot}x+b\right)\left(c\ensuremath{\cdot}x+d\right)& =& \left(ax\right)\left(c\ensuremath{\cdot}x+d\right)+b\left(c\ensuremath{\cdot}x+d\right)\hfill \\ & =& \left(ax\right)\left(cx\right)+\left(ax\right)d+b\left(cx\right)+b\ensuremath{\cdot}d\hfill \\ & =& a{x}^{2}+x\left(ad+bc\right)+bd\hfill \end{array}
      \end{equation}
\par
...
%         \vspace{5pt}
%         \label{m39383*solfhsst!!!underscore!!!id346}\noindent\textbf{Solution to Exercise } \label{m39383*listfhsst!!!underscore!!!id346}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39383*id268333}\nopagebreak\noindent{}
          
    \begin{equation}
    \begin{array}{ccc}\hfill \left(3x-2\right)\left(5x+8\right)& =& \left(3x\right)\left(5x\right)+\left(3x\right)\left(8\right)+\left(-2\right)\left(5x\right)+\left(-2\right)\left(8\right)\hfill \\ & =& 15{x}^{2}+24x-10x-16\hfill \\ & =& 15{x}^{2}+14x-16\hfill \end{array}
      \end{equation}
      }} 
    \end{wex}
...
binomials to multiply a binomial and a trinomial.\par 
    ...
    \begin{array}{cccc}& \phantom{\rule{4pt}{0ex}}& \left(2x+1\right)\left({x}^{2}+2x+1\right)\hfill & \\ & =& 2x\left({x}^{2}+2x+1\right)+1\left({x}^{2}+2x+1\right)\hfill & \left(\mathrm{apply\; distributive\; law}\right)\hfill \\ & =& \left[2x\left({x}^{2}\right)+2x\left(2x\right)+2x\left(1\right)\right]+\left[1\left({x}^{2}\right)+1\left(2x\right)+1\left(1\right)\right]\hfill & \\ & =& 2{x}^{3}+4{x}^{2}+2x+{x}^{2}+2x+1\hfill & \left(\mathrm{expand\; the\; brackets}\right)\hfill \\ & =& 2{x}^{3}+\left(4{x}^{2}+{x}^{2}\right)+\left(2x+2x\right)+1\hfill & \left(\mathrm{group\; like\; terms\; to\; simplify}\right)\hfill \\ & =& 2{x}^{3}+5{x}^{2}+4x+1\hfill & \left(\mathrm{simplify\; to\; get\; final\; answer}\right)\hfill & \end{array}
      \end{equation}
    }
...
%       \hspace*{-30pt}\includegraphics[width=0.5in]{col11306.imgs/pspencil2.png}   \raisebox{25mm}{   
%
      \begin{wex}{Multiplication of Binomial with Trinomial }{Multiply \begin{math}x-1\end{math} with \begin{math}{x}^{2}-2x+1\end{math}.} 
{
\westep{}      
% \begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
%             \leftskip=20pt\rightskip=\leftskip\item  
...
\westep{}Apply the distributive law and then simplify the resulting expression.  
%       \label{m39387*id272061}\par 
\westep{}
...
%  \caption{Exercise: Finding Products}
\end{table}
    \par
  \newline
\newline
...
%     \begin{caption}{Exercise: common factors}\end{caption}
\end{table}
...
\end{exercises}
    ...
    \begin{equation}
    \left(ax+b\right)\left(ax-b\right)
      \end{equation}
          \label{m39383*id269338}Therefore,\par 
          \label{m39383*id269343}\nopagebreak\noindent{}
            
    \begin{equation}
    {a}^{2}{x}^{2}-{b}^{2}=\left(ax+b\right)\left(ax-b\right)
      \end{equation}
...
%       \hspace*{-30pt}\includegraphics[width=0.5in]{col11306.imgs/pspencil2.png}   \raisebox{25mm}{   
%     
      \begin{wex}{Factorising binomials with a common bracket }{Factorise completely: $3a\left(a-4\right)-7\left(a-4\right)$ \par }
%           \vspace{5pt}
...
\westep{}
    ...
    \begin{equation}
    \begin{array}{ccc}\hfill 3a\left(a-4\right)-7\left(a-4\right)& =& \left(a-4\right)\left(3a-7\right)\hfill \end{array}
      \end{equation}
         }
    \end{wex}
...
%   cap  \begin{caption}{Exercise: Factorisation}\end{caption}
\end{table}
    \par
  \newline
\newline
...
%       \hspace*{-30pt}\includegraphics[width=0.5in]{col11306.imgs/pspencil2.png}   \raisebox{25mm}{   
      ...
      \begin{wex}{Difference of Squares }
{Find the factors of $9{x}^{2}-25$.} 
{
% \begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
%             \leftskip=20pt\rightskip=\leftskip\item  
      \westep{}\label{m39394*id275388}We see that the quadratic is a difference of squares because:\par 
...
\westep{} 
    ...
    \begin{equation}
    9{x}^{2}-25={\left(3x\right)}^{2}-{5}^{2}
      \end{equation}
    \westep{}   
      \label{m39394*id275517}\nopagebreak\noindent{}
        
    \begin{equation}
    {\left(3x\right)}^{2}-{5}^{2}=\left(3x-5\right)\left(3x+5\right)
      \end{equation}
    \westep{}  
...
%       \end{enumerate}
    ...
    \begin{equation}
    \begin{array}{ccc}\hfill \left(x+2\right)\left(x+3\right)& =& x\left(x+3\right)+2\left(x+3\right)\hfill \\ & =& \left(x\right)\left(x\right)+3x+2x+\left(2\right)\left(3\right)\hfill \\ & =& {x}^{2}+5x+6.\hfill \end{array}
      \end{equation}
...
%       \hspace*{-30pt}\includegraphics[width=0.5in]{col11306.imgs/pspencil2.png}   \raisebox{25mm}{   
      ...
      \begin{wex}{ Factorising a Quadratic }{Find the factors of $3{x}^{2}+2x-1$. } 

{ \westep{}The quadratic is in the required form.
        \westep{}  
\begin{equation}
    \left(x\phantom{\rule{2.em}{0ex}}\right)\left(x\phantom{\rule{2.em}{0ex}}\right)
      \end{equation}
...
\end{table}
 ...
 \westep{} 
    ...
    \begin{equation}
\begin{array}{ccc}  
 \left(x+1\right)\left(3x-1\right)& =& x\left(3x-1\right)+1\left(3x-1\right)\hfill \\ & =& \left(x\right)\left(3x\right)+\left(x\right)\left(-1\right)+\left(1\right)\left(3x\right)+\left(1\right)\left(-1\right)\hfill \\ & =& 3{x}^{2}-x+3x-1\hfill \\ & =& {x}^{2}+2x-1.\end{array}
      \end{equation}
 \westep{}
...
\begin{exercises}{Factorising a Trinomial }
 {
...
%     \begin{caption}{Exercise: Factorising trinomials}\end{caption}
\end{table}
    \par
