...
\subsection[Converting terminating decimals into rational numbers]{\huge Converting terminating decimals into rational numbers}
...
\subsection[Converting recurring decimals into rational numbers]{\Huge Converting recurring decimals into rational numbers}
...
\westep{Expand  thebrackets to check that the expression has been correctly factorised}
}
\end{wex}
...
\end{equation*}
\westep{Change the division sign and mutiply by the reciprocal}
