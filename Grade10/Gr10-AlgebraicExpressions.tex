...
When you write irrational numbers in decimal form, you may (if you
...
\par 
 \par \begin{tabular}[h]{cccccc}
 (1.) 00bb&  (2.) 00bc&  (3.) 00bd& (4.) 00be& (5.) 00bf& (6.) 00bg\end{tabular}
}
\end{exercises}
...
A binomial is a mathematical expression with two terms, for example,
$ax+b$ or $cx+d$.

\begin{wex}{Applying the distributive law}
{%
Write the following without brackets in its simplest form:
$2a(a-1) - 3(a^{2}-1)$.
}{%
...
\begin{wex}{Factorising by grouping}
...
\par 
 \par \begin{tabular}[h]{cccccc}
 (1.-5.) 00c5& (6.-10.) 00c6&  \end{tabular}
}
\end{exercises}
...
{Simplify: $\dfrac{ax-b+x-ab}{a{x}^{2}-abx}$. Assume that all denominators are non-zero.}
{
...
\begin{wex}{Simplifying fractions}
{Simplify: $\dfrac{x-2}{{x}^{2}-4}+\dfrac{{x}^{2}}{x-2}-\dfrac{{x}^{3}+x-4}{{x}^{2}-4}$. Assume that all denominators are non-zero.}
{
...
\begin{wex}{Simplifying fractions}
{Simplify: $\dfrac{2}{{x}^{2}-x}+\dfrac{x^{2}+x+1}{x^{3}-1}-\dfrac{x}{{x}^{2}-1}$. Assume that all denominators are non-zero.}
{
\westep{Factorise the numerator and denominator}
\begin{equation*}
...
\par \begin{tabular}[h]{cccc}
  (1.-7.) 00c7&  (8.-13.) 00c8&  (14.-20.) 00c9&  (21.-26) 00ca\end{tabular}
}
\end{exercises}
...
\item If the ${n}^{\mbox{th}}$ root of a number cannot be simplified to a rational number, it is called a surd.
...
\item The distributive law
  \begin{equation}
    (A+B)(C+D+E)=A(C+D+E)+B(C+D+E)
  \end{equation}
  helps us to multiply a binomial and a trinomial.
...
\par 
 ...
 (13a-k.) 00cp&  (13l-p.) 00cq&  (13q-t.) 00cr& (14a-d.) 00cs& (14e-f.) 00ct& (14g-j.) 00cu&
 (15.) 00cv&  (16.) 00cw&  (17.) 00cx\end{tabular}
\end{eocexercises}
