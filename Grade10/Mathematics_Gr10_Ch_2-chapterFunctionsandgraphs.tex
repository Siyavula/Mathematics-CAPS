    ...
    \label{m39337*cid2}
            \subsection{ Introduction to Functions and Graphs}
            \nopagebreak
    ...
    \label{m39337*cid3}
            \subsection{ Functions and Graphs in the Real-World}
            \nopagebreak
...
\end{itemize}
    ...
    \label{m39337*cid4}
      ...
      \label{m39337*id232161}The following should be familiar.\par 
      \label{m39337*uid5}
            \subsubsection{ Variables and Constants}
            \nopagebreak
            
        
        \label{m39337*id232172}In Review of past work (Section~: Letters and Arithmetic), we were introduced to variables and constants. To recap, a \textsl{variable} can take any value in some set of numbers, so long as the equation is consistent. Most often, a variable will be written as a letter.\par 
        \label{m39337*id232189}A \textsl{constant} has a fixed value. The number 1 is a constant. Sometimes letters are used to represent constants, as they are easier to work with.\par 
\label{m39337*secfhsst!!!underscore!!!id84}
            \subsubsection{  Investigation : Variables and Constants }
            \nopagebreak
            
        \label{m39337*id232206}In the following expressions,
identify the variables and the constants:\par 
        \label{m39337*id232211}\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
            \label{m39337*uid6}\item 
            \begin{math}2{x}^{2}=1\end{math}
          \label{m39337*uid7}\item 
            \begin{math}3x+4y=7\end{math}
          \label{m39337*uid8}\item 
            \begin{math}y=\frac{-5}{x}\end{math}
          \label{m39337*uid9}\item 
            \begin{math}y={7}^{x}-2\end{math}
          \end{enumerate}
      ...
      \label{m39337*uid10}
        ...
        \label{m39337*id232358}In earlier grades, you saw that variables can be \textsl{related} to each other. For example, Alan is two years older than Nathan. Therefore the relationship between the ages of Alan and Nathan can be written as \begin{math}A=N+2\end{math}, where \begin{math}A\end{math} is Alan's age and \begin{math}N\end{math} is Nathan's age.\par 
        \label{m39337*id232402}In general, a \textsl{relation} is an equation which relates two variables. For example, \begin{math}y=5x\end{math} and \begin{math}{y}^{2}+{x}^{2}=5\end{math} are relations. In both examples \begin{math}x\end{math} and \begin{math}y\end{math} are variables and 5 is a constant, but for a given value of \begin{math}x\end{math} the value of \begin{math}y\end{math} will be very different in each relation.\par 
        \label{m39337*id232487}Besides writing relations as equations, they can also be represented as words, tables and graphs. Instead of writing \begin{math}y=5x\end{math}, we could also say ``\begin{math}y\end{math} is always five times as big as \begin{math}x\end{math}''. We could also give the following table:\par 
        
    % \textbf{m39337*id232523}\par
...
\label{m39337*secfhsst!!!underscore!!!id196}
            \subsubsection{  Investigation : Relations and Functions }
            \nopagebreak
            
        \label{m39337*id232855}Complete the following table
for the given functions:\par 
        
    % \textbf{m39337*id232861}\par
    ...
    \par
      ...
      \label{m39337*uid11}
        ...
        \label{m39337*id233118}When working with real valued functions, our major tool is drawing graphs. In the first place, if we have two real variables, \begin{math}x\end{math} and \begin{math}y\end{math}, then we can assign values to them simultaneously. That is, we can say ``let \begin{math}x\end{math} be 5 and \begin{math}y\end{math} be 3''. Just as we write ``let \begin{math}x=5\end{math}'' for ``let \begin{math}x\end{math} be 5'', we have the shorthand notation ``let \begin{math}\left(x,y\right)=\left(5,3\right)\end{math}'' for ``let \begin{math}x\end{math} be 5 and \begin{math}y\end{math} be 3''. We usually think of the real numbers as an infinitely long line, and picking a number as putting a dot on that line. If we want to pick \textsl{two} numbers at the same time, we can do something similar, but now we must use two dimensions. What we do is use two lines, one for \begin{math}x\end{math} and one for \begin{math}y\end{math}, and rotate the one for \begin{math}y\end{math}, as in Figure~1.1. We call this the \textsl{Cartesian plane}.\par 
        
    \setcounter{subfigure}{0}


	\begin{figure}[H] % horizontal\label{m39337*uid12}
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m39337*uid12!!!underscore!!!media}\label{m39337*uid12!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39337_MG10C11_001.png} % m39337;MG10C11\_001.png;;;6.0;8.5;
        
      \vspace{2pt}
    \vspace{\rubberspace}\par \begin{cnxcaption}
	  \small \textbf{Figure 1.1: }The Cartesian plane is made up of an \begin{math}x-\end{math}axis (horizontal) and a \begin{math}y-\end{math}axis (vertical).
	\end{cnxcaption}
 ...
 \end{figure}   
    ...
    \addtocounter{footnote}{-0}
      ...
      \label{m39337*uid13}
        ...
        \label{m39337*id233311}In order to draw the graph of a function, we need to calculate a few points. Then we plot the points on the Cartesian Plane and join the points with a smooth line.\par 
        \label{m39337*id233318}Assume that we were investigating the properties of the function \begin{math}f\left(x\right)=2x\end{math}. We could then consider all the points \begin{math}\left(x;y\right)\end{math} such that \begin{math}y=f\left(x\right)\end{math}, i.e. \begin{math}y=2x\end{math}. For example, \begin{math}\left(1;2\right),\left(2,5;5\right),\end{math} and \begin{math}\left(3;6\right)\end{math} would all be such points, whereas \begin{math}\left(3;5\right)\end{math} would not since \begin{math}5\ne 2\ensuremath{\times}3\end{math}. If we put a dot at each of those points, and then at every similar one for all possible values of \begin{math}x\end{math}, we would obtain the graph shown in Figure~1.2\par 
        
    \setcounter{subfigure}{0}


	\begin{figure}[H] % horizontal\label{m39337*uid14}
    \begin{center}
    \rule[.1in]{\figurerulewidth}{.005in} \\
        \label{m39337*uid14!!!underscore!!!media}\label{m39337*uid14!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39337_MG10C11_002.png} % m39337;MG10C11\_002.png;;;6.0;8.5;
        
      \vspace{2pt}
    \vspace{\rubberspace}\par \begin{cnxcaption}
	  \small \textbf{Figure 1.2: }Graph of \begin{math}f\left(x\right)=2x\end{math}
	\end{cnxcaption}
 ...
 \end{figure}   
    ...
    \addtocounter{footnote}{-0}
        ...
        \label{m39337*id233532}The form of this graph is very pleasing -- it is a simple straight line through the middle of the plane. The technique of ``plotting'', which we have followed here, is \textsl{the} key element in understanding functions.\par 
\label{m39337*secfhsst!!!underscore!!!id298}
            \subsubsection{  Investigation : Drawing Graphs and the Cartesian Plane }
            \nopagebreak
            
        \label{m39337*id233553}Plot the
following points and draw a smooth line through them.
(-6; -8),(-2; 0), (2; 8), (6; 16) \par 

      
      \label{m39337*uid15}
            \subsubsection{ Notation used for Functions}
            \nopagebreak
            
        
        \label{m39337*id233575}Thus far you would have seen that we can use \begin{math}y=2x\end{math} to represent a function. This notation however gets confusing when you are working with more than one function. A more general form of writing a function is to write the function as \begin{math}f\left(x\right)\end{math}, where \begin{math}f\end{math}\hspace{1ex} is the function name and \begin{math}x\end{math} is the independent variable. For example, \begin{math}f\left(x\right)=2x\end{math} and \begin{math}g\left(t\right)=2t+1\end{math} are two functions.\par 
        \label{m39337*id233683}Both notations will be used in this book.\par 
\label{m39337*secfhsst!!!underscore!!!id308}\vspace{.5cm} 
      
      \noindent
      \hspace*{-30pt}\includegraphics[width=0.5in]{col11306.imgs/pspencil2.png}   \raisebox{25mm}{   
      \begin{mdframed}[linewidth=4, leftmargin=40, rightmargin=40]  
      \begin{exercise}
    \noindent\textbf{Exercise 1.1:  Function notation }
        \label{m39337*probfhsst!!!underscore!!!id309}
        \label{m39337*id233701}If \begin{math}f\left(n\right)={n}^{2}-6n+9\end{math}, find \begin{math}f\left(k-1\right)\end{math} in terms of \begin{math}k\end{math}. \par 
        \vspace{5pt}
        \label{m39337*solfhsst!!!underscore!!!id312}\noindent\textbf{Solution to Exercise } \label{m39337*listfhsst!!!underscore!!!id312}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39337*id233816}\nopagebreak\noindent{}
          \settowidth{\mymathboxwidth}{\begin{equation}
    \begin{array}{ccc}\hfill f\left(n\right)& =& {n}^{2}-6n+9\hfill \\ \hfill f\left(k-1\right)& =& {\left(k-1\right)}^{2}-6\left(k-1\right)+9\hfill \end{array}\tag{1.1}
      \end{equation}
    }
    ...
    f\left(n\right)={n}^{2}-6n+9f\left(k-1\right)={\left(k-1\right)}^{2}-6\left(k-1\right)+9\end{math}}\hfill
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \item  
        \label{m39337*id233936}\nopagebreak\noindent{}
          \settowidth{\mymathboxwidth}{\begin{equation}
    \begin{array}{ccc}& =& {k}^{2}-2k+1-6k+6+9\hfill \\ & =& {k}^{2}-8k+16\hfill \end{array}\tag{1.2}
      \end{equation}
    }
    \typeout{Columnwidth = \the\columnwidth}\typeout{math as usual width = \the\mymathboxwidth}
    \ifthenelse{\lengthtest{\mymathboxwidth < \columnwidth}}{% if the math fits, do it again, for real
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    ={k}^{2}-2k+1-6k+6+9={k}^{2}-8k+16\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (1.2)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \label{m39337*id234019}We have now simplified the function in terms of \begin{math}k\end{math}.
 \par 
        \end{enumerate}
...
\label{m39337*secfhsst!!!underscore!!!id442}\vspace{.5cm} 
      
      \noindent
      \hspace*{-30pt}\includegraphics[width=0.5in]{col11306.imgs/pspencil2.png}   \raisebox{25mm}{   
      \begin{mdframed}[linewidth=4, leftmargin=40, rightmargin=40]  
      \begin{exercise}
    \noindent\textbf{Exercise 1.2:  Function notation }
        \label{m39337*probfhsst!!!underscore!!!id443}
        \label{m39337*id234058}If \begin{math}f\left(x\right)={x}^{2}-4\end{math}, calculate \begin{math}b\end{math} if \begin{math}f\left(b\right)=45\end{math}. \par 
        \vspace{5pt}
        \label{m39337*solfhsst!!!underscore!!!id446}\noindent\textbf{Solution to Exercise } \label{m39337*listfhsst!!!underscore!!!id446}\begin{enumerate}[noitemsep, label=\textbf{Step} \textbf{\arabic*}. ] 
            \leftskip=20pt\rightskip=\leftskip\item  
        \label{m39337*id234160}\nopagebreak\noindent{}\settowidth{\mymathboxwidth}{\begin{equation}
    \begin{array}{ccc}\hfill f\left(b\right)& =& {b}^{2}-4\hfill \\ \hfill \hspace{4pt}\mathrm{but}\hspace{4pt}\phantom{\rule{2pt}{0ex}}f\left(b\right)& =& 45\hfill \end{array}\tag{1.3}
      \end{equation}
    }
    \typeout{Columnwidth = \the\columnwidth}\typeout{math as usual width = \the\mymathboxwidth}
    \ifthenelse{\lengthtest{\mymathboxwidth < \columnwidth}}{% if the math fits, do it again, for real
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    f\left(b\right)={b}^{2}-4\hspace{4pt}\mathrm{but}\hspace{4pt}\phantom{\rule{2pt}{0ex}}f\left(b\right)=45\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (1.3)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
    \typeout{math as usual width = \the\mymathboxwidth}
        ...
        \item  
        \label{m39337*id234238}\nopagebreak\noindent{}
          \settowidth{\mymathboxwidth}{\begin{equation}
    \begin{array}{ccc}\hfill {b}^{2}-4& =& 45\hfill \\ \hfill {b}^{2}-49& =& 0\hfill \\ \hfill b& =& +7\hspace{4pt}\mathrm{or}\hspace{4pt}-7\hfill \end{array}\tag{1.4}
      \end{equation}
    }
    \typeout{Columnwidth = \the\columnwidth}\typeout{math as usual width = \the\mymathboxwidth}
    \ifthenelse{\lengthtest{\mymathboxwidth < \columnwidth}}{% if the math fits, do it again, for real
    ...
    \par\vspace{12pt}\noindent\begin{minipage}{\columnwidth}
    \parbox[t]{\mymathboxwidth}{\large\begin{math}
    {b}^{2}-4=45{b}^{2}-49=0b=+7\hspace{4pt}\mathrm{or}\hspace{4pt}-7\end{math}}\hfill
    \parbox[t]{48pt}{\raggedleft 
    (1.4)}
    \end{minipage}\vspace{12pt}\par
    }% end of conditional for this bit of math
...
\label{m39337*secfhsst!!!underscore!!!id559}
            \subsubsection{ Recap }
            \nopagebreak
            
        \label{m39337*id234365}\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
            \label{m39337*uid16}\item 
Guess the function in the form \begin{math}y=...\end{math} that has the values listed in the table.

    % \textbf{m39337*id234396}\par
    ...
    \setlength\mystarwidth{\mytableroom}
      ...
      % ----- Begin capturing width of table in LR mode woof
      \settowidth{\mytableboxwidth}{\begin{tabular}[t]{|l|l|l|l|l|l|l|l|l|l|l|}\hline
    ...
    \end{tabular}} % end mytableboxwidth set
      ...
      % ----- End capturing width of table in LR mode
        ...
        % ----- LR or paragraph mode: must test
        % ----- Begin capturing height of table
        \settoheight{\mytableboxheight}{\begin{tabular}[t]{|l|l|l|l|l|l|l|l|l|l|l|}\hline
    % count in rowspan-info-nodeset: 11
    % align/colidx: left,1
    ...
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | '' || col4 '0' | 'false' | '' || col5 '0' | 'false' | '' || col6 '0' | 'false' | '' || col7 '0' | 'false' | '' || col8 '0' | 'false' | '' || col9 '0' | 'false' | '' || col10 '0' | 'false' | '' || col11 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}\cline{5-5}\cline{6-6}\cline{7-7}\cline{8-8}\cline{9-9}\cline{10-10}\cline{11-11}
      %--------------------------------------------------------------------
    \end{tabular}} % end mytableboxheight set
        \settodepth{\mytableboxdepth}{\begin{tabular}[t]{|l|l|l|l|l|l|l|l|l|l|l|}\hline
    % count in rowspan-info-nodeset: 11
    % align/colidx: left,1
    ...
    % \\ 'id2825632' '1'
      ...
      \label{m39337*id234396}
      
    \noindent
    \begin{tabular}[t]{|l|l|l|l|l|l|l|l|l|l|l|}\hline
    % count in rowspan-info-nodeset: 11
    % align/colidx: left,1
    ...
    \tabletail{%
      ...
      \tablelasttail{}
      \begin{xtabular}[t]{|l|l|l|l|l|l|l|l|l|l|l|}\hline
    % count in rowspan-info-nodeset: 11
    % align/colidx: left,1
    ...
    \par
          \label{m39337*uid17}\item 
Guess the function in the form \begin{math}y=...\end{math} that has the values listed in the table.

    % \textbf{m39337*id234628}\par
    ...
    \par
          \label{m39337*uid18}\item 
Guess the function in the form \begin{math}y=...\end{math} that has the values listed in the table.

    % \textbf{m39337*id234860}\par
    ...
    % rowcount: '0' | start: 'false' | colidx: '11'
        ...
        % Formatting a regular cell and recurring on the next sibling
        10000% make-rowspan-placeholders
    % rowspan info: col1 '0' | 'false' | '' || col2 '0' | 'false' | '' || col3 '0' | 'false' | '' || col4 '0' | 'false' | '' || col5 '0' | 'false' | '' || col6 '0' | 'false' | '' || col7 '0' | 'false' | '' || col8 '0' | 'false' | '' || col9 '0' | 'false' | '' || col10 '0' | 'false' | '' || col11 '0' | 'false' | ''
     \tabularnewline\cline{1-1}\cline{2-2}\cline{3-3}\cline{4-4}\cline{5-5}\cline{6-6}\cline{7-7}\cline{8-8}\cline{9-9}\cline{10-10}\cline{11-11}
      %--------------------------------------------------------------------
    \end{tabular}} % end mytableboxwidth set
    ...
    \par
          \label{m39337*uid19}\item On a Cartesian plane, plot the following points: (1;2), (2;4), (3;6), (4;8), (5;10). Join the points. Do you get a straight line?\newline
    
        \label{m39337*uid20}\item If \begin{math}f\left(x\right)=x+{x}^{2}\end{math}, write out:
\label{m39337*id235122}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \label{m39337*uid21}\item \begin{math}f\left(t\right)\end{math}\label{m39337*uid22}\item \begin{math}f\left(a\right)\end{math}\label{m39337*uid23}\item \begin{math}f\left(1\right)\end{math}\label{m39337*uid24}\item \begin{math}f\left(3\right)\end{math}\end{enumerate}
                \label{m39337*uid25}\item If \begin{math}g\left(x\right)=x\end{math} and \begin{math}f\left(x\right)=2x\end{math}, write out:
\label{m39337*id235285}\begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
            \label{m39337*uid26}\item \begin{math}f\left(t\right)+g\left(t\right)\end{math}\label{m39337*uid27}\item \begin{math}f\left(a\right)-g\left(a\right)\end{math}\label{m39337*uid28}\item \begin{math}f\left(1\right)+g\left(2\right)\end{math}\label{m39337*uid29}\item \begin{math}f\left(3\right)+g\left(s\right)\end{math}\end{enumerate}
                \label{m39337*uid30}\item A car drives by you on a straight highway. The car is travelling 10 m every
second. Complete the table below by filling in how far the car has travelled
away from you after 5, 10 and 20 seconds.

    % \textbf{m39337*id235448}\par
...
Use the values in the table and draw a graph of distance on the \begin{math}y\end{math}-axis and time on the \begin{math}x\end{math}-axis.
        \end{enumerate}
...
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 ...
 (1.) lxO  &  (2.) lxc  &  (3.) lxx  &  (4.) lxa  &  (5.) lxC  &  (6.) lx1  &  (7.) lxr  & \end{tabular}



            \subsection{ Characteristics of Functions - All Grades}
            \nopagebreak
...
\end{enumerate}
 ...
 \end{figure}   
    ...
    \typeout{math as usual width = \the\mymathboxwidth}
      ...
      \label{m39337*uid46}
            \subsubsection{ Intercepts with the Axes}
            \nopagebreak
 ...
 \end{figure}   
    ...
    \addtocounter{footnote}{-0}
      ...
      \label{m39337*uid50}
            \subsubsection{ Lines of Symmetry}
            \nopagebreak
 ...
 \end{figure}   
    ...
    \addtocounter{footnote}{-0}
      ...
      \label{m39337*uid52}
            \subsubsection{ Intervals on which the Function Increases/Decreases}
            \nopagebreak
      ...
      \label{m39337*uid53}
            \subsubsection{ Discrete or Continuous Nature of the Graph}
            \nopagebreak
...
\end{enumerate}
 ...
 \end{figure}   
    ...
    \addtocounter{footnote}{-0}
            \label{m39337*uid63}\item On the following graph label:
...
\label{m39338*secfhsst!!!underscore!!!id833}
            \subsubsection{  Investigation : Functions of the Form $y=ax+q$ }
            \nopagebreak
...
\label{m39338*id238303}
    \begin{center}
    \label{m39338*id238303!!!underscore!!!media}\label{m39338*id238303!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39338_MG10C11_006.png} % m39338;MG10C11\_006.png;;;6.0;8.5;
...
\label{m39338*id238315}
    \begin{center}
    \label{m39338*id238315!!!underscore!!!media}\label{m39338*id238315!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39338_MG10C11_007.png} % m39338;MG10C11\_007.png;;;6.0;8.5;
...
\label{m39338*id238353}
    \begin{center}
    \label{m39338*id238353!!!underscore!!!media}\label{m39338*id238353!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39338_MG10C11_008.png} % m39338;MG10C11\_008.png;;;6.0;8.5;
...
\label{m39338*id238365}
    \begin{center}
    \label{m39338*id238365!!!underscore!!!media}\label{m39338*id238365!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39338_MG10C11_009.png} % m39338;MG10C11\_009.png;;;6.0;8.5;
...
\label{m39345*secfhsst!!!underscore!!!id1384}
            \subsubsection{  Investigation : Functions of the Form $y=a{x}^{2}+q$ }
            \nopagebreak
...
\par \label{m39345*eip-481}
 ...
 \end{figure}   
    ...
    \addtocounter{footnote}{-0}
    \par \label{m39345*id241684}From your graphs, you should have found that \begin{math}a\end{math} affects whether the graph makes a smile or a frown. If \begin{math}a\lessthan{}0\end{math}, the graph makes a frown and if \begin{math}a\greatthan{}0\end{math} then the graph makes a smile. This is shown in Figure~1.18.\par 
...
\label{m39345*id241967}
    \begin{center}
    \label{m39345*id241967!!!underscore!!!media}\label{m39345*id241967!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39345_MG10C11_015.png} % m39345;MG10C11\_015.png;;;6.0;8.5;
...
\label{m39345*id241979}
    \begin{center}
    \label{m39345*id241979!!!underscore!!!media}\label{m39345*id241979!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39345_MG10C11_016.png} % m39345;MG10C11\_016.png;;;6.0;8.5;
...
\label{m39345*id242017}
    \begin{center}
    \label{m39345*id242017!!!underscore!!!media}\label{m39345*id242017!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39345_MG10C11_017.png} % m39345;MG10C11\_017.png;;;6.0;8.5;
...
\label{m39345*id242029}
    \begin{center}
    \label{m39345*id242029!!!underscore!!!media}\label{m39345*id242029!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39345_MG10C11_018.png} % m39345;MG10C11\_018.png;;;6.0;8.5;
...
\label{m39341*secfhsst!!!underscore!!!id2774}
            \subsubsection{  Investigation : Functions of the Form $y=\frac{a}{x}+q$ }
            \nopagebreak
...
\label{m39341*id246931}
    \begin{center}
    \label{m39341*id246931!!!underscore!!!media}\label{m39341*id246931!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39341_MG10C11_022.png} % m39341;MG10C11\_022.png;;;6.0;8.5;
...
\label{m39341*id246943}
    \begin{center}
    \label{m39341*id246943!!!underscore!!!media}\label{m39341*id246943!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39341_MG10C11_023.png} % m39341;MG10C11\_023.png;;;6.0;8.5;
...
\label{m39341*id246981}
    \begin{center}
    \label{m39341*id246981!!!underscore!!!media}\label{m39341*id246981!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39341_MG10C11_024.png} % m39341;MG10C11\_024.png;;;6.0;8.5;
...
\label{m39341*id246993}
    \begin{center}
    \label{m39341*id246993!!!underscore!!!media}\label{m39341*id246993!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39341_MG10C11_025.png} % m39341;MG10C11\_025.png;;;6.0;8.5;
...
So there is one x-intercept at \begin{math}\left(\frac{4}{7},0\right)\end{math}.\item Putting all this together gives us the following graph:
    ...
    \begin{center}
    \label{m39341*uid12479!!!underscore!!!media}\label{m39341*uid12479!!!underscore!!!printimage}\includegraphics{col11306.imgs/m39341_hyperbola1.png} % ;hyperbola1.png;;;6.0;8.5;
...
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Find the answers with the shortcodes:
 ...
 (1.) lxB  &  (2.) lxK  & \end{tabular}
    ...
    \nopagebreak
      ...
      \label{m39348*uid172}
            \subsection{ Functions of the Form $y=a{b}^{\left(x\right)}+q$}
            \nopagebreak
...
\label{m39348*secfhsst!!!underscore!!!id3489}
            \subsubsection{  Investigation : Functions of the Form $y=a{b}^{\left(x\right)}+q$ }
            \nopagebreak
...
\label{m39348*id250546}
    \begin{center}
    \label{m39348*id250546!!!underscore!!!media}\label{m39348*id250546!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39348_MG10C11_028.png} % m39348;MG10C11\_028.png;;;6.0;8.5;
...
\label{m39348*id250558}
    \begin{center}
    \label{m39348*id250558!!!underscore!!!media}\label{m39348*id250558!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39348_MG10C11_029.png} % m39348;MG10C11\_029.png;;;6.0;8.5;
...
\label{m39348*id250596}
    \begin{center}
    \label{m39348*id250596!!!underscore!!!media}\label{m39348*id250596!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39348_MG10C11_030.png} % m39348;MG10C11\_030.png;;;6.0;8.5;
...
\label{m39348*id250608}
    \begin{center}
    \label{m39348*id250608!!!underscore!!!media}\label{m39348*id250608!!!underscore!!!printimage}\includegraphics[width=300px]{col11306.imgs/m39348_MG10C11_031.png} % m39348;MG10C11\_031.png;;;6.0;8.5;
...
So there is one x-intercept at \begin{math}\left(0,83,0\right)\end{math}.\item Putting all this together gives us the following graph:
    ...
    \begin{center}
    \label{m39348*uid12329!!!underscore!!!media}\label{m39348*uid123279!!!underscore!!!printimage}\includegraphics{col11306.imgs/m39348_exponent1.png} % ;exponent1.png;;;6.0;8.5;
...
\label{m39348*secfhsst!!!underscore!!!id4260}
            \subsubsection{  Exponential Functions and Graphs }
            \nopagebreak
