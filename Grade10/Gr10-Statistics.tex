...
% \usefont{T1}{ptm}{m}{n}
\rput{89.854546}(0.73185694,0.38878262){\rput(0.13573053,0.5775){Frequency}}
\end{pspicture} 
}
\end{center}
  \end{enumerate}
...
\item 
    ...
    \begin{tikzpicture}[xscale=0.4]
      ...
      \draw[dotted] ( \maximum, 0.2) -- ( \maximum, -1);
      \draw[dotted] ( \thirdquartile, 0.6) -- ( \thirdquartile, -1);
      \draw[dotted] (\median, 0.6)  -- ( \median, -1);
      \draw[dotted] (\firstquartile, 0.6) -- ( \firstquartile, -1);
      \draw[dotted] ( \minimum, 0.2) -- ( \minimum, -1);
    \end{tikzpicture}
%   \end{center}
\item 
