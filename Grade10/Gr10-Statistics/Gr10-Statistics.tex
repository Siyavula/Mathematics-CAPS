...
\begin{wex}{Effect of outliers on mean and median}{
  ...
  \westep{Compute the mean of the first $10$ learners.}
  ...
  \westep{Compute the mean of all $11$ learners.}
  ...
  \westep{Compute the median of the first $10$ learners.}
  ...
  \westep{Compute the median of all $11$ learners.}
