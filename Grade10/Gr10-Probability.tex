...
\begin{figure}[h]
  \paragraph{Experiment 1} A coin is tossed and it lands with either
...
\begin{figure}[h]
  \paragraph{Experiment 2} Two dice are rolled and the total number of
  dots added up.
...
\begin{exercises}{Theoretical probability}
  ...
  \item A playing card is selected randomly from a pack of $52$
    ...
    \end{enumerate[itemsep=5pt, label=\textbf{\arabic*}. ]}
...
\begin{wex}{Relative frequency and theoretical probability}{
  ...
  the trials are shown in the table below. \vspace*{\baselineskip}
