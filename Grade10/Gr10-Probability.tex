...
%THIS IFACT MUTS BE COMMENTED BACK IN -  BUT FOR NOW (10.20am, 25/10/2011) IT BREAKS THE STYLING THAT FOLLOWS IT
...
We will prove this identity using the Venn diagrams given in the previous section.
...
\begin{wex}{Union and intersection of events}{
  ...
  4 and show that they satisfy the identity
  \[P(A \cup B) = P(A) + P(B) - P(A \cap B)\]
}{
  \westep{Write down the probabilities of the two events, their union
    and their intersection.}
  
  From The figure in Worked Example 4
