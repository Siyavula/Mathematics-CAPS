...
\setcounter{enumi}{4}
    ...
    \end{enumerate}
Even numbers in the range $2$--$100$ are written on cards. 
    \begin{enumerate}[itemsep=5pt, label=\textbf{\arabic*}. ]
\setcounter{enumi}{9}
  \item What is
...
\begin{exercises}{Venn diagrams}
{
   ...
   Let $S$ denote the set of whole numbers from $1$ to $16$, $X$
...
\setcounter{enumi}{2}
    ...
    \end{enumerate}
 Pieces of paper labelled with the numbers $1$ to $12$ are
