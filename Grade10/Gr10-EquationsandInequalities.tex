...
\end{enumerate}
      \label{m39262*uid110}
            \subsubsubsection{ Application of Word Problems}
            \nopagebreak
            \par
...
\label{m39262*secfhsst!!!underscore!!!id6331}
            \subsubsubsection{Exercise:  Word Problems }
            \nopagebreak
...
\label{m39258*id978342}
            \subsubsubsection{Exercise: Solving literal equations}
            \nopagebreak
...
\label{m39254*secfhsst!!!underscore!!!id3912}
            \subsubsubsection{Inequalities and Interval Notation}
            \nopagebreak
      \label{m39254*id157128}{exercise}Represent the following
on number lines:\par 
...
\end{center}
 ...
 \end{figure}       
    ...
    \noindent
            \subsubsubsection{ Exercise: Linear Inequalities }
            \nopagebreak
