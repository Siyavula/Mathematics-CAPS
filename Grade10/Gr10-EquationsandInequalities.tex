...
\westep{Set up a system of equations}  
\begin{equation*}
\begin{array}{cll}\hfill 3x+2y& =& 21\hfill \\ \hfill x+y& =& 8\hfill \end{array}
\end{equation*}
...
\begin{equation*}
    \begin{array}{cll}\hfill 3x+2(8-x)& =& 21\hfill \\
    \end{array}
\end{equation*}
...
\begin{equation*}
\begin{array}{ccl} \hfill 2(7-t)+3t & =& 19\hfill 
\end{array}
\end{equation*}
...
\end{array}
\end{equation*}
Therefore there are $2$ bicycles and $7-2=5$ tricycles.
...
If we represent this answer using interval notation we write $(-\infty ~;-\frac{1}{2}]$.\par
...
\item A man runs to the bus stop and back in $15$ minutes. His speed on the way to the bus stop is $5~\ems$ and his speed on the way back is $4~\ems$. Find the distance to the bus stop.
\item Zanele and Piet skate towards each other on a straight path. They set off $20$ km apart. Zanele skates at $15$ km\textbackslash h and Piet at $10$ km\textbackslash h. How far will Piet have skated when they reach each other?
\item If the price of chocolates is increased by R $10$ and we buy five fewer chocolates for R $300$, calculate the price of each chocolate before the price was increased.
