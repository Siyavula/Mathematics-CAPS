...
\begin{center}
\begin{array}{lcl} \dfrac{{5}^{2x-1}\ensuremath{\,.\,}{9}^{x-2}}{{15}^{2x-3}}& =& \dfrac{{5}^{2x-1}\ensuremath{\,.\,}{\left({3}^{2}\right)}^{x-2}}{{\left(5.3\right)}^{2x-3}}\hfill \\
		  & =& \dfrac{{5}^{2x-1}\ensuremath{\,.\,}{3}^{2x-4}}{{5}^{2x-3}\ensuremath{\,.\,}{3}^{2x-3}}\hfill 
\end{array}
  \end{center}
...
\begin{center}
\begin{array}{lcl}
\phantom{\dfrac{{5}^{2x-1}\ensuremath{\,.\,}{9}^{x-2}}{{15}^{2x-3}}}& =& {5}^{(2x-1)-(2x-3)}\ensuremath{\,.\,}{3}^{(2x-4)-(2x-3)}\hfill \\ 
