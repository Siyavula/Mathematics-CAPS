...
\textbf{Nota:} wanneer ons met eksponentuitdrukkings werk, geld al die re\"els vir algebra\"ese bewerkings nog steed.
...
\begin{center}
 $ a^x &= a^y $ \\
then $ x &= y ~~\mbox{(dieselfde grondtal)}$\\
\end{center}
\par
...
\textbf{Nota:} om eksponent vergelykings op te los, gebruik ons al die prosedures vir die line\^ere en kwadratiese vergelykings.
