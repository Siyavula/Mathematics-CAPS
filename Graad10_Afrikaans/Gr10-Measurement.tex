...
\item 
Vind die totale buite-oppervlak van die volgende prismas (korrek tot $1$ desimale plek waar nodig):
\begin{center}
\scalebox{0.8} % Change this value to rescale the drawing.
{
\begin{pspicture}(0,-6.555141)(11.58,6.555141)
...
\end{center}
    \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
% \setcounter{enumi}{4}
 \item Bereken die buite-oppervlaks van die volgende soliede liggame.
\item Bereken die volume van die volgende soliede liggame.

\end{enumerate}

% \setcounter{enumi}{6}
\item Bereken die volumes en buite-oppervlaks van die volgende soliede liggame (korrek tot $1$ desimale plek):
\end{enumerate}
\begin{center}
\scalebox{1} % Change this value to rescale the drawing.
{
