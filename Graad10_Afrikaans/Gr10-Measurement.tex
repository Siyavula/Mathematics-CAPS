...
\scalebox{0.9}{
    ...
    \end{pspicture}}
\end{center}
& $\mbox{Oppervlakte} = \dfrac{1}{2} (a + b) \times h $ \\ \hline 
Parallelogram &
...
\begin{equation*}
\begin{array}{rcl}
 \mbox{Buite-oppervlakte }&=& \mbox{oppervlakte van groot reghoek}  + (2\times \mbox{oppervlakte van sirkel})\\
&=& 1~884,96 + 2(314,16) \\
&=&2~513,3\mbox{ cm}^2
\end{array}
\end{equation*}
...
\mbox{Volume} &= \mbox{oppervlakte van basis} \times \mbox{hoogte} \\
                &= \mbox{oppervlakte van reghoek} \times \mbox{hoogte} \\
                &= l \times b \times h \\
\end{aligned}$   \\ \hline
...
$\begin{aligned}
\mbox{Volume} &= \mbox{oppervlakte van basis} \times \mbox{hoogte} \\
                &= \mbox{oppervlakte van driehoek} \times \mbox{hoogte} \\
...
$\begin{aligned}
\mbox{Volume} &= \mbox{oppervlakte van basis} \times \mbox{hoogte} \\
                &= \mbox{oppervlakte van sirkel} \times \mbox{hoogte} \\
                &= \pi r^2 \times h \\
\end{aligned}$  \\ \hline
...
&
$\begin{aligned}
\mbox{Buite-oppervlakte} &= \mbox{ oppervlakte van basis } +\\
&~~~~~~\mbox{ oppervlakte van driehoekige vlakke } \\
...
$\begin{aligned}
\mbox{Buite-oppervlakte} &= \mbox{ oppervlakte van basis } +\\
&~~~~~~\mbox{oppervlakte van driehoekige sye} \\
...
$\begin{aligned}
\mbox{\small Buite-oppervlakte} &=  \mbox{\small oppervlakte van basis }+\mbox{\small oppervlakte van syvlak}\\
...
&
$\begin{aligned}
\mbox{ Volume} &=  \frac{1}{3} \times \mbox{ oppervlakte van basis } \times\\
