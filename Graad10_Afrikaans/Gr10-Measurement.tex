\chapter{ Meting }  
Hierdie hoofstuk ondersoek die buite-oppervlaktes en volumes van die drie-dimensionele voorwerpe, bekend as vaste liggame. Om hiermee te werk, moet jy weet hoe om die oppervlakte en omtrek van twee-dimensionele voorwerpe te bereken.

\section{Oppervlakte van poligone}
\Definition{Area}{Area is'n twee-dimensionele ruimte binne die grense van 'n plat voorwerp. Dit word gemeet in vierkante eenheide.}
\begin{table}[H]
...
\begin{wex}{Bepaaling van die oppervlakte van 'n poligoon}{
...
\end{pspicture} 
    ...
    \westep{Ons moet eers $BE$, die loodregte hoogte van die parallelogram,
vind. Ons kan Pythagoras gebruik om dit te doen:}
\begin{equation*}
\begin{array}{ccl}
AB^2 &=& BE^2 + AE^2\\
...
\end{equation*}
    ...
    \westep{ Ons pas die formule vir die area van ’n parallelogram toe om die
berekening te doen:}
\begin{equation*}
\begin{array}{ccl}
	\mbox{Area} &=& b \times h\\
...
\Definition{Regte prisma}{'n Regte prisma is a geometriese vaste liggaam met 'n poligoon as basis en een of meer sye loodreg op die basis. Die basis en die boonste vlak het dieselfde grootte en vorm en hulle is ewenydig aan mekaar. Dit word genoem 'n regte prisma omdat die hoeke tussen die basis en die sye regte hoeke is.}
’n Regte prisma is ’n veelhoek wat uitgerek word in ’n kolom sodat die hoogte van die
kolom reghoekig tot sy basis is. ’n Vierkantige prisma het ’n vierkantige basis, ’n driehoekige prisma het ’n
driehoekige basis en 'n reghoekige regte prisma het 'n reghoekige basis.
...
\Definition{Oppervlakarea}{Die term oppervlakarea verwys na die totale area van die oppervlak aan die buitekant van die prisma. Dit word ook genoem die totale buiteoppervlakte}
Dit is makliker om te verstaan as ’n mens aan die prisma dink as ’n soliede voorwerp.
'n Soliede voorwerp wat oopgevou word, word 'n ontbou\"ing genoem. Wanneer 'n prisma ontvou word, kan ons elke vlak duidelik sien. Om die oppervlakarea van die prisma te bereken, bereken ons eenvoudig die oppervlakte van elke vlak en tel hulle almal bymekaar.
\par 
...
die oppervlakarea van ’n driehoekige prisma te bereken moet die oppervlak van al vyf syvlakte bereken en bymekaartel
word.
.
  \par
’n Silinder bestaan uit twee sirkelvormige syvlakke en ’n reghoekige kolom met 'n lengte wat gelyk is aan die omtrek van die sirkelvormige basis. Om die oppervlakarea te bereken vind ons die area van die twee sirkels en van die reghoek en tel hulle bymekaar.
...
'n Kubus wat ontvou is, bestaan uit ses identiese vierkante. 'n Kubus is 'n vierkantige prisma wat uit ses eenderse vierkante bestaan.
...
Die ontvouing van 'n driehoekige prisma bestaan uit twee identiese driehoeke en een reghoek, wat bestaan uit drie reghoeke met dieselfde hoogte.
...
\begin{wex}
{Bereken die oppervlakarea van reghoekige prismas

}
{%Problem
Bereken die oppervlakarea van die volgende reghoekige prisma:
\begin{center}
\scalebox{0.9}{
    \begin{pspicture}(-2,-3.5)(3,1.5)
        \psset{yunit=0.9,xunit=0.9}
...
\westep{Vind die area van die verskillende vorme in die ontvouing}
\begin{align*} 
\mbox{Groot reghoek} &= \mbox{Omtrek van kleiner reghoek} \times \mbox{lengte} \\
                        &= (2+ 5 +2 + 5) \times 10 \\
                        &= 14 \times 10 \\
                        &= 140~\mbox{cm}^2  \\ \\
2 \times \mbox{area van kleiner reghoek} &= 2(5 \times 2) \\
                                &= 2(10) \\
                                &= 20~\mbox{cm}^2
\end{align*}
...
\westep{Vind die som van die areas van die vlakte}

$\mbox{groot reghoek} + 2 \times \mbox{klein reghoek} = 140 + 20 = 160$ cm$^2$.
\westep{Skryf die finale antwoord}
Die oppervlakarea van die reghoekige prisma is 160~cm$^2$.
}
\end{wex}


\begin{wex}
{Berekening van die oppervlakarea van 'n driehoekige prisma}
{Vind die oppervlakarea van die volgende driehoekige prisma:\\
\begin{center}
\scalebox{1}{
	%% Triangular Prism
\scalebox{1} % Change this value to rescale the drawing.
...
\westep{Skets en benoem die ontvouiing van die prisma}
...
\end{center}
\westep{Vind die areas van verskillende vorme in die ontvouiing}
Om die area van 'n reghoek te bereken moet ons sy lengte vind. Dit is gelyk aan die omtrek van die driehoeke.\\
\\
...
\begin{equation*}
\begin{array}{rcl}
 \therefore \mbox{area van groot driehoek}&=& \mbox{ omtrek van driehoek}\times \mbox{lengte}\\
&=& 18 \times 12 \\
&=&216 \mbox{ cm}^2
\end{array}
\end{equation*}
...
\begin{equation*}
\begin{array}{rcl}
\mbox{area van driehoek } &= &\frac{1}{2}b \times h\\
...
\begin{equation*}
\begin{array}{rcl}
 \mbox{oppervlakarea}&=& \mbox{area groot reghoek}  + (2\times \mbox{  area driehoek})\\
&=& 216 + 2(12) \\
&=& 240\mbox{ cm}^2
\end{array}
\end{equation*}
 ...
 \westep{Skryf die finale antwoord}
Die oppervlakarea van die driehoekige prisma is $240$ cm$^2$.
...
\begin{wex}
{Bereken die oppervlakarea van 'n silindriese prisma
}
{% Question
Vind die oppervlakarea van die volgende silinder (korrek to $1$ desimale plek):
\begin{center}
        \begin{pspicture}(-2,-3.5)(3,1.5)
	    \psset{yunit=0.9,xunit=0.9}
...
\westep{Vind die area van die verskillende vorm in die ontvouiing}

\begin{equation*}
\begin{array}{rcl}
\mbox{area van groot reghoek} &=& \mbox{omtrek van sirkel} \times \mbox{lengte} \\
...
\begin{equation*}
\begin{array}{rcl}
 \mbox{oppervlakarea }&=& \mbox{area van groot reghoek}  + (2\times \mbox{  area van sirkel})\\
&=& 1884,96 + 2(314,16) \\
&=&2513,3\mbox{ cm}^2
\end{array}
\end{equation*}
...
\westep{Skryf die finale antwoord}
Die oppervlakarea van die silinder is $2513,3\mbox{ cm}^2$.
}
\end{wex}
...
\item Bereken die oppervlakarea van:
...
% \usefont{T1}{ptm}{m}{n}
\rput(0.96203125,4.1521873){\textbf{(a)}}
% \usefont{T1}{ptm}{m}{n}
\rput(7.763125,4.0121875){\textbf{(b)}}
% \usefont{T1}{ptm}{m}{n}
...
\item As ’n liter verf nodig is vir ’n area van $2$ m$^{2}$, bereken hoeveel verf die verwer nodig het om die volgende
areas te verf:
...
\end{exercises}        
\subsection{Volume van ’n prisma en silinder}
...
$
\begin{aligned}
\mbox{Volume} &= \mbox{area van basis} \times \mbox{hoogte} \\
                &= \mbox{area van reghoek} \times \mbox{hoogte} \\
                &= l \times b \times h \\
\end{aligned}$   \\ \hline
...
\westep{Vind die area van die basis}
\begin{align*}
\mbox{area van vierkant} 
&=l \times b\\
&= 3 \times 3 \\
&= 9~\mbox{ cm}^2
\end{align*}

\westep{Vermenigvuldig die area van die basis van die vaste liggaam met die hoogte om die volume te kry}
\begin{align*}
...
\begin{wex}
{Vind die volume van 'n driehoekige prisma
}
...
\westep{Vind die area van die basis}
\begin{align*}
\mbox{area van driehoek} 
&=\dfrac{1}{2}b \times h\\
&= \left( \dfrac{1}{2} \times 8 \right)\times 10\\
                        &= 40\mbox{ cm}^2
\end{align*}

\westep{Bereken die volume van ’n prisma deur eers die area van die basis te bereken en dan te vermenigvuldig met die
...
\begin{wex}{Vind die volume van 'n silindriese prisma}
...
\westep{Vermenigvuldig die area van die basis met die
...
\section{Regte piramides, regte kegels (keëls / konusse), sfere}
\Definition{Piramide}{’n Piramide is ’n soliede geometriese figuur met ’n poligoonbasis wat verbind is aan die toppunt waar die syvlakke
ontmoet. (met ander woorde die sye is \textbf{nie} loodreg op die basis nie).} 

Die driehoekige piramide en vierkantige piramide neem hulle name van die vorm van die basis. Ons noem hulle 'regte' piramids omdat die hoogtelyn van die piramide by die tophoek loodreg is op die basis.Kegels is soortgelyk aan piramides behalwe dat hulle basisse sirkels is en nie poligone nie.\par
Voorbeelde van vierkantige-en driehoekige-piramides, 'n kegel en 'n sfeer:
\begin{figure}[ht]
\begin{center}
...
\subsection{Oppervlakarea van ’n piramide, kegel and sfeer}
...
&~~~~~~\mbox{ area van driehoekige vlakke } \\
...
$\begin{aligned}
\mbox{\small Oppervlakarea} &=  \mbox{\small area van basis }+\mbox{\small area van kante}\\
...
&
$\begin{aligned}
\mbox{\small oppervlakarea} &=  4\pi r^{2}
 \end{aligned}$\\ \hline
...
\begin{wex}{Bereken die oppervlakarea van 'n driehoekige piramide}
 {Vind die oppervlakarea van die volgende driehoekige piramide (korrek tot 1 desimale plek):\\
\begin{center}
\scalebox{1} % Change this value to rescale the drawing.
{
...
\westep{Vind die area van die basis}
\begin{align*}
 \mbox{area van 'n driehoek} &= \frac{1}{2} bh_b\\
...
&=3\sqrt{3}\\
\therefore \mbox{ van basis driehoek} &= \frac{1}{2} \times 6 \times 3\sqrt{3}\\
&=9\sqrt{3}\mbox{ cm}^2
\end{align*}
\westep{Vind die area van die kante}
\begin{align*}
 \mbox{area van vlakke} &= 3\left(\frac{1}{2} \times b\times h_s\right)\\
&=3\left(\frac{1}{2} \times 6 \times 10\right)\\
&=90\mbox{ cm}^2
\end{align*}

\westep{Vind die som van die areas}
\begin{align*}
9\sqrt{3} + 90&=105,6\mbox{ cm}^2\\

\end{align*}
\westep{Skryf die finale antwoord}
Die oppervlakarea van 'n driehoekige piramide is $105,6$ cm$^{2}$.
}
\end{wex}

\begin{wex}{Vind die oppervlakarea van 'n kegel}
...
\westep{Vind die area van die basis}
\begin{align*}
 \mbox{area van basis sirkel} &= \pi r^2\\
&= \pi4^2\\
&=16\pi
\end{align*}
...
\begin{align*}
 \mbox{ area van kante} &= \frac{1}{2}2\pi r h_s\\
&=\pi(4)(2\sqrt{53})\\
&= 8\pi\sqrt{53}\mbox{ cm}^2
\end{align*}
\westep{Vind die som van die areas}
\begin{align*}
\mbox{totale oppervlakarea } &= 16\pi + 8\pi\sqrt{53}\\
&=233,2\mbox{ cm}^2
\end{align*}
\westep{Skryf die finale antwoord}
Die oppervlakarea van die driehoekige piramide is $233,2\mbox{ cm}^2$.
}
\end{wex}

\begin{wex}{Vind die oppervlakarea van 'n sfeer}
 {Vind die oppervlakarea van die volgende sfeer (korrek tot $1$ desimale plek):
\begin{center}
\scalebox{0.9} % Change this value to rescale the drawing.
{
\begin{pspicture}(0,-1.9)(3.8,1.9)
...
{
\westep{Gebruik die formule om die oppervlakarea te vind}
\begin{align*}
 \mbox{oppervlakarea van sfeer} &= 4 \pi r^2\\
&= 4\pi5^2\\
&=100\pi\\
&=314,2\mbox{ cm}^2
\end{align*}
\westep{Skryf die finale antwoord neer}
Die oppervlakarea van 'n sfeer is $314,2\mbox{ cm}^2$.
}
...
\westep{Identifiseer die vlakke waaruit die kegel bestaan}
...
\begin{align*}
\mbox{Area of sektor }&=\frac{1}{2}\times \mbox{basis } \times \mbox{ hoogte (van ’n klein driehoekie)}\\
...
\westep{Bereken $a$}
Bereken $a$ met die Stelling van Pythagoras. Dus:
\begin{equation*}
a = \sqrt{r^{2} + h^{2}}
\end{equation*}
\westep{Bereken die area van die sirkelvormige basis ($A_{b}$)}
\begin{equation*}
A_{b} = \pi r^{2}
\end{equation*}
\westep{Bereken die are van die gebo\"e wand ($A_{w}$)}
\begin{eqnarray*}
A_{w} &=& \pi r a \\
&=& \pi r \sqrt{r^{2}+h^{2}}
\end{eqnarray*}
\westep{Vind die som van die areas $A$}
\begin{eqnarray*}
 A &=& A_{b} + A_{w} \\
...
\subsection{Volume of piramide, kegel and sfeer}
...
\begin{wex}{Volume van ’n piramide}
{
...
\begin{wex}{Volume van ’n driehoekige piramide}
...
{
\westep{Skets die driehoek en bereken die area}
...
\end{align*}
\westep{Bereken die volume van piramide}
\begin{align*}
...
\begin{wex}{Bereken die volume van 'n kegel}
...
\begin{wex}{Vind die volume van 'n sfeer}
 {Vind die volume van die volgende sfeer (korrect tot $1$ desimale plek):
\begin{center}
\scalebox{0.9} % Change this value to rescale the drawing.
{
\begin{pspicture}(0,-1.9)(3.8,1.9)
...
{
\westep{Gebruik die formule om die volume te berken}
\begin{align*}
...
\end{wex}
\begin{wex}{Vind die volume van 'n saamgestelde voorwerp}
...
{
\westep{Bereken die volume van die voorwerp}
a) Ons gebruik die formule vir die volume van ’n regte prisma\\
\\
i) Vind die hoogte van die basis driehoek
\begin{center}
 \scalebox{0.8}
{
\begin{pspicture}(0,-2.1564062)(4.64,2.097329)
...
\begin{align*}
\mbox{Area van basis driehoek } &= \frac{1}{2} \times 20 \times 10 \sqrt{3}\\
&=100 \sqrt{3}
\end{align*}

iii) Vind die volume van die prisma
\begin{align*}
\therefore \mbox{Volume van prisma} &= \mbox{area van basis driehoek }\times \mbox{ hoogte van prisma}\\
&=100 \sqrt{3} \times 42\\
&=42000\sqrt{3}\mbox{ cm}^3
\end{align*}

b) Vind die volume van die piramide\\
\\
Die area van die basis driehoek is gelyk aan area van die basis van die piramide.

\begin{align*}
\therefore \mbox{Volume van piramide} &= \frac{1}{3} (\mbox{area van basis}) \times H\\
&= \frac{1}{3} \times 100 \sqrt{3} \times 12 \\

&=400\sqrt{3}\mbox{ cm}^3
\end{align*}
c) Bereken die totale volume
\begin{align*}
\mbox{Totale volume } &= 42000\sqrt{3}+400\sqrt{3}\\
&= 7274,661 + 692,8\\
&=7967,4\mbox{ cm}^3
\end{align*}

Dus die totale volume van die voorwerp is $7967,4 \mbox{ cm}^3$.

\westep{Bereken die oppervlakarea van elke sigbare vlak van die piramide}
a) Om die oppervlakarea van die wande van die piramide te bereken, moet ons die skuinshoogte bereken ($h_s$)
\begin{center}
 \scalebox{0.9}
{
\begin{pspicture}(0,-2.1564062)(4.64,2.097329)
...
\end{center}
b) Ons kan $h_s$ bereken met die Stelling van Pythagoras. Dus:
...
c) Bereken die area van elke vlak:
\begin{align*}
\mbox{Area van een van die piramide syvlakke}&= \frac{1}{2}b \times h_s\\
&= \frac{1}{2} \times 20 \times \sqrt{219}\\
&=10\sqrt{219}\mbox{ cm}^2
\end{align*}
Omdat die basis driehoek gelyksydig is, het elke wand(syvlak) dieselfde basis, en dus dieselfde oppervlakarea. \\
Dus die oppervlakarea vie elke vlak van die piramide is $148$ cm$^{2}$.

\westep{Die oppervlakarea van die prisma}
Ons moet die oppervlakarea van die sye van die prisma bereken. DIt bestaan uit $3$ reghoeke met basis $b = 20$ cm en hoogte $h_p = 42$ cm.
\\
\\
a) Bereken die area van die wande van die prisma
\begin{align*}
 \mbox{Area van prisma wande(sykante)} &= 3(b \times h_p) \\
&= 3(20 \times 42)\\
&=2520\mbox{ cm}^2
\end{align*}


b)  Bereken die oppervlakarea van die prisma
\begin{align*}
 \mbox{Totale oppervlakarea} &= \mbox{ area van basis van prisma } + \mbox{ area van wande van prisma } + \\
&~~~~~~~~~\mbox{ area van sigbare vlakke van piramide } \\
...
\item Vind die totale oppervlakarea van die volgende prismas (korrek tot $1$ desimale plek indien nodig):
\begin{center}
\scalebox{0.8} % Change this value to rescale the drawing.
{
...
\item 
Vind die totale oppervlakarea van die volgende prismas (korrek tot $1$ desimale plek waar nodig):
\begin{center}
\scalebox{0.8} % Change this value to rescale the drawing.
{
\begin{pspicture}(0,-6.555141)(11.58,6.555141)
...
\end{center}
\item
Die vaste liggaam bestaan uit 'n kubus en 'n vierkantige piramide . Vind die volume en oppervlakarea van die voorwerp (korrek tot $1$ desimale plek):
\begin{center}
 \scalebox{1} % Change this value to rescale the drawing.
{
...
\section[The effect of multiplying a dimension with the factor $k$]{\Huge Die invloed van die vermenigvuldiging van 'n afmeting met 'n faktor $k$}
Wanneer een of meer van die afmetings van 'n prisma of 'n silinser met 'n konstante vermenigvuldig word, sal die oppervlakarea en die volume verander. Ons ondersoek die nuwe oppervlakarea en volume in die afmdeling wat volg.\par
Dit is moontlik om 'n verband te sien tussen die verandering in afmetings en die gevolglike veranding in oppervlakarea en volume. Hierdie verwantskap maak dit moontlik om die verandere volume en oppervlakarea te bereken as die afmetings van 'n voorwerp groter of kleiner gemaak word .\par
\mindsetvid{increasing surface area}{VMctl}
Beskou 'n rehoekige prisma met afmetings $l$, $b$ en $h$. Ons vermenigvuldig vervolgens een, twee en drie van die prisma se afmetings met 'n konstante faktor van $5$ en bereken dan die nuwe volume en oppervlakarea.\par
\begin{center}
\begin{table}[H]
...
Vermenigvuldig al dire afmetings met $k$ 
\begin{center}
\scalebox{0.8} % Change this value to rescale the drawing.
{
...
\begin{wex}{Bereken die nuwe oppervlakarea en volume van kubus}
 {
...
\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
 \item Bereken die oorspronklike oppervlakarea en volume.
\item Bereken die nuwe oppervlakarea ($A_n$) en volume ($V_n$) as die lengte van 'n sy van die basis vermeeder word met 'n konstante faktor van $3$.
\item Druk die nuwe oppervlakarea en volume uit as 'n faktor van die oorspronklike oppervlakarea en volume.
\end{enumerate}
}
{
\westep{Bereken die oorsponklike volume en oppervlakarea}
\begin{align*}
V&=l\times b\times h\\
&=3\times3\times4\\
&= 36\mbox{ cm}^3
...
&= 66 \mbox{ cm}^2
\end{align*}
\westep{Bereken die nuwe volume en oppervlakarea}
...
&= 306 \mbox{ cm}^2
\end{align*}
\westep{Druk die nuwe volume en oppervlakarea uit as 'n faktor van die oorspronklike volume en oppervlakarea}
\begin{align*}
V&=36\\
V_n&= 324\\
...
\begin{wex}{Vermenigvuldig een afmeting van 'n reghoekige prisma met $k$}
 {
...
Ons word oorspronklike afmetings $l$, $b$ en $h$ gegee\\
Dus die oorspronklike volume is $V = l \times b \times h$\\
\westep{Bereken die nuwe volume}
Die nuwe afmetings is $l$, $b$, en $kh$\\
Dus die nuwe volume is 
\begin{align*}
...
\begin{wex}{Vermenigvuldig afmetings van 'n silinder met $k$}
{Beskou 'n silinder met radius $r$ en hoogte $h$. Bereken die nuwe volume en oppervlakarea(uitgedruk in terme van $r$ en $h$) as die radius vermenigvuldig word met 'n konstante faktor van $k$.
\begin{center}
...
{
\westep{Bereken die oorspronklike volume en oppervlakarea}
\begin{align*}
 V&= \pi r^2 \times h\\
\end{align*}
\begin{align*}
...
\end{align*}
\westep{Bereken die nuwe volume en oppervlakarea}
Die nuwe afmetings van $kr$ en $h$
\begin{align*}
 V_n&= \pi (kr)^{2} \times h\\
&= \pi k^{2}r^{2} \times h\\
&=k^{2} \times \pi r^{2} h\\
...
\end{enumerate}
\item Gegewe 'n prisma met 'n volume van $493$ cm$^{3}$ en 'n oppervlakarea van $6007$ cm$^{2}$, 
Vind die nuwe oppervlakarea en volume vir die prisma as al die afmetings vermeeder word met 'n konstante faktor van $4$. 
\end{enumerate}
...
\begin{itemize}[noitemsep]
 \item Area is die twee dimensionele spasie binne die grense van 'n plaat voorwerp, gemeet in vierkante eenhede.
\item Area formules:
\begin{itemize}[noitemsep]
...
\item sirkel $= \pi r^2$
\end{itemize}
\item Oppervlakarea is die totale area van die buite of sigbare oppervlakke van 'n prisma.
\item 'n Ontvouiing is die oopgevoude 'plan' van 'n vaste liggaam.
...
\begin{itemize}[noitemsep]
\item Die volume van 'n kubus $=l \times b \times h$
\item Die volume van 'n driekhoekige prism $= (\frac{1}{2} b \times h) \times H$
\item Die volume van 'n vierkantige prisma or cube $=b^2 \times h$
\item Die volume van 'n silinder$=\pi r^2 \times h$
\end{itemize}
...
\item Die oppervlakarea van die prisma word bereken deur:
\begin{itemize}[noitemsep]
\item vierkant piramide $=b(b+2h)$
\item driehoekige piramide $= \frac{1}{2}b(h_b +3h_s)$
\item kegel $= \pi r(r+h_s)$
\item sfeer $= 4\pi r^2$
\end{itemize}
...
\item kegel $= \frac{1}{3} \times \pi r^2 \times H$
\item sfeer $= \frac{1}{3} \times 4\pi r^2$
\end{itemize}
\item Vermenigvuldiging van een of meer afmetings van 'n prisma of silinder met 'n konstante $k$ be\"invloed die oppervlakarea en volume.
\begin{eocexercises}{}
...
\end{center}
    \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
  \item Bereken die oppervlakarea van elke vaste liggaam.
\item Bereken die volume van elke voorwerp.
\item As elke afmeting van die voorwerpe vermeerder met 'n faktor van $3$, Bereken die nuwe oppervlakarea van elk.
...
% \setcounter{enumi}{6}
\item Bereken die volumes en oppervlakareas van die volgende soliede liggame (korrek tot $1$ desimale plek):
\end{enumerate}
\begin{center}
\scalebox{1} % Change this value to rescale the drawing.
{
