...
\Definition{Area}{Area is the two dimensional space inside the boundary of a flat object. It is measured is square units.}
\begin{table}[H]
...
\end{table}
       ...
       \Note{Onthou area word gemeet in vierkante eenhede: e.g. cm$^2$, m$^2$ or mm$^2$.}     
...
\end{pspicture} 
    ...
    \westep{Ons moet eers vir $ BE$ die loodregte hoogte van die parallelogram
...
\psline[linewidth=0.04cm,linestyle=d\raisebox{-0.2em}{\includegraphics[height=1em]{../icons/www.pdf}}
Kry die oplossing met die kortkodes:\\
\begin{tabularx}{\textwidth}{ XX }
(1)	&	(2)
\end{tabularx}ashed,dash=0.16cm 0.16cm](2.361875,2.3482811)(2.361875,1.8) 
% \usefont{T1}{ptm}{m}{n} 
...
\section{Reghoekige Prismas en Silinders}

\Definition{Reghoekige prisma}{'n Reghoekige prisma is a geometric solid that has a polygon as its base and one or more sides perpendicular to the base. The base and top surface are the same shape and size. It is called a ``right`` prism because the angles between the base and sides are right-angles.}
’n Reghoekige prisma is ’n veelhoek wat uitgerek word in ’n kolom sodat die hoogte van die
kolom reghoekig tot sy basis is. ’n Vierkantige prisma het ’n vierkantige basis en ’n driehoekige prisma het ’n
driehoekige basis.
...
\Definition{oppervlakarea}{Die term oppervlakarea verwys na die totale area van die oppervlak aan die buitekant van die prisma.}
...
\Note{Onthou area word gemeet in vierkante eenhede $^2$, m$^2$ or mm$^2$.}
\par
...
\begin{figure}[H]
 \begin{caption*}{\textbf{Square prism or cube}}\end{caption*}
    \begin{center}
...
A square prism (or cube) unfolded into a net is made up of six identical squares.
...
A triangular prism unfolded into a net is made up of two triangles and one rectangle, which is made up of three
...
{%Problem
Bereken die oppervlakarea van elk van die volgende reghoekige prisma:
\begin{center}
\scalebox{0.9}{
    \begin{pspicture}(-2,-3.5)(3,1.5)
        \psset{yunit=0.9,xunit=0.9}
...
% \setcounter{enumi}{3}
\item ’n Reghoekige swembad met binnewande en bodem met die volgende afmetings $4$ m $\times~3$ m $\times~2,5$ m (the inside walls and floor only).
...
\Note{Onthou are word gemeet in vierkante eenhede: e.g. cm$^3$, m$^3$ or mm$^3$.}
...
\westep{vermenigvuldig die basis met die
hoogte van die prisma to find the volume}
\begin{align*}
\mbox{volume} &= \mbox{area van die basis  } \times \mbox{ hoogte}\\
&=\pi r^{2} \times h\\
&= 50,27\times 15\\
...
\Definition{Pyramid}{’n Piramide is ’n soliede geometriese figuur met ’n poligoonbasis wat verbind is aan die toppunt waar die syvlakke
ontmoet. called the apex (in other words the sides are \textbf{not} perpendicular to the base).} 

The triangular pyramid and square pyramid take their names
...
\westep{Vind die som cvan die areas}
\begin{align*}
...
\westep{Sketch the side trangle and calculate pyramid height $H$}
...
\end{align*}
\westep{Bereken die volume van ’n Piramide}
\begin{align*}
...
\westep{Die oppervlakarea van die prisma is}
...
\begin{wex}{Calculating the new dimensions of a square prism}
 {
...
\psline[linewidth=0.04cm,linestyle=dashed,dash=
}0.17638889cm 0.10583334cm](11.0,1.8208936)(9.82,2.7008936)
