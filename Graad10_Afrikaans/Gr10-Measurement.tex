...
\Definition{Oppervlak}{Oppervlak is'n twee-dimensionele ruimte binne die grense van 'n plat voorwerp. Dit word gemeet in vierkante eenheide.}
\begin{table}[H]
\newcolumntype{C}{>{\centering\arraybackslash} m{1.2in} }
\newcolumntype{D}{>{\centering\arraybackslash} m{2in} }
\newcolumntype{E}{>{\centering\arraybackslash} m{1.5in} }
\begin{tabular}{|C|D|E|}
\hline
...
& $ \mbox{Oppervlak} = \dfrac{1}{2} b \times h $ \\ \hline
...
\scalebox{0.9}{
    ...
    \end{pspicture}}
\end{center}
& $\mbox{Oppervlak} = \dfrac{1}{2} (a + b) \times h $ \\ \hline 
Parallelogram &
...
\begin{wex}{Bepaaling van die oppervlak van 'n veelhoek}{
    Vind die oppervlak van die volgende parallelogram:\\
...
\end{equation*}
    ...
    \westep{ Gebruik die formule vir 'n parallelogram om die oppervlak te vind}
\begin{equation*}
\begin{array}{ccl}
	\mbox{Oppervlak} &=& b \times h\\
&=& AD \times BE \\
		    &=& 7 \times 4\\
		    &=& 28 \mbox{ mm}^2
    \end{array}
...
die kante van gelyke lengte is.
'n Slinder is' n ander tipe regte prisma wat 'n sirkel as sy
...
\Definition{Buite-oppervlak}{Die term buite-oppervlak verwys na die totale oppervlak aan die buitekant van die prisma. }
Dit is makliker om te verstaan as ’n mens aan die prisma dink as ’n soliede voorwerp.
'n Soliede voorwerp wat oopgevou word, word 'n ontbou\"ing genoem. Wanneer 'n prisma ontvou word, kan ons elke vlak duidelik sien. Om die buite-oppervlak van die prisma te bereken, bereken ons eenvoudig die oppervlak van elke vlak en tel hulle almal bymekaar.
\par 


Byvoorbeeld, die driehoekige prisma het twee syvlakke wat driehoekig is en drie syvlakke wat reghoekig is. Om
die buite-oppervlak van ’n driehoekige prisma te bereken moet die oppervlak van al vyf syvlakte bereken en bymekaartel
word.
  \par
’n Silinder bestaan uit twee sirkelvormige syvlakke en ’n reghoekige kolom met 'n lengte wat gelyk is aan die omtrek van die sirkelvormige basis. Om die buite-oppervlak te bereken vind ons die oppervlak van die twee sirkels en van die reghoek en tel hulle bymekaar.\par
...
\begin{wex}
{Berekening van die buite-oppervlak van 'n reghoekige prisma

}
{%Problem
Bereken die buite-oppervlak van die volgende reghoekige prisma:
\begin{center}
\scalebox{0.9}{
    \begin{pspicture}(-2,-3.5)(3,1.5)
        \psset{yunit=0.9,xunit=0.9}
...
\westep{Vind die som van die oppervlaktes van die vlakte}

$\mbox{groot reghoek} + 2 \times \mbox{klein reghoek} = 140 + 20 = 160$ cm$^2$.
\westep{Skryf die finale antwoord}
Die buite-oppervlak van die reghoekige prisma is 160~cm$^2$.
}
\end{wex}


\begin{wex}
{Berekening van die buite-oppervlak van 'n driehoekige prisma}
{Vind die buite-oppervlak van die volgende driehoekige prisma:\\
\begin{center}
...
\end{center}
\westep{Vind die oppervlaktes van verskillende vorme in die ontvouiing}
Om die oppervlak van 'n reghoek te bereken moet ons sy lengte vind. Dit is gelyk aan die omtrek van die driehoeke.\\
\\
...
\begin{equation*}
\begin{array}{rcl}
 \therefore \mbox{oppervlak van groot driehoek}&=& \mbox{ omtrek van driehoek}\times \mbox{lengte}\\
&=& 18 \times 12 \\
&=&216 \mbox{ cm}^2
\end{array}
\end{equation*}
...
\begin{equation*}
\begin{array}{rcl}
 \mbox{buite-oppervlak}&=& \mbox{oppervlak groot reghoek}  + (2\times \mbox{  oppervlak driehoek})\\
&=& 216 + 2(12) \\
&=& 240\mbox{ cm}^2
\end{array}
\end{equation*}
 ...
 \westep{Skryf die finale antwoord}
Die buite-oppervlak van die driehoekige prisma is $240$ cm$^2$.
...
\begin{wex}
{Bereken die buite-oppervlak van 'n silindriese prisma
}
{% Question
Vind die buite-oppervlak van die volgende silinder (korrek to $1$ desimale plek):
\begin{center}
        \begin{pspicture}(-2,-3.5)(3,1.5)
	    \psset{yunit=0.9,xunit=0.9}
...
\begin{equation*}
\begin{array}{rcl}
\mbox{oppervlak van groot reghoek} &=& \mbox{omtrek van sirkel} \times \mbox{lengte} \\
...
\begin{equation*}
\begin{array}{rcl}
 \mbox{buite-oppervlak }&=& \mbox{oppervlak van groot reghoek}  + (2\times \mbox{  oppervlak van sirkel})\\
&=& 1~884,96 + 2(314,16) \\
&=&2~513,3\mbox{ cm}^2
\end{array}
\end{equation*}
...
\westep{Skryf die finale antwoord}
Die buite-oppervlak van die silinder is $2~513,3\mbox{ cm}^2$.
}
\end{wex}
...
\item As ’n liter verf nodig is vir ’n oppervlak van $2$ m$^{2}$, bereken hoeveel verf die verwer nodig het om die volgende
...
Die volume van ’n reghoekige prisma word bereken deur die oppervlak van die basis met die hoogte te vermenigvuldig. 
\par 
...
\newcolumntype{E}{>{\centering\arraybackslash} m{2.4in} }
\begin{tabular}{|C|D|E|}
\hline
...
$
\begin{aligned}
\mbox{Volume} &= \mbox{oppervlak van basis} \times \mbox{hoogte} \\
                &= \mbox{oppervlak van reghoek} \times \mbox{hoogte} \\
                &= l \times b \times h \\
\end{aligned}$   \\ \hline
...
$\begin{aligned}
\mbox{Volume} &= \mbox{oppervlak van basis} \times \mbox{hoogte} \\
                &= \mbox{oppervlak van driehoek} \times \mbox{hoogte} \\
...
$\begin{aligned}
\mbox{Volume} &= \mbox{oppervlak van basis} \times \mbox{hoogte} \\
                &= \mbox{oppervlak van sirkel} \times \mbox{hoogte} \\
                &= \pi r^2 \times h \\
\end{aligned}$  \\ \hline
...
\westep{Vind die oppervlak van die basis}
\begin{align*}
\mbox{oppervlak van vierkant} 
&=l \times b\\
&= 3 \times 3 \\
&= 9~\mbox{ cm}^2
\end{align*}

\westep{Vermenigvuldig die oppervlak van die basis van die vaste liggaam met die hoogte om die volume te kry}
\begin{align*}
\mbox{volume} &= \mbox{oppervlak van basis} \times \mbox{hoogte}\\
                    &= 9 \times 3 \\
                    &= 27\mbox{ cm}^3 
...
\begin{wex}
{Berekining van die volume van 'n driehoekige prisma
}
...
\westep{Vind die oppervlak van die basis}
\begin{align*}
\mbox{oppervlak van driehoek} 
&=\dfrac{1}{2}b \times h\\
&= \left( \dfrac{1}{2} \times 8 \right)\times 10\\
                        &= 40\mbox{ cm}^2
\end{align*}

\westep{Vermenigvuldig die oppervlak van die basis met die
hoogte van die prisma om die volume te kry}
\begin{align*}
\mbox{volume} &= \mbox{oppervlak van die basis} \times \mbox{hoogte}\\
...
\begin{wex}{Berekining van die volume van 'n silindriese prisma}
...
\begin{exercises}{}
Bereken die volume van die volgende prismas (korrek tot een desimale plek):
\begin{center}
...
Voorbeelde van 'n vierkantige-en driehoekige-piramid, 'n keël en 'n sfeer:
\begin{figure}[ht]
\begin{center}
...
\subsection{Buite-oppervlaktes van piramides, keëls and sfere}
...
&
$\begin{aligned}
\mbox{buite-oppervlak} &= \mbox{ oppervlak van basis } +\\
&~~~~~~\mbox{ oppervlak van driehoekige vlakke } \\
...
$\begin{aligned}
\mbox{Buite-oppervlak} &= \mbox{ oppervlak van basis } +\\
&~~~~~~\mbox{oppervlak van driehoekige sye} \\
...
$\begin{aligned}
\mbox{\small Buite-oppervlak} &=  \mbox{\small oppervlak van basis }+\mbox{\small oppervlak van kante}\\
...
&
$\begin{aligned}
\mbox{\small Buite-oppervlak} &=  4\pi r^{2}
 \end{aligned}$\\ \hline
...
\begin{wex}{Bereken die buite-oppervlak van 'n driehoekige piramide}
 {Vind die buite-oppervlak van die volgende driehoekige piramide (korrek tot 1 desimale plek):\\
\begin{center}
\scalebox{1} % Change this value to rescale the drawing.
{
...
\westep{Vind die oppervlak van die basis}
\begin{align*}
 \mbox{oppervlak van 'n driehoek} &= \frac{1}{2} bh_b\\
...
&=3\sqrt{3}\\
\therefore \mbox{ oppervlak van basis driehoek} &= \frac{1}{2} \times 6 \times 3\sqrt{3}\\
&=9\sqrt{3}\mbox{ cm}^2
\end{align*}
\westep{Vind die oppervlak van die kante}
\begin{align*}
 \mbox{oppervlak van vlakke} &= 3\left(\frac{1}{2} \times b\times h_s\right)\\
...
\end{align*}
\westep{Skryf die finale antwoord}
Die buite-oppervlak van 'n driehoekige piramide is $105,6$ cm$^{2}$.
}
\end{wex}

\begin{wex}{Vind die buite-oppervlak van 'n keël}
 {Vind die buite-oppervlak van die volgende keël (korrek tot 1 desimale plek):
\begin{center}
...
\westep{Vind die oppervlak van die basis}
\begin{align*}
 \mbox{oppervlak van basis sirkel} &= \pi r^2\\
&= \pi4^2\\
&=16\pi
\end{align*}
...
\westep{Vind die oppervlak van die kante}
\begin{align*}
 \mbox{oppervlak van kante} &= \pi rh_s
\end{align*}
...
\begin{align*}
 \mbox{ oppervlak van kante} &= \frac{1}{2}2\pi r h_s\\
&=\pi(4)(2\sqrt{53})\\
&= 8\pi\sqrt{53}\mbox{ cm}^2
\end{align*}
\westep{Vind die som van die oppervlaktes}
\begin{align*}
\mbox{totale buite-oppervlak } &= 16\pi + 8\pi\sqrt{53}\\
&=233,2\mbox{ cm}^2
\end{align*}
\westep{Skryf die finale antwoord}
Die buite-oppervlak van die driehoekige piramide is $233,2\mbox{ cm}^2$.
}
\end{wex}

\begin{wex}{Vind die buite-oppervlak van 'n sfeer}
 {Vind die buite-oppervlak van die volgende sfeer (korrek tot $1$ desimale plek):
\begin{center}
\scalebox{0.9} % Change this value to rescale the drawing.
{
\begin{pspicture}(0,-1.9)(3.8,1.9)
...
{
\westep{Gebruik die formule om die buite-oppervlak te vind}
\begin{align*}
 \mbox{buite-oppervlak van sfeer} &= 4 \pi r^2\\
&= 4\pi5^2\\
&=100\pi\\
&=314,2\mbox{ cm}^2
\end{align*}
\westep{Skryf die finale antwoord neer}
Die buite-oppervlak van 'n sfeer is $314,2\mbox{ cm}^2$.
}
...
\begin{wex}
{Ondersoek die buite-oppervlak van 'n keël}
{As ’n keël ’n hoogte het van $h$ en ’n
basis met radius $r$, toon dat die buite-oppervlak gegee word deur:\\ $\pi r^2 + \pi r \sqrt{r^2+h^2}$.}
{
...
\begin{align*}
\mbox{Oppervlak van sektor }&=\frac{1}{2}\times \mbox{basis } \times \mbox{ hoogte (van ’n klein driehoekie)}\\
...
a = \sqrt{r^{2} + h^{2}}
\end{equation*}
\westep{Bereken die oppervlak van die sirkelvormige basis ($A_{b}$)}
\begin{equation*}
A_{b} = \pi r^{2}
\end{equation*}
...
&=& \pi r \sqrt{r^{2}+h^{2}}
\end{eqnarray*}
\westep{Vind die som van die oppervlak $A$}
\begin{eqnarray*}
 A &=& A_{b} + A_{w} \\
...
\subsection{Volume van piramides, keëls and sfere}
...
&
$\begin{aligned}
\mbox{ Volume} &=  \frac{1}{3} \times \mbox{ oppervlak van basis } \times\\
...
\begin{wex}{Berekining van die volume van ’n piramide}
{
...
\begin{wex}{Berekining van die volume van ’n driehoekige piramide}
...
{
\westep{Skets die driehoek en bereken die oppervlak}
...
\begin{align*}
\therefore \mbox{ oppervlak of base triangle} &= \frac{1}{2} b \times h_b\\
...
\begin{wex}{Berekining van die volume van 'n sfeer}
...
\item Vind die oppervlak van elke vlak van die piramide.
\item Vind die totale buite-oppervlak van die voorwerp.
\end{enumerate}
...
a) Vind die oppervlak van die basis driehoek
% \begin{center}
% 
% \scalebox{0.8} % Change this value to rescale the drawing.
% {
...
\begin{align*}
\mbox{oppervlak van basis driehoek } &= \frac{1}{2} \times 20 \times 10 \sqrt{3}\\
&=100 \sqrt{3}
\end{align*}

c) Vind die volume van die prisma
\begin{align*}
\therefore \mbox{volume van prisma} &= \mbox{oppervlak van basis driehoek }\times \mbox{ hoogte van prisma}\\
&=100 \sqrt{3} \times 42\\
...
\\
Die oppervlak van die basis driehoek is gelyk aan die oppervlak van die basis van die piramide.

\begin{align*}
\therefore \mbox{volume van piramide} &= \frac{1}{3} (\mbox{oppervlak van basis}) \times H\\
...
{
\westep{Bereken die buite-oppervlak van elke sigbare vlak van die piramide}
\begin{align*}
...
en dus dieselfde oppervlakte. Daarom die buite-oppervlak vir
elke vlak van die piramide is $133$ cm$^{2}$.

\westep{Bereken die buite-oppervlak van elke vlak van die prisma}
Elke vlak van die prisma is 'n reghoek met basis $b = 20$ cm en hoogte $h_p = 42$ cm.


\begin{align*}
  \mbox{oopervlak van een vlak van die prisma}
  &= b \times h_p \\
  &= 20 \times 42 \\
  &= 840\mbox{ cm}^2
\end{align*}
Omdat die basis driehoek gelyksydig is, het elke vlak dieselfde oppervlakte. Daarom die buite-oppervlak vir
elke vlak van die prisma is
is $840$ cm$^{2}$.

\westep{Bereken die totale buite-oppervlak vir die voorwerp}
\begin{equation*}
  \begin{array}{r@{\;}c@{\;}l}
    \mbox{totale buite-oppervlak} &=& \mbox{area van basis van prisma} + \mbox{area van sye van prisma } + \\
                              & & \mbox{oppervlak van elke sigbare vlak van die piramide} \\
    &=& (100 \sqrt{3}) + 3(840) + 3(133) \\
    &=& 3~092,2\mbox{ cm}^3
  \end{array}
\end{equation*}
Dus, die total buite-oppervlak (van die sigbare kante) van die voorwerp is $3~092,2$ cm$^{2}$.
}
\end{wex}
...
\section{Die invloed van die vermenigvuldiging van 'n afmeting met 'n faktor $k$}
Wanneer een of meer van die afmetings van 'n prisma of 'n silinder met 'n konstante vermenigvuldig word, sal die buite-oppervlak en die volume verander. 
%english
The new surface area and volume can be calculated by
using the formulae from the preceding section.
\par
Dit is moontlik om 'n verband te sien tussen die verandering in afmetings en die gevolglike veranding in buite-oppervlak en volume. Hierdie verwantskap maak dit moontlik om die verandere volume en buite-oppervlak te bereken as die afmetings van 'n voorwerp groter of kleiner gemaak word .\par
\mindsetvid{increasing surface area}{VMctl}
Beskou 'n rehoekige prisma met afmetings $l$, $b$ en $h$. Ons vermenigvuldig vervolgens een, twee en drie van die prisma se afmetings met 'n konstante faktor van $5$ en bereken dan die nuwe volume en buite-oppervlak.\par
\begin{table}[H]
\begin{center}
...
\begin{wex}{Bereken die nuwe buite-oppervlak en volume van kubus}
 {
\begin{minipage}{\textwidth}
...
\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
 \item Bereken die oorspronklike buite-oppervlak en volume.
\item Bereken die nuwe buite-oppervlak ($A_n$) en volume ($V_n$) as die lengte van 'n sy van die basis vermeeder word met 'n konstante faktor van $3$.
\item Druk die nuwe buite-oppervlak en volume uit as 'n faktor van die oorspronklike buite-oppervlak en volume.
\end{enumerate}
\end{minipage}
}
{
\westep{Bereken die oorsponklike volume en buite-oppervlak}
\begin{align*}
V&=l\times b\times h\\
&=3\times3\times4\\
&= 36\mbox{ cm}^3
...
&= 66 \mbox{ cm}^2
\end{align*}
\westep{Bereken die nuwe volume en buite-oppervlak}
...
&= 306 \mbox{ cm}^2
\end{align*}
\westep{Druk die nuwe volume en buite-oppervlak uit as 'n faktor van die oorspronklike volume en buite-oppervlak}
\begin{align*}
V&=36\\
V_n&= 324\\
...
\begin{wex}{Vermenigvuldig die afmeting van 'n reghoekige prisma met $k$}
 {
...
Die nuwe afmetings is $l$, $b$, en $kh$ dus die nuwe volume is 
\begin{align*}
...
\begin{wex}{Vermenigvuldig die afmetings van 'n silinder met $k$}
{Beskou 'n silinder met radius $r$ en hoogte $h$. Bereken die nuwe volume en buite-oppervlak (uitgedruk in terme van $r$ en $h$) as die radius vermenigvuldig word met 'n konstante faktor van $k$.
\begin{center}
...
{
\westep{Bereken die oorspronklike volume en buite-oppervlak}
\begin{align*}
 V&= \pi r^2 \times h\\
A&= \pi r^2 + 2\pi rh
\end{align*}
...
\end{enumerate}
\item Gegewe 'n prisma met 'n volume van $493$ cm$^{3}$ en 'n buite-oppervlak van $6~007$ cm$^{2}$, 
vind die nuwe buite-oppervlak en volume vir die prisma as al die afmetings vermeeder word met 'n konstante faktor van $4$. 
\end{enumerate}
...
\begin{itemize}[noitemsep]
 \item Oppervlak is die twee-dimensionele spasie binne die grense van 'n plaat voorwerp, gemeet in vierkante eenhede.
\item Oppervlak formules:
\begin{itemize}[noitemsep]
...
\item sirkel $= \pi r^2$
\end{itemize}
\item Buite-oppervlak is die totale van die buite of sigbare oppervlaktes van 'n prisma.
...
\item Die volume van 'n vierkantige prisma of kubus $=b^2 \times h$
...
\end{itemize}
\item Vermenigvuldiging van een of meer afmetings van 'n prisma of silinder met 'n konstante $k$ be\"invloed die buite-oppervlak en volume.
\begin{eocexercises}{}
...
\end{center}
    \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
  \item Bereken die buite-oppervlak van elke vaste liggaam.
\item Bereken die volume van elke voorwerp.
\item As elke afmeting van die voorwerpe vermeerder met 'n faktor van $3$, Bereken die nuwe buite-oppervlak van elk.
...
\end{center}
    \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
% \setcounter{enumi}{4}
 \item Bereken die buite-oppervlaks van die soliede liggame.
\item Bereken die volume van die soliede liggame.

\end{enumerate}

% \setcounter{enumi}{6}
\item Bereken die volume en buite-oppervlak van die volgende soliede liggaam (korrek tot $1$ desimale plek):
\end{enumerate}
\begin{center}
\scalebox{1} % Change this value to rescale the drawing.
{
