...
\end{pspicture} 
    ...
    \westep{gebruik Pythagoras om die loodregte hoogte  $BE$ van die parallelogram te vind}
\begin{equation*}
\begin{array}{ccl}
AB^2 &=& BE^2 + AE^2\\
...
\end{equation*}
    ...
    \westep{ Gebruik die formule vir 'n parallelogram om die area te vind}
\begin{equation*}
\begin{array}{ccl}
	\mbox{Area} &=& b \times h\\
&=& AD \times BE \\
...
.
  \par
’n Silinder bestaan uit twee sirkelvormige syvlakke en ’n reghoekige kolom met 'n lengte wat gelyk is aan die omtrek van die sirkelvormige basis. Om die oppervlakarea te bereken vind ons die area van die twee sirkels en van die reghoek en tel hulle bymekaar.\par
...
\westep{Skryf die finale antwoord}
Die oppervlakarea van die silinder is $2~513,3\mbox{ cm}^2$.
}
\end{wex}
