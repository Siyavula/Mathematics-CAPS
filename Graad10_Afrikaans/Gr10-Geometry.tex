...
bekend as die hoekpunt. Hoeke word aangedui deur ’n $\hat{}$ (genoem ’n kappie) bo ’n letter te plaas. Hoeke kan ook aangedui word met behulp van die lyn segmente waaruit die hoek bestaan, byvoorbeeld $C\hat{B}A$ or $A\hat{B}C$.

 Die $\angle $ simbool is 'n kort metode om hoek te skyrf in meetkunde en word dikwels gebruik vir frases soos ``som van  $\angle$s in 'n $\triangle$''. \par 
...
\subsection*{Ewewydige lyne en dwarslyne} Twee lyne sny mekaar as hulle kruis by ‘n punt. Byvoorbeeld, by ‘n verkeerskruising sny twee of meer strate en die
snypunt van die kruising is die gemeenskaplike punt tussen die strate.
 Ewewydige lyne is lyne wat nooit kruis nie. Hulle word aangedui deur pyle, soos hieronder getoon is.
\par 
\setcounter{subfigure}{0}
\begin{figure}[H]
 \begin{center}
...
\subsection*{Gelykvormige driehoeke}
     %english
Twee driehoeke is soortgelyk as een driehoek 'n uitbreiding van die ander is. Dit beteken dat hulle ooreenkomstige hoeke gelyk in die meet is en die verhouding van die ooreenstemmende sye in verhouding is. Die twee driehoeke het dieselfde vorm, maar 'n ander skaal. Kongruent driehoeke is gelykvormige driehoeke, maar nie alle gelykvormige driehoeke kongruent is. Die volgende tabel beskryf die vereistes vir die gelykvormigheid:
\par 
\begin{table}[H]
        \begin{center}
...
{
%english 
Bewys dat as albei pare teenoorstaande hoeke in 'n vierhoek gelyk ann mekaar is, is die vierhoek 'n parallelogram.
\\
\begin{center}
...
\begin{Investigation}{Bewys dat 'n vierhoek 'n parallelogram is}
 \begin{enumerate}[label=\textbf{\arabic*}.]
 \item Bewys dat ias beide pare teenoorgestelde kante van 'n vierhoek gelyk is, is die vierhoek dan 'n parallelogram.

 \item Bewys dat as die hoeklyne van 'n vierhoek mekaar halveer, is die vierhoek dan 'n parallelogram.

 \item Bewys dat as 'n paar van die teenoorgestelde kante van' n vierhoek albei gelyk en ewewydig is, is die vierhoek dan 'n parallelogram.
 \end{enumerate}
\end{Investigation}
...
\begin{itemize}[noitemsep]
 \item Neide pare teenoorstaande sye ewewydig is.
 \item Beide pare teenoorstaande sye ewe lank is.
 \item Beide pare teenoorstaande hoeke gelyk is.
 \item Die hoeklyne mekaar halveer.
 \item Een paar teneoorstaande sye ewewydig en gelyk is.
\end{itemize}
...
\item Beide pare teenoorstaande sye is ewewydig.
\item Beide pare teenoorstaande sye is ewe lank.
\item Beide pare teenoorstaande hoeke is gelyk.
...
%english
'n Ruit het all die eienskappe van 'n parallelogram:
\begin{itemize}[noitemsep]
\item Beide pare teenoorstaande sye is ewewydig.
\item Beide pare teenoorstaande sye is ewe lank.
\item Beide pare teenoorstaande hoeke is gelyk.
...
%english
Om te bewys dat 'n parallelogram 'n ruit is, moet ons enige een van die volgende toon:
...
\par
%english
'n Vierkant is' n reghoek met al vier kante gelyk in lengte.
}
...
\begin{itemize}[noitemsep]
%english
\item Diagonaal tussen gelyke kante halveer die ander diagonaal.
\item Een paar teenoorstaande hoeke (die hoeke tussen die ongelyke sye) is ewe groot.
\item Diagonal tussen gelyke sye halveer die binnehoeke en is 'n simmetriese as.
...
%english below
\begin{wex}{Bewys dat 'n vierhoek 'n parallelogral is}
{
...
\item As $R\hat TU = 68^{\circ}$ bereken, met redes, die grote van $T \hat{S} U$.
\end{enumerate}
...
\end{center}
\begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
\item Bewys dat $M$ die middelpunt van $NP$ is.
\item As $ST=4$ cm en die area van $\triangle SNT$ $6$ cm$^2$ is, bereken die area van $\triangle MNR$.
\item Bewys dat die area van $\triangle MNR$ sal altyd vier keer so groot as die area van $\triangle SNT$ wees, laat $ST=x$ eenhede en $SN=y$ eenhede.
\end{enumerate}
\end{enumerate}
