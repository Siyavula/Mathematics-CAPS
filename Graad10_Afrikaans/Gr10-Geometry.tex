...
snypunt van die kruising is die gemeenskaplike punt tussen die strate.
 Ewewydige lyne is lyne wat nooit kruis nie. 
%english
They are denoted by arrow symobls as shown below.\par 
\setcounter{subfigure}{0}
\begin{figure}[H]
 \begin{center}
\scalebox{1}{
...
\item %english question
$PQR$ is an isosceles with $PR=QR$. $S$ is the mid-point of $PQ$, $T$ is the mid-point of $PR$ and $U$ is the mid-point of $RQ$.
\begin{center}
