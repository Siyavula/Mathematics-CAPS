...
In die diagram hier onder, sny die twee reguitlyne $AB$ en $CD$ by punt $X$, om vier hoeke $\hat{A}$, $\hat{B}$, $\hat{C}$ and $\hat{D}$ te vorm.\par 
...
Australian lyn oor die Nullarbor vlakte, is 478 km (297 miles) pylreguit,
van Mile 496, tussen Nurina and Loongana, Western Australia, tot by
Mile 793, tussen Ooldea and Watson, South Australia.}
...
As die hoekpunte van ’n driehoek benoem word met $A$, $B$, en $C$, dan praat ons van $\Delta ABC$ \par 
...
{
\westep{Verbind $AC$ om $\triangle ABC$ en $\tirangle CDA$}
