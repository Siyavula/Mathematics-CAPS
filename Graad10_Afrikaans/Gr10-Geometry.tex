...
Hoeke word gemeet in grade wat aangedui word deur die volgende simbool $^{\circ }$, 'n klein sirkeltjie bokant die teks soos 'n eksponent aan te dui ('superscript').\par 
...
In die diagram hier onder, sny die twee reguitlyne $AB$ en $CD$ by punt $X$, om vier hoeke $\hat{A}$, $\hat{B}$, $\hat{C}$ en $\hat{D}$ te vorm.\par 
...
\label{fig:mg:f:specialangles2}
 \end{figure}        
Die tabel gee ‘n opsomming van die spesiale hoekpare wat genoem word as twee reguitlyne mekaar sny.\par 
...
Aangrensende hoeke & Hoeke wat 'n hoekpunt en 'n gemeenskaplike sy deel & $\hat{A}$ en $\hat{D}$ \\ 
& & $\hat{C}$ en $\hat{D}$ etc. \\ \hline
Teenoorstaande of regoorstaande hoeke & Hoeke regoor mekaar wanneer twee lyne mekaar sny. Hulle deel 'n hoekpunt en is ewe groot & $\hat{A}=\hat{C}$;\\
 &  & $\hat{B}=\hat{D}$\\ \hline
Supplementêre hoeke & Hoeke waarvan die som $180^{\circ}$ is. & $\hat{A}+\hat{B}=180^{\circ}$;\\ 
...
lyne is altyd ewe groot. Aangrensende hoeke op ‘n reguitlyn is supplementêr.
}


\subsubsection{Ewewydige Lyne wat gesny word deur dwarslyne} Twee lyne sny mekaar as hulle kruis by ‘n punt. Byvoorbeeld, by ‘n verkeerskruising sny twee of meer strate en die
snypunt van die kruising is die gemeenskaplike punt tussen die strate.\par  ewewydige lyne is lyne wat nooit kruis nie. Byvoorbeeld, spoorlyne is parallel (gerirflikheidshalwe s\^e wiskundiges soms dat ewewydige lyne by 'n oneindige punt sny, dus 'n oneindige afstand weg). Ons wil nie h\^e spoorlyne moet mekaar ontmoet nie - dit sou 'n katastrofe wees!\par 
\setcounter{subfigure}{0}
\begin{figure}[H]
 \begin{center}
\scalebox{1}{
...
\rput[l](0.2,-.5){$C$}
\rput[r](5.8,2.5){$D$}
  \end{pspicture}Co-interior e
}  
 \end{center}
\end{figure} 
\begin{center}{$AB \parallel CD$ en $MN \parallel OP$ }\end{center} \\    
...
’n Dwarslyn van twee of meer lyne is ‘n lyn wat hierdie lyne sny. Byvoorbeeld, $AB \parallel CD$ en $EF$ is ‘n dwarslyn. Die eienskappe van hoeke wat gevorm word by hierdie
...
buitekant \\ \hline
ooreenkomstige hoeke & die hoeke aan dieselfde kant van die snylyn en aan dieselfde kant van die ewewydige lyne & $\hat{a} = \hat{e}$,  $\hat{b} = \hat{f}$,  $\hat{c} = \hat{g}$ en  $\hat{d} = \hat{h}$ is ooreenkomstige hoeke &
\raisebox{-.8\height}{
...
\begin{equation*}
\begin{array}{rl}
\mbox{Indien }EF \parallel CG \mbox{ dan } \hat{p} &= \hat{s} \mbox{ (ooreenkomstige. $\angle$'e)} \\
\mbox{Maar }\hat{p} &= 20^{\circ} \\
\mbox{ en } \hat{s}&= 30^{\circ} \\
\mbox{Dus }EF \mbox{ is nie ewewydige aan } CG.& \mbox{nie} \\
\end{array}
\end{equation*} 
}
\end{wex}
...
'n Driehoek is ’n drie-sydige poligoon. Driehoeke kan geklassifiseer word volgens sye of volgens hoeke: ongelyksydig, gelyksydig, gelykbenig, reghoekig, skerphoekig, stomphoekig. \par 
...
\end{center}
 & enen binnehoek is groter as $90^{\circ}$. \\ \hline
Reghoekig &
\begin{center}
\scalebox{0.7}{
...
\begin{Ondersoek}{binnehoeke van 'n driehoek }
...
\begin{Ondersoek}{buitehoeke van 'n driehoek}
        \nopagebreak  
\begin{center}
\scalebox{0.8} % Change this value to rescale the drawing.
{
...
SSS \newline (Sy, sy, sy) & As die 3 sye van ’n driehoek net so lank is soos die ooreenkomstige 3 sye van ’n ander driehoek, dan is die 2 driehoeke kongruent. &  
\begin{center}
\hspace{6pt}
\scalebox{0.5} % Change this value to rescale the drawing.
{
...
SAS \newline (Sy, hoek, sy) & As 2 sye en die ingeslote hoek van een driehoek net so groot is soos 2 sye en die ingeslote hoek van ’n ander driehoek, dan is die 2 driehoeke kongruent. & \begin{center}
\hspace{15pt}
\scalebox{0.5} % Change this value to rescale the drawing.
{
...
HHS  \newline (hoek, hoek, sy) &  As 1 sy en 2 hoeke van ’n driehoek net so groot is as die ooreenkomstige sy en 2 hoeke van ’n ander driehoek, dan is die 2 driehoeke kongruent. & 
\begin{center}        
\hspace{13pt}
\scalebox{0.5} % Change this value to rescale the drawing.
{
...
\end{table}
\textbf{Nota oor notasie:} Die volgorde van die letters wanneer kongruente driehoek benoem word, is baie belangrik. 
\begin{center}
...
HHH \newline (Hoek, hoek, hoek) & As 3 hoeke van een driehoek gelyk is aan die 3 hoeke
...
SSS \newline (Sy, sy, sy) & As al $3$ sye van ’n driehoek eweredig is aan die ooreenstemmende $3$ sye van ’n ander driehoek, dan is die driehoeke gelykvormig.&
\begin{center}
\scalebox{.8} % Change this value to rescale the drawing.
{
...
\textbf{Nota oor notasie:} Die volgorde van letters vir gelykvormige driehoeke is baie belangrik. Benoem altyd gelykvormige driehoek in ooreenkomstige volgorde. Byvoorbeeld:
\begin{align*}
 \triangle MNL&|||\triangle RST \mbox{  is reg.}\\
...
{\westep{Ondersoek die inligting watgegee is vir die twee driehoeke}
...
\begin{equation*}
 \begin{array}{rcll}
\triangle CDE &\equiv& \triangle CBA &\mbox{ (bewys) en (HHS)} \\
 CE &=& CA  & \\
 \therefore z &=& 5 & 
 \end{array}
\end{equation*}
...
%      
% \label{m38380*id1166233687055}$\mbox{DE}=\mbox{AB}=3$\hspace
% {1ex} (given)\par 
%       \label{m38380*id1166230595268}\nopagebreak\noindent{}
%         \settowidth{\mymathboxwidth}{\begin{equation}
%     \therefore \triangle \mbox{ABC}\equiv \triangle \mbox{CDE}\tag{13.3}
%       \end{equation}
%     }
...
%     \therefore \triangle \mbox{ABC}\equiv \triangle \mbox{CDE}$}\hfill
...
% }{\begin{equation}
%     \begin{array}{ccc}\hfill {\mbox{CE}}^{2}& =&
% {\mbox{DE}}^{2}+{\mbox{DC}}^{2}\hfill \\ \hfill {5}^{2}& =&
...
%     \parbox[t]{\mymathboxwidth}{\large$
%    
% {\mbox{CE}}^{2}={\mbox{DE}}^{2}+{\mbox{DC}}^{2}{5}^{2}={3}^{2}+{x}^{2}{x}^{2}
% =16x=4$}\hfill
%     \parbox[t]{48pt}{\raggedleft 
%     (13.4)}
%     \end{minipage}\vspace{12pt}\par
...
% triangles, 
% $\mbox{AC}=\mbox{CE}$)\par \end{enumerate}
%         
% 
% 
%     \end{exercise}
...
% \usefont{T1}{ptm}{m}{n}\par \raisebox{-5pt}
...
\nopagebreak
\Definition{Vierhoeke}{’n Vierhoek is ’n geslote vier-sydige figuur.}
\begin{center}
...
% \usefont{T1}{ppl}{m}{n}
\rput(5.9079685,2.264697){Vierhoek}
...
% \usefont{T1}{ppl}{m}{n}
\rput(6.215,-2.475303){ Reghoek}
% \usefont{T1}{ppl}{m}{n}
\rput(2.2095313,-2.415303){Vierkant}
% \usefont{T1}{ppl}{m}{n}
\rput{31.880966}(0.3867812,-1.5860298){\rput(2.9423437,-0.13530304){Rombus}}
% \usefont{T1}{ppl}{m}{n}
\rput(8.205,1.464697){Trapesium}
% \usefont{T1}{ppl}{m}{n}
\rput(0.615,2.084697){Vlie\"er}
\end{pspicture} 
}
...
{
\westep{Verbind $AC$ om $\triangle ABC$ en $\triangle CDA$}
...
\mbox{en }\hat{B} &=& \hat{D} & (\triangle ABC \equiv \triangle CDA) \\
 \end{array}
\end{equation*}
Teenoorstande hoeke van 'n parallelogram is ewe groot.
}
\end{wex}
...
\end{center}
\end{figure}       
’n Vierhoek is 'n parallelogram in elk van die volgende gevalle:
\begin{enumerate}[label=\textbf{\arabic*}.]
 \item As beide pare teenoorstaande sye parallel is.
 \item As beide pare teenoorstaande sye ewe lank is.
 \item As beide pare teenoorstaande hoeke ewe groot is.
 \item As die hoeklyne/diagonale mekaar halveer (d.w.s. as hulle mekaar in die helfte sny).
 \item As een paar teenoorstaande sye gelyk en ewewydig is.
\end{enumerate}
% \pagebreak%MANUAL PAGEBREAK TO SPLIT WEX BELOW

\begin{wex}{Bewys 'n vierhoek is 'n parallelogram}
{In vierhoek $WXYZ$, $\hat{W} = \hat{Y} = \hat{y}$ en $\hat{Z} = \hat{X} = \hat{x}$. bewys $WXYZ$ is 'n parallelogram.\\
\begin{center}
...
{ \westep{Kry die eerste paar teenoorstaande hoeke}
 In $WXYZ$ \\
\begin{equation*}
 \begin{array}{rcll}
...
\end{array}
\end{equation*}
Maar hulle is ko-binne $\angle$'e tussen lyne $WX$ en $ZY$. \\
Dus $WX \parallel ZY$ \\
\westep{Vind die ander paar teenoorstaande hoeke}
Soortgelyk $\hat{W} + \hat{X} = 180^\circ$. \\
Hulle is ook ko-binne $\angle$'e tussen $XY$ en $WZ$ \\
Dus $XY \parallel WZ$ \\ \newline
...
\westep{Gebruik die difinisie van 'n reghoek om alle gelyke hoeke en sye te merk op die diagram}
...
\subsection{Ruit}
\Definition{Ruit / rombus}{'n Ruit is 'n parallelogram waarvan al vier sye ewe lank is.}\par
...
TO\mbox{ is 'n gemeenskaplike sy} &&& \\
...
\westep{Gebruik kongruente driehoek om te bewys die hoeklyne halveer die hoeke} 
\begin{equation*}
 \begin{array}{rcll}
 \hat{X}_1 &=& \hat{Z}_1 & \mbox{($\triangle XTO \equiv \triangle ZTO$)} \\
\mbox{en }\hat{X}_1 &=& \hat{Z}_2 & \mbox{(verwisselende binne $\angle$'e, $XT \parallel YZ$)} \\
\therefore \hat{Z}_1 &=& \hat{Z}_2 & \\
 \end{array}

\end{equation*}
Dus, hoeklyn $XZ$ halweer $\hat{X}$. \\
\newline
Soortgelyk, kan ons aantoon $XY$ halveer $\hat{Z}$. \\
...
\begin{itemize}[noitemsep]
\item Opsomming van die eienskappe van 'n ruit
...
\subsection{Vierkant}
\Definition{Vierkant}{’n Vierkant is ’n rombus met al vier sye ewe lank en al vier hoeke gelyk aan 90$^{\circ }$.}
...
% }
% \end{wex}
'n Vierkant is 'n vierhoek met al die spesiale eienskappe: dit is die perfekte vierhoek:
...
\end{array}
\end{equation*}
Dus een paar teenoorstaande binnehoeke van 'n  vlie\"er is ewe lank $ABCD$.
\westep{Gebruik eienskappe van kongruente driehoeke om te bewys $AC$ halveer $\hat{A}$ en $\hat{C}$}
\begin{equation*}
 \begin{array}{rcll}
...
\begin{Ondersoek}{Ondersoek die volgende situasie deur die stappe te volg:}
\begin{center}
\scalebox{1} % Change this value to rescale the drawing.
{
...
\end{array}
\end{equation*}
maar hulle is verwisselende binnehoeke, dus $BD \parallel ubsection*FC$  \\ \newline
\begin{equation*}
 \begin{array}{rcll}
 BD &=& DA & \mbox{(gegee)} \\
BD &=& FC & \mbox{($\triangle EAD \equiv \triangle ECF$)} \\
\therefore BCFD \mbox{ is 'n parallelogram} & &&\mbox{(een paar teenoorstaande sye $=$ en $\parallel$)} \\
\end{array}
\end{equation*}
Dus $DE \parallel BC$ \\
...
Jy kan meetkunde en die eienskappe van poligone gebruik om die onbekende lengtes en hoeke in vierhoeke en driehoeke te vind.\\

\mindsetvid{conjectures, proofs and triangles}{VMckg}

\begin{wex}{Proving a parallelogram}
{
In parallelogram $ABCD$, is  die ($AW$, $BX$, $CY$ en $DZ$) die halveerlyne
van die hoeke, gekonstrueer. Jy word ook gegee $\mathrm{AB}=\mathrm{CD}$, $\mathrm{AD}=\mathrm{BC}$,
...
\westep{Bewys dat $MNOP$ die eienskappe van 'n parallelogram het.}
...
In $\triangle ABX$ en $\triangle CDZ$ & \\
\begin{equation*}
 \begin{array}{rcll}
D\hat{C}Z &=& B\hat{X} & \mbox{(gegee)} \\
\hat{D}_{1} &=& \hat{B}_{1} & \mbox{(gegee)} \\
DC &=& AD & \mbox{(given) }\\
\therefore \triangle ABX &\equiv& \triangle CDZ & \mbox{(HHS)} \\ 
\therefore AX &=& CZ  & 
 \end{array}
\end{equation*}
...
\begin{equation*}
 \begin{array}{rcll}
X\hat{A}M &=& Z\hat{C}C & \mbox{(gegee)} \\
A\hat{X}M &=& C\hat{Z}O & \mbox{(bewys)} \\
AX &=& CZ & \mbox{(bewys)} \\
\therefore \triangle XAM &\equiv& \triangle COS & \mbox{(HHS)} \\
\therefore \hat{Z}_{1} &=& \hat{M}_{1} & \\
\hat{M}_1 &=& \hat{M}_2 & \mbox{(regoorst. $\angle$'e)} \\
\hat{O}_{1} &=& \hat{O}_2 & \mbox{(regoorst. $\angle$'e)} \\
...
%  \end{array}
% \end{equation*}
Net so, kan ons aantoon $\hat{N}_2 = \hat{P}_2$. \\
Dus is $MNOP$ is 'n parallelogram (beide pare teenoorstaande hoeke is gelyk).
}
\end{wex}


\summary{VMdml}{Opsomming}
\begin{itemize}[noitemsep]
...
\item Vind hoeke $a$, $b$, $c$ en $d$ gee redes in elke geval:\\
\begin{tabular}{lm{4.5cm}lm{4.5cm}}
\textbf{(a)} & 
...
\item
$LMAO$ is 'n vierkant met $LM=LO$ en hoeklyne wat sny by $S$ sodat $MS=SO$. Bewys dat:
   \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
% \setcounter{enumi}{49}
...
%Challenge
\item
\textbf{uitdaging:} Gebruik die figuur hieronder en bewys dat die hoeke van 'n driehoek gelyk is aan 180$^{\circ }$. Lyn $DE$ is ewewydig aan $BC$.\\
\begin{center}
