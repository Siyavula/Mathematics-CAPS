...
\paragraph{Eksperiment 2} Twee dobbelstene word gerol en die aantal kolletjies gesommeer. 
...
\paragraph{Eksperiment 1} Gestel ons wil he die munstuk moet land met kruis bo. Hier het die gebeurtenis net een uitkoms, naamlik
\(E=\{\textrm{H}\}\), \(n(E)=1\).
...
\Definition{Waarskynlikheid}{'n Waarskynlikheid is 'n reeele getal tussen $0$ en $1$ wat beskryf hoe waarskynlik dit is dat die gebeuretenis sal plaasvind.}
\begin{itemize}
...
\begin{wex}{Venn diagrams}{
  Dui met behulp van 'n Venn-diagram die volgende aan:
  \begin{itemize}
  \item[] $A:$ Die som van die dobbelstene is geluk aan $8$
...
\Definition{Interseksie}{Die interseksie van twee versamelings is 'n nuwe versameling wat al die elemente bevat wat in beide versamelings voorkom. Die interseksie word geskryf as $A \cap B$.}
...
\begin{wex}{Vereniging en interseksie van gebeurtenisse}{
  Vergelyk die waarskynlikhede van gebeurtenisse $A$ and $B$ in die Voorbeeld \textbf{NNN} en toon aan dat die identiteit 
\[P(A \cup B) = P(A) + P(B) - P(A \cap B)\]
bevredig word.

}{
  \westep{Skryf die waarskynlikhede van die twee gebeurtenisse, hulle vereniging en hulle interseksie.}
...
% gmf
  ...
  \westep{Skryf die identiteit neer en gaan dit na.}
  \begin{eqnarray*}
    P(A \cup B) &=& P(A) + P(B) - P(A \cap B) \\
...
\Definition{Onderlinge uitsluitlike gebeurtenisse}{Twee gebeurtenisse is onderling uitlsluitlik indien hulle nie saam kan voorkom nie. Wanneer die uitkoms van 'n eksperiment in eerste gebeurtenis val, kan dit nie ook in die tweede gebeurtenis wees nie.}
...
Uit die figuur sien ons dat daar geen elemente in gemeen in $A$ and $B$ is nie. Die gebeurtenisse is dus onderling uitsluitlik.
}
\end{wex}

\section{Komplementere gebeurtenisse}

\Definition{Komplementere versameling}{Die komplement van 'n versameling, $A$, is 'n ander versameling wat al die elemente bevat wat nie in 
  $A$ is nie. Ons skryf die komplement van $A$ as $\complement{A}$, of soms ``$\textrm{not}(A)$''.}

Vir 'n eksperiment met 'n monsterruimte $S$ en 'n gebeurtenis $A$, kan ons sekere identiteite aflei vir komplementere gebeurtenisse. Aangesien elke element van $A$ nie in $\complement{A}$ voorkom nie, weet ons dat komplementere gebeurtenisse onderling uitsluitlik is.
...
\Identity{Komplementere gebeurtenisse omvat die monsterruimte.}{
...
\begin{wex}{Beredenering met Venn-diagramme}{
  ...
  \westep{Bepaal die groottes van die monsterruimte, die gebeurtenis-versamelings, hule vereniging en hulle interseksie.}
  \begin{itemize}
...
Aangesien die interseksie, $A \cap B$, nie leeg is nie, is die gebeurtenisse nie onderling uisluitend nie. Dit beteken dat hulle sirkels behoort te oorvleuel in die Venn-diagram.
  ...
  \westep{Teken die Venn-Draw the Venn diagram diagram en vul die syfers in}
    \begin{center}
      \begin{tikzpicture}
        \begin{scope}[scale=5]
...
\begin{eoexercises}{Waarskynlikheid}
  \begin{enumerate}[itemsep=5pt, label=\textbf{\arabic*}]
