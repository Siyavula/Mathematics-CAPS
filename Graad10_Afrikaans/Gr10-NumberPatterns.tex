...
>>>>>>> 3b3a321f1f806d4fc47320d668c1c9d8aeea1572
...
1;3;5;7;9;\ldots
\end{equation}
The ${n}^{\mathrm{de}}$ word gegee deur die formule
\begin{equation*}
...
\westep{Bereken die $12^{\mathrm{de}}$ term}
...
\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
\item Vind die $6^{\mathrm{de}}$ term vir die volgende reekse:
    \begin{enumerate}[noitemsep, label=\textbf{\alph*}. ] 
