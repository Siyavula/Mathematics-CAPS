...
\begin{multicols}{2}
      \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ] 
    \item $(0;1)$ and $(-1;0)$; toenemend%$y=x+1$
      \item $(0;-1)$ and $(1;0)$; toenemend%$y=x-1$
      \item $(0;-1)$ and $(\frac{1}{2};0)$; toenemend%$h(x)=2x-1$
      \item $(0;1)$ and $(\frac{1}{3};0)$; afnemend%$y+1=2x$
      \item $(0;2)$ and $(-3;0)$; toenemend%$3y-2x=6$
      \item $(0;3)$; horizontal line%$k(x)=-3$
      \item $(0;0)$; toenemend%$x=3y$
      \item $(0;3)$ and $(2;0)$; afnemend%$\frac{x}{2} - \frac{y}{3} = 1$
      \end{enumerate}
\end{multicols}
...
\item $y= \frac{1}{2}^{x}$ is represented by the equation $y=2^{-x}$ because $\frac{1}{2}^{-1} = 2^{-1}$, which gives $y = 2^{-x}$. %Which graph is represented by the equation  ? Explain your answer.
...
%lots of english
 \item Skets die grafieke van die volgende trigonometriese funksies as
    $\theta \in[~0^{\circ};360^{\circ}]$. Wys afsnitte en asimptotes.
    ...
    \end{enumerate}
  \item As die algemene vergelykings $y=mx+c$, $y=ax^2+q$, $y=\frac{a}{x}+q$, $y=a~sin~x+q$, $y=a^x +q$ en $y=a~tan~x$ gegewe is, bereken die spesifieke vergelykings vir elkeen van die volgende grafieke
\vspace{20pt}\\
    \begin{center}
      \begin{table}[H]
...
$g(x) = -2(3)+6 = 0\\
g(x) = -2(-2)+6=10\\$
Therefore the points of intersection are $(3;0)$ and $(-2;10)$%Calculate the points of intersection of $f$ and $g$.
