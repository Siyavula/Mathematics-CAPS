...
Oplos van lineêre vergelykings (aanvaar alle nomers is nie nul nie): \\
\begin{multicols}{2}
...
\therefore 0y=-60\\$
No solution\\
$(y_1 = \frac{1}{2}x - 11$ en $y_2 = \frac{1}{2}x + 4$. These lines have the same gradient therefore they are parallel and will never intersect - hence there is no solution.)
\end{enumerate}
\item
\begin{enumerate}[itemsep=5pt,label=\textbf{(\alph*)}]
\item 
