...
% \rput(2.973594,1.4596876){$U$}
    \end{pspicture} \begin{enumerate}[label=\textbf{\arabic*}.]
...
% \usefont{T1}{ptm}{m}{n}
\rput(4.655156,0.5834375){$116$}\begin{enumerate}[noitemsep,label=\textbf{\arabic*}. ] 
\item 
Bereken die onbekende veranderlikes in elk van die volgende figure. 
\begin{center}
\scalebox{1} % Change this value to rescale the drawing.
...
% \usefont{T1}{ptm}{m}{n}
\rput(0.97375,1.7907813){$A$}\begin{enumerate}[noitemsep,label=\textbf{\arabic*}. ] 
\item 
