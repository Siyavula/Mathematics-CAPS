...
m_{RQ} = \frac{7 - 0}{8 - 7}\\
 = \frac{7}{1}\\
m_{PR} \times m_{RQ} = -\frac{1}{7} \frac{7}{1}\\
 = -1\\
\text{therefore } P\hat{Q}R = 90^{\circ}\\
\text{Length}_{PQ} = \sqrt{(1-8)^2 + (8 -7)^2}\\
 = \sqrt{49 + 1}\\
 = \sqrt{50}\\
\text{Length}_{RQ} = \sqrt{(8-7)^2 + (7 - 0)^2}\\
 = \sqrt{1 + 49}\\
 = \sqrt{50}\\
\text{Therefore } PQ = RQ$\\
Therefore $\triangle PQR$ is a rightangled, isosceles triangle.
\item %solution12
\scalebox{.4} % Change this value to rescale the drawing.
{
