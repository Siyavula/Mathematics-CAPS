...
%6
\item
We first need to construct the loodregte hoogte. If we do this such that we divide the basis in half we get:\\
$h^2 = 3^2 + 5^2 \\
h = \sqrt{34}\\
h = 5,83 \mbox{ cm}\\
A = \frac{1}{2}\mbox{basis} \times \mbox{hoogte}\\
...
A = 17,5 \mbox{ cm}^{2}$
%7
\item Once again we construct the loodregte hoogte. If we do this such that we divide the basis in half we get:\\
$h^2 = 10^2 + 5^2 \\
h = \sqrt{125}\\
h = 11,18 \mbox{ cm}\\
A = \frac{1}{2}\mbox{basis} \times \mbox{hoogte}\\
...
\mbox{Groot reghoek} + 2 \times \mbox{(klein reghoek)} = 204 + 140 = 344 ~cm^2$
  \item $\mbox{Oppervlak van groot reghoek} = \mbox{circumference van sirkel} \times \mbox{lengte}\\
= 2 \pi \times r \times l \\
= 2 \pi \times (5) \times 10 \\
= 314,16$ cm$^2 \\
...
= (4~$m$ \times 3~$m$) + 2(4~$m$ \times 2,5~$m$) + 2(3~$m$ \times 2,5~$m$)\\
= 12~$m$^2 + 20~$m$^2 + 15~$m$^2 \\
= 47~$m$^{2}$\\
The painter will need $\frac{47}{2} = 24$ litres of paint (rounded up to the nearest litre).
  \item We first need to work out r:\\
$r = \frac{4}{2} = 2~$m
$\mbox{Buite-oppervlak} = \mbox{oppervlak van bottom van reservoir} + \mbox{oppervlak van inside van reservoir}\\
= (\pi r^2) + (\mbox{circumference van basis} \times \mbox{hoogte van reservoir})\\ 
= (\pi (2)^2) + (2 (\pi) (2) \times 2,5~$m$)\\
= 43,98~$m\\
The painter will need $\frac{44}{2} = 22$ litres of paint (rounded up to the nearest litre).
      \end{enumerate}
\end{enumerate}}
\end{solutions}
...
\begin{exercises}{}{
Bereken die volume van die volgende prismas (korrek tot $1$ desimale plek):
\begin{center}
...
= 4~188,79~$cm$^{3}$
      \end{enumerate}
\item $\mbox{Volume} = \mbox{volume van cube} + \mbox{volume van vierkantige piramide}\\
= (5 \times 5 \times 5) + \frac{1}{3}(5 \times 5 \times (11-5))\\
= 175 ~$cm$^{3}$\\
$\mbox{Buite-oppervlak} = 5(\mbox{kante van cube}) + 4(\mbox{driehoek faces van piramide})\\
...
new volume = oppervlak van basis $\times 2 \times$ hoogte \\
Therefore, the new volume is twice as much as the old volume if the hoogte is doubled. 
\item \begin{enumerate}[itemsep=5pt, label=\textbf{(\alph*)}]
