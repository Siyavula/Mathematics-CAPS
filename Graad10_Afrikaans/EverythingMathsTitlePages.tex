...
\makebox(6cm,0){\rotatebox{45}{\textcolor[gray]{0.75}%
...
\begin{flushleft} \textbf{\huge Outeurs Lys }\end{flushleft}
...
\textbf{\LARGE Oorsponklike Free High School Science Texts kern span}\\

Mark Horner; Samuel Halliday; Sarah Blyth; Rory Adams; Spencer Wheaton \par 


\textbf{\LARGE Oorspronklike Free High School Science Texts outeurs}\\
