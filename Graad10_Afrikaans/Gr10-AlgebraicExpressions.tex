...
\fancyfoot[LO,RE]{Focus Area: Wiskunde}
...
$ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} {(subsection shortcode: MG10035 )} \par 
...
\nopagebreak
 $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} {(subsection shortcode: MG10036 )} \par 
...
\nopagebreak
 $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} {(subsection shortcode: MG10037 )} \par 
Alle heelgetalle en heeltallige kwosiënte is rasionaal. Daar is twee bykomende vorme van rasionale getalle.\par 




\begin{Aktiwiteit}{Desimale getalle}
\nopagebreak
...
\subsection*{Omskakeling van repeterende desimale na rasionale getalle}
 ...
 $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} {(subsection shortcode: MG10039 )} \par 
...
\setcounter{subfigure}{1}
 ...
 $ \hspace{-5pt}\begin{array}{cccccccccccc}   \end{array} $ \hspace{2 pt}\raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} {(subsection shortcode: MG10055 )} \par 
...
\Definition{Irrasionale getalle}{Irrasionale getalle is getalle wat nie as ’n breuk met ’n heeltallige teller en noemer geskryf kan word nie. Dit
...
\Tip{Wanneer irrasionale getalle in desimaalnotasie geskryf word, het hulle ’n oneindige aantal desimale syfers wat nooit herhaal nie. \\Die vierkantswortels van non-vierkante en die derde-magswortels van non-derdemagte is almal irrasionaal.}
...
\westep{Kyk na die volgende syfer on te sien of jy boontoe of ondertoe moet afrond}
\begin{enumerate}[itemsep=5pt, label=\textbf{\arabic*}. ]
...
\westep{Gebruik die volkome vierkant on die hoer heelgetal te skat}
${6}^{2}=36$. 
...
\westep{Gebruik volkome derdemagte om die hoer heelgetal te skat} ${4}^{3}=64$, daarom $\sqrt[3]{49}\lessthan{}4$. 

\westep{Die antwoord is}
$3\lessthan{}\sqrt[3]{49}\lessthan{}4$

\westep{Kontroleer die antwoord deur al die getalle in die ongelykheld tot die derde mag te verhef en vereenvoudig dan}
...
\westep{Gebruik 'n omnuilings tegniek om die gemene faktoor te vind in hierdie geval. let op dat $2-a = -(a-2)$ }
\begin{equation*}
\begin{array}{ccl}
...
\Tip{Om te faktoriseer, kyk vir uitdrukkings
\begin{itemize}
...
\end{equation*}
\Tip{
 As $c$ positief is, moet albei die faktore van $c$ positief of albei negatief wees. Die faktore is beide negatief indien $b$ negatief is, en beide positief indien $b$ positief is. As $c$ negatief is, beteken dit slegs een van die faktore van $c$ is negatief, en die ander een is positief. Wanneer jy ’n antwoord gekry het, brei weer jou hakies uit om te toets of dit reg uitwerk.
}
...
\westep{Groepeer termer met gemene faktore saam}$x$ is 'n gemene faktor van die eerste en derde terme en $2y$ is 'n gemene faktor van die tweede en vierde terme $(7:b~=~14:2b)$.\par 
\westep{Herrangskik die uitdrukking met}
...
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Vind die antwoord met kortkodes:
\par \begin{tabular}[h]{cccccc}
...
\Note{Om te deel deur 'n breuk is dieselfde as om te vermenigvuldig met die resiprook }
\In In sommige gevalle van die vereenvoudiging van ’n algebraïese uitdrukking, sal die uitdrukking ’n breuk wees. Byvoorbeeld,\par 
\
\begin{equation*}
\dfrac{{x}^{2}+3x}{x+3}
\end{equation*}
\het het ’n tweeterm in die noemer en ’n kwadratiese tweeterm in die teller. Jy kan die verskillende metodes van faktorisering gebruik om die uitdrukking te vereenvoudig.\par 
\
\begin{equation*}
...
\westep{Gebruik groepering vir die teller en haal ’n gemene faktor van $ax$ uit in.}\par 
...
\end{equation*}
\westep{Verander delling na vermenigvuldig met die resipook}
...
\end{equation*}
\westep{Maak al die noemers dieselfde soda die breuke kan opgestel en afgetrek word} Die kleinste gemene noemer is $(x-2)(x+2)$.\par 
...
(aanvaar alle noemers is non-zero)}
{
\westep{Fakotoriseer die noemer en die teller}
\begin{equation*}
\dfrac{2}{x(x-1)}+ \dfrac{({x}^{2} + x + 1)}{(x-1)(x^{2}+x+1)}-\dfrac{x}{(x-1)(x+1)}
\end{equation*}
\westep{Vereenvoudig delling na vermenigvuldig met die resipook} 
\begin{equation*}
