...
\end{equation*}
Jy kan sien dat al die tellers en noemers heelgetalle is. Dit beteken dat alle heelgetalle rasionaal is, aangesien hulle geskryf kan word met ’n noemer van $1$.\par 
% Dus is
% 
% \begin{equation*}
...
%english
A monomial is an expression with one term, for example, $3x$ or $y^2$. ’n Binomiaal is ’n wiskundige uitdrukking met twee terme, soos $ax+b$ and $cx+d$.
