...
\item% If $a$ is an integer, $b$ is an integer en $c$ is irrational, which of the following are rational numbers?
    \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ] 
    \item Rasionele%$\dfrac{-b}{a}$
    \item Irrasionele%$c \div c$
    \item Irrasionele%$\dfrac{a}{c}$
    \item Irrasionele%$\dfrac{1}{c}$
    \end{enumerate}
...
\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
\item$t = 2$ hrs %Two jets are flying towards each other from airports that are $1~200$ km apart. One jet is flying at $250$ km/h en the other jet at $350$ km/h. If they took off at the same time, how long will it take for the jets to pass each other?
...
\item Sam is $7$ en Mark is $35$ %Mark is now five times as old as his son Sam. In seven years from now, Mark will be three times as old as his son. Find their ages now.    
\end{enumerate}
...
\item %Determine whether the following statements are true of false. If the statement is false, give reasons why:
  \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
   \item F%The given of chosen $y$-value is known as the independent variable.
    ...
    \item T%Given a function of the form $y=ax+q$, to find the $y$-intercept let $x=0$ en solve for $y$.
    \end{enumerate}
...
\item $(3;0)$ en $(-2;10)$%Calculate the points of intersection of $f$ en $g$.
...
\item Ne% Do the diagonals of $FGHI$ bisect each other?
\item Normale vierhoek% Can you state what type of quadrilateral $FGHI$ is? Give reasons for your answer.
\end{enumerate}
...
% 		  \item %Find a set for the event, $N$, of drawing a numbered card.
    ...
    \item Wedersyds eksklusiewe en aanvullende
...
\item %Consider the solids below en answer the questions that follow (correct to one decimal place, if necessary):
      \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
	  \item Silinder$ = 352$ cm$^2$\\  Dh prisma$= 384$ cm$^2$\\Vh prisma$ = 72$ cm$^2$%%Calculate the surface area of each solid.
	  \item Silinder$ = 502$ cm$^3$\\ Dh prisma $= 240$ cm$^3$\\Vh prisma$ = 40$ cm$^3$ %Calculate volume of each solid.
\item Sil$=3166,7$ cm$^2$\\ Dh prisma $=3~456$ cm$^2$\\Vh prisma$=684$ cm$^2$%If each dimension of the solid is increased by a factor of $3$, calculate the new surface area of each solid.
\item Sil$=13571,9$ cm$^3$\\ Dh prisma $=6~480$ cm$^3$\\Vh prisma $=1~080$ cm$^3$ %If each dimension of the solid is increased by a factor of $3$, calculate the new volume of each solid.
      \end{enumerate}
\item %Consider the solids below:
      \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
      % \setcounter{enumi}{4}
	  \item Konus$= 225$ cm$^2$\\R piramide$= 585$ cm$^2$\\Halwe sfeer$= 100$ cm$^2$%Calculate the surface area of each solid.
	  \item Konus$ = 94$ cm$^3$\\R piramide$= 900$ cm$^3$ \\Halwe sfeer$= 134$ cm$^3$ %Calculate the volume of each solid.
      \end{enumerate}
\item Volume$=335~103,2$ cm$^3$ Oprvlk$=35~185,9$ cm$^2$%Calculate the volume en surface area of the solid below (correct to $1$ decimal place):
\end{enumerate}
\end{multicols}
