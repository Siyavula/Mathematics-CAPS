...
Trigonometrie (uitgespreek tri-go-no-me-trie) handel oor die verwantskappe tusen die hoeke en die sye van 'n reghoekige driehoek. Ons sal leer van trigonometriese funksies wat die basis vorm van trigonometrie.\par 
...
\end{figure}   
\par 
Nou is dit moontlik om die verhoudings af te lei tussen ooreenkomstige sye van die twee gelykvormige driehoeke:\par 
...
In die reghoekige driehoek vrewys ons na die lengtes van die sye na gelang van hulle plasing in verhouding met die hoek $\theta $. Die sy oorkant die regte hoek is die skuinssy, die sy oorkant $\theta $ is die teenoorstaande sy en die sy naas $\theta $ is die aanliggende sy.
Let op dat die keuse van die nie-$90^{\circ}$ binnehoek arbitrer is. Jy kan enige van die binnehoeke kies en dan die aanliggende en teenoorstaande sy definieer. Die skuinssy bly egter die skuinssy ongeag die binnehoek van belang (omdat dit ALTYD oorkant die regte hoek is en ALTYD die langste sy).\par 
...
Hierdie verhoudings, ook bekend as die trigonometriese identiteite, bepaal die verhoudings van die lengtes van 'n driehoek se sye tot sy binnehoeke.\par 
...
You may also hear people saying ``Soh Cah Toa''. This is a mnemonic technique for remembering die trigonometric ratios:\par 
...
\Tip{Die definisies van teenoorstaande, aanliggend en skuinssy is net van toepassing wanneer mens met 'n reghoekige driehoek werk! Bevestig telkens dat jou driehoek 'n regte hoek bevat alvorens jy die verhoudings gebruik, anders kry jy die verkeerde antwoord.}

\begin{activity}{Sakrekenaarwerk}

Dit is baie belangrik dat jy vertroud is met jou sakrekenaar se trigonometrie-knoppies en hoe hulle werk. \\
...
\begin{wex}{Gebruik van jou sakrekenaar}
...
\end{wex}
\Note{Die meeste wetenskaplike sakrekenaars is naastenby dieselfde maar hierdie stappe mag verskil afhangende van die sakrekenaar wat jy gebruik. Maak seker jou sakrekenaar is in 'degrees' mode. }

\begin{wex}
{Sakrekenaarwerk}
{As $x=25^{\circ}$ en $y=65^{\circ}$ is, gebruik jousakrekenaar om te bepaal of die volgende stelling waar of vals is:
\begin{equation*}
sin^{2}~x + cos^{2}~(90^{\circ}-y) = 1
\end{equation*}
}
{
\westep{Bereken die linkerkant van die vergelyking}
...
Onthou dat die lengtes van 'n reghoekige driehoek die Teorema van Pythagoras moet bevredig: die vierkant van die skuinssy is gelyk aan die som van die vierkante van die ander twee sye.\par 
...
\item gebruik die volgende tabel om aan te dui dat:
...
\item Gebruik die definisies van die trigonometriese verhoudings om die volgende vrae te antwoord:
\begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
% \setcounter{enumi}{6}
...
Elk van die drie trigonometriese funksies het 'n omgekeerde. Die omgekeerdes cosecant, secant and cotangens word soos volg gedefinieer:
...
\end{array}
\end{equation*}
\section{Oplossing van trigonometriese vergelykings}
...
{
\westep{Identifiseer die teenoorstaande sy en die aanliggende sy}
\begin{equation*}
\begin{array}{ccl}
...
Die volgende videos gee 'n opsomming van wat jy tot nou toe geleer het.
\setcounter{subfigure}{0}
...
\end{center}
    ...
    \end{enumerate}
\vspace{10pt}
\item In $\triangle MNP$, $\hat{N}=90^{\circ}$, $MP=20$ en $\hat{P}=40^{\circ}$. Bereken $NP$ en $MN$ (korrek tot $2$ desimale plekke).
\end{enumerate}

\par 

\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Vind die antwoorde met die kort kodes:
...
\westep{Identifiseer die teenoorstaande- en aanliggende sye en die skuinssy}
...
\begin{wex}{Die vlieg van 'n vlieer}
{Mandla vlieg 'n vlieer aan 'n $17~$m lyn teen 'n skuinste van $63^{\circ}$.
\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
 \item Wat is die hoogte ($h$) van die vlieer bo die grond?
\item As Mandla se vriend Sipho direk onder die vlieer staan, bereken die afstand ($d$) tussen die twee vriende. 
\end{enumerate}
}
{
\westep{Teken 'n skets en identifiseer die teenoorstaande sy, die aanliggende sy en die skuinssy}
\begin{center}
\scalebox{1} % Change this value to rescale die drawing.
{
\scalebox{1} % Change this value to rescale die drawing.
...
\westep{Gebruik die gegewens en toepaslike verhoudings om op te los vir $h$ and $d$}
\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
\item
\begin{equation*}
 \begin{array}{ccl}
...
\end{equation*}
\end{enumerate}
Let op dat die derde sy van die driehoek ook bereken kan word deur die Teorema van Pythagoras: $d^{2} = 17^{2} - h^{2}$.

\westep{Skryf die finale antwoord neer}
\begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
\item Die vlieer is $15,15$ m bo die grond.
...
\westep{Vind die eerst hoek $A\hat{B}E$}
...
\westep{Gebruik die Teorema van Pythagoras om $EC$ te bepaal}
In $\triangle ABE$, \\
\begin{equation*}
\begin{array}{ccl}
...
Die diagram gegewe toon 'n gebou van onbekende hoogte $h$. As ons $(Q)$ $100$ m wegstap en die hoek meet van die grond na die toppunt van die gebou $(T)$, vind ons die hoek is $38,{7}^{\circ }$. Hierdie word genoem die elevasiehoek.\\
...
{
\westep{Identifiseer die teenoorstaande-, aanliggende- en die skuinssy}
...
\begin{wex}{Elevasie-en depressiehoeke}
{'n Woonstelblok is $200$ m weg van 'n selfoontoring. Iemand staan by $B$. Sy meet die hoek van $B$ na die top van die toring $E$ en vind dit is $34^{\circ}$ (die elevasiehoek). Sy meet dan die hoek vanaf $B$ na die onderpunt van die toring $C$ en vind dit is $62^{\circ}$ (die depressiehoek.)
...
$\triangle BDE$ en $\triangle BDC$ is beide reghoekige driehoeke. In elk van die driehoeke is die lengte $BD$ bekend, dus kan ons die sye van die driehoeke bereken.
...
\westep{Sommeer die twee hoogtes om die finale antwoord te kry} 
...
\begin{wex}{Gebouplan}
{Mnr Nkosi het 'n motorhuis by sy huis en hy besluit om 'n afdak aan te bou aan die kant van die motorhuis. Die motorhuis is $4$ m hoog en sy plaat vir die dak is $5$ m lank. As die hoek van die dak $5^\circ$ is, hoe hoog moet hy die muur $BD$ bou? Gee die antwoord korrek tot $1$ desimale plek.
\\
\begin{center}
...
\westep{Identifiseer die teenoorstande sy, die aanliggende sy en die skuinssy}
...
\item 'n Seun wat 'n vlieer vlieg staan $30~$m vanaf 'n punt direk onder die vlieer. As die vlieer se tou $50~$m lank is, vind die elevasiehoek van die vlieer.
\item Wat is die elevasiehoek van die son as 'n boom wat $7,15$ m hoog is 'n skaduwee van $10,1$ m het?
\item Susan is $1,4$ m lank. Vanaf 'n afstand van $300$ m kyk sy op na die bopunt van 'n vuurtoring. die elevasiehoek is $5^{\circ}$. Bepaal die hoogte van die vuurtoring tot die naaste meter.
...
\par \raisebox{-5 pt}{\includegraphics[width=0.5cm]{col11306.imgs/summary_www.png}} Vind die antwoorde met die kortkodes:
\par \begin{tabular}[h]{cccccc}
...
Ons het trigonometriese verhoudings gedefinieer deur reghoekige driehoeke te gebruik. Ons kan hierdie definisies uitbrei na enige hoek, deur daarop te let dat die definisies nie afhanklik is van die lengte van die sye van 'n driehoek nie, maar wel net afhanklik van die grootte van die hoek. As ons dus enige punt op 'n Cartesiese vlak plot en 'n lyn trek vanaf die oorsprong na daardie punt kan ons die hoek van die lyn bereken. In die figuur hieronder is punte $P$ and $Q$ reeds geplot. 'n Lyn word getrek vanaf die oorsprong na elke punt. Die stippellyne wys hoe ons reghoekige driehoeke vir elke punt kan konstrueer. Die stippellyn moet altyd na die $x$-as getrek word. Nou kan ons hoeke $A$ and $B$ vind. Ons kan ook die definisies van die omgekeerdes op dieselfde manier uitbrei:
...
Uit die ko-ordinate $Q(-2;3)$ weet ons die lengte van die sy oorkant $\hat{x}$ is $3$ en die lengte van die aanliggende sy is $2$. Deur $tan~\hat{x}=\frac{\mbox{\footnotesize teenoorstaande}}{\mbox{\footnotesize aanliggend}} = \frac{3}{2}$ bereken ons $\hat{x}=56,3^{\circ}$.
\\Dus $\hat{B}=180^{\circ} - \hat{x} = 123,7^{\circ}$.\par

Soortgelyk, 'n alternatiewe metode is om die skuinssy te bereken deur die Teorema van Pythagoras ete bereken, dan $\hat{x}$ using $sin~\hat{x} = \frac{\mbox{\footnotesize teenoorstaande}}{\mbox{\footnotesize skuins}}$ or $cos~\hat{x} = \frac{\mbox{\footnotesize aanliggend}}{\mbox{\footnotesize skuins}}$ te gebruik. \par
Sou ons 'n sirkel trek, gesentreerd om die oorsprong $(0)$ en deur punt $P$, dan is die lengte van die oorsprong tot by punt $P$ die radius van die sirkel, wat ons aandui met $r$. Ons kan al die trigonometriese funksies dan herskryf in terme van $x$, $y$ and $r$.
...
Die karetesies vlak is verdeel in $4$ kwadrante in 'n anti-klokse rigting soos aangedui in die diagram hieronde. Let daarop dat $r$ altyd positief i, maar dat die waardes van $x$ en $y$ verander afhangende van die posisie van die punt op die Cartesiese vlak. As 'n resultaat kan die trigonometriese 
...
{
\westep{Skets punt point $P$ in die Cartesiese vlak en merk dit $\theta$} 
\begin{center}
\scalebox{1} % Change this value to rescale die drawing.
{
...
\begin{wex}{Verhoudings in die Cartesiese vlak}{
$X\hat{O}K = \theta$ is 'n hoek in die derde kwadrant en $K$ is die punt $(-5;y)$. $OK$ is $13$ eenhede. Bepaal sonder 'n rekenaar:
  \begin{enumerate}[noitemsep, label=\textbf{\arabic*}. ] 
   \item Die waarde van $y$
...
\Tip{Maak altyd 'n skets wanneer jy trigonometriese probleme sonder 'n rekenaar moet oplos.}

\begin{exercises}{}
{
  \begin{enumerate}[itemsep=5pt, label=\textbf{\arabic*}. ]
   \item $B$ is a punt in die Cartesiese vlak. Bepaal sonder 'n rekenaar:
% \begin{center}
% \scalebox{1} % Change this value to rescale die drawing.
% {
% \begin{pspicture}(0,-3.1584375)(6.44125,3.1984375)
...
\item As $sin~\theta= 0,4$ en $\theta$ is 'n stomp hoek, bepaal:
% \begin{center}
% \scalebox{1} % Change this value to rescale die drawing.
% {
% \begin{pspicture}(0,-3.1584375)(6.44125,3.1984375)
...
\item Vir sekere spesiale hoeke kan ons die waardes van $sin$, $cos$ and $tan$ maklik bepaal sonder 'n rekenaar.
\item Ons kan die definisies van die trigonometriese funksies uitbrei na enige hoek.
\item Trigonometrie word gebruik om probleme in twee dimensies op te los, soos om die hoogte van 'n gebou te bepaal.
\end{itemize}
...
\item As $3~tan~\alpha = -5$ en $0^{\circ} < \alpha < 270^{\circ}$, gebruik 'n skets om te bepaal:
    ...
    \end{enumerate}
\item Los op vir $\theta$ as $\theta$ 'n positiewe skerp hoek is:
    \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
...
\item Bereken die onbekende lengtes in die diagramme hieronder:
\begin{center}
\scalebox{1}  
{ 
...
\end{enumerate} 
\item 'n leer met lengte $15$ m rus teen 'n muur. Die voet van die leer is $5$ m from die wall. Vind die hoek tussen die muur en die leer.
\item In die volgende driehoek, vind die hoek $A\hat{B}C$:
\begin{center}
...
\end{pspicture}
\end{center} 
\item $A(5;0)$ en $B(11;4)$. Vind die hoek tussen die lyn deur $A$ en $B$ en die $x$-as. 
...
\begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
\item Vind die kante van die rombus. 
\item Vind die lengte van beide diagonale. 
\end{enumerate} 
\item Kaptein Jack seil na 'n krans met 'n hoogte van $10$ m. 
\begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ] 
\item As die afstand vanaf die boot na die bokant van die krans $30$ m is, bereken die elevaasiehoek vanaf die boot na die bokant van die krans (korrek tot tot die naaste heelgetal).
\item As die boat $7$ m nader aan die krans seil, wat is die nuwe elevasiehoek vanaf die boot na die bokant van die krans? 
\end{enumerate} 
