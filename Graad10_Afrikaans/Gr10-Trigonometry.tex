...
\begin{Ondersoek}{Verhoudings van gelykvormige driehoeke}
...
\aput{:U}{teenoorstaande / opposite}
\pcline[linestyle=none](B)(C)
\aput{:U}{skuinssy / hypotenuse}
\pcline[linestyle=none](A)(C)
\bput{:U}{aangrensend / adjacent}
\end{pspicture}
\end{center}
\end{figure}       
\par 
...
In die reghoekige driehoek vrewys ons na die lengtes van die sye na gelang van hulle plasing in verhouding tot met die hoek $\theta $. Die sy oorkant die regte hoek is die skuinssy, die sy oorkant $\theta $ is die teenoorstaande sy en die sy naas $\theta $ is die aanliggende of aangrensende sy.
...
Hierdie verhoudings, ook bekend as die trigonometriese definisies, bepaal die verhoudings van die lengtes van 'n driehoek se sye tot sy binnehoeke.\par 
...
\Tip{Die definisies van teenoorstaande, aangrensend en skuinssy is net van toepassing wanneer mens met 'n reghoekige driehoek werk! Bevestig telkens dat jou driehoek 'n regte hoek bevat alvorens jy die verhoudings gebruik, anders kry jy die verkeerde antwoord.}

\begin{aktiwiteit}{Sakrekenaarwerk}
...
\end{center}
Uit die ko-ordinate van $P(2;3)$ weet ons dat die lengte van die sy oorkant $\alpha}$ $3$ is en die lengte van dei aanliggende sy $2$. Deur $tan~\alpha=\frac{\mbox{\footnotesize teenoorstaande}}{\mbox{\footnotesize aanliggend}} = \frac{3}{2}$ te gebruik, bvereken ons dat $\alpha=56,3^{\circ}$ is.\par

Ons kan ook die Teorema van Pythagoras gebruik om die skuinssy van die driehoek te bereken, dan $\alpha$ bereken deur $sin~\alpha = \frac{\mbox{\footnotesize teenoorstaande}}{\mbox{\footnotesize skuins}}$ or $cos~\alpha = \frac{\mbox{\footnotesize aangresend}}{\mbox{\footnotesize skuins}}$\par
Beskou punt $Q(-2;3)$. Ons definieer $\beta}$ as die hoek tussen die lyn $OQ$ en die positiewe $x$-axis. Hierdie word die standaard hoekposisie genoem. Laat $\theta$ die hoek wees tussen lyn $OQ$ en die negatiewe $X$-as sodat $\beta + \theta = 180^{\circ}$.
\par

Uit die ko-ordinate $Q(-2;3)$ weet ons die lengte van die sy oorkant $\theta$ is $3$ en die lengte van die aanliggende sy is $2$. Deur $tan~\theta=\frac{\mbox{\footnotesize teenoorstaande}}{\mbox{\footnotesize aangesend}} = \frac{3}{2}$ bereken ons $\theta=56,3^{\circ}$.
...
\end{center}
\westep{Gebriuk Pythagoras om $y$ te bereken}
\begin{equation*}
 \begin{array}{ccl}
    \hfill r^{2} &= & x^{2} + y^{2} \hfill \\
...
\Tip{Maak altyd 'n skets wanneer jy trigonometriese probleme sonder 'n sakrekenaar moet oplos.}
