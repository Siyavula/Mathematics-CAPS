...
Beskou punt $Q(-2;3)$. Ons definieer $\hat{B}$ as die hoek tussen die lyn $OQ$ en die positiewe $x$-as. Hierdie word die standaard hoekposisie genoem. Laat $\hat{\alpha}$ die hoek wees tussen lyn $OQ$ en die negatiewe $x$-as sodat $\hat{B} + \hat{\alpha} = 180^{\circ}$.
\par
...
'n Alternatiewe metode is om die skuinssy te bereken deur die stelling van Pythagoras bereken, en dan $\alpha$ deur $sin~\alpha = \frac{\mbox{\footnotesize teenoorstaande sy}}{\mbox{\footnotesize skuinssy}}$ of $cos~\alpha = \frac{\mbox{\footnotesize aangrensende sy}}{\mbox{\footnotesize skuinssy}}$ te gebruik. \par
