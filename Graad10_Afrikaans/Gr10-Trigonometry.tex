...
\end{center}
\end{center}
Uit die ko-ordinate van $P(2;3)$ weet ons dat die lengte van die sy oorkant $\hat{A}$ $3$ is en die lengte van dei aangrensende sy $2$. Deur $tan~\hat{A}=\frac{\mbox{\footnotesize teenoorstaand}}{\mbox{\footnotesize aangrensend}} = \frac{3}{2}$ te gebruik, bvereken ons dat $\hat{A}=56,3^{\circ}$ is.\par



Ons kan ook die Teorema van Pythagoras gebruik om die skuinssy van die driehoek te bereken, dan $\hat{A}$ bereken deur $sin~\hat{A} = \frac{\mbox{\footnotesize teenoorstaand}}{\mbox{\footnotesize skuinssy}}$ or $cos~\hat{A} = \frac{\mbox{\footnotesize aangrensend}}{\mbox{\footnotesize skuinssy}}$\par
...
Uit die ko-ordinate $Q(-2;3)$ weet ons die lengte van die sy oorkant $\hat{x}$ is $3$ en die lengte van die aangrensende sy is $2$. Deur $tan~\hat{x}=\frac{\mbox{\footnotesize teenoorstaand}}{\mbox{\footnotesize aangrensend}} = \frac{3}{2}$ bereken ons $\hat{x}=56,3^{\circ}$.
\\Dus $\beta=180^{\circ} - \theta = 123,7^{\circ}$.\par

'n Alternatiewe metode is om die skuinssy te bereken deur die stelling van Pythagoras bereken, en dan $x$ deur $sin~x = \frac{\mbox{\footnotesize teenoorstaand}}{\mbox{\footnotesize skuinssy}}$ of $cos~x = \frac{\mbox{\footnotesize aangrensend}}{\mbox{\footnotesize skuinssy}}$ te gebruik. \par
...
Waneer ons in die Cartesiese vlak werk, sluit ons twee ander spesiale hoeke in reghoekige driehoeke in:  $0^{\circ}$ en $90^{\circ}$. Hierdie is spesiaa; omdat ons nie gewoonlik 'n hoek van $0^{\circ}$ of nof 'n hoek van $90^{\circ}$ kan hê nie.

Let op dat as $\theta = 0^{\circ}$, die lengte van die teenoorstaande sy gelyk aan $0$  is, dus
\begin{equation*}
  sin~ 0^{\circ} =
...
As $\theta = 90^{\circ}$, die lengte van die aangrensende sy gelyk aan $0$ is, dus
\begin{equation*}
  cos~ 90^{\circ} =
  \dfrac{\mbox{\footnotesize aangrensend }}{\mbox{\footnotesize skuinssy}} =
  \dfrac{0}{\mbox{\footnotesize skuinssy}} =
  0.
\end{equation*}
