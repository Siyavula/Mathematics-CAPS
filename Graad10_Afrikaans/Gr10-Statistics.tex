...
Wanneer ons 'n eksperiment uitvoer of 'n opname maak, kan on potensieel met duisende of selfs miljoene waardes in die resulterende datastel sit. Te veel data kan oorweldigend wees en ons moet verminder of voorstel op 'n manier wat makliker is om te verstaan en te kommunikeer. Statistiek gaan oor die opsom van data. Statistiese metodes stel ons in staat om die noodsaaklike inligting in 'n datastel voor te stel en die onbelangrike inligting ter syde te stel. Ons moet versigtig wees om seker te maak dat ons nie per ongelik sekere belangrike aspekte van die datastel uitlig en die data dus makliker maak om te interpreteer, deur statistiese metodes korrek toe te pas. Deur statistiek oneerlik of swak toe te pas kan ons belangrike inligting buite rekening laat en toe te laat dat mense foutiewe gevolgtrekkings maak. In hierdie hoofstuk gaan na 'n paar numeriese en grafiese metodes kyk waardeur data voorgestel kan word om die makliker te maak om te interpreteer.\par
...
\Definition{Data}{Data verwys na stukke inligting wat waargeneem en opgeteken in 'n eksperiment of opname. Data is die meervoud van die meervoud 'datum' en dus is dit 'n meervoudsvorm: in Engels s\^e ons 'the data are' en nie 'the data is' nie.}

Ons onderskei tussen twee soorte data: kwantitatiewe en kwalititiewe data.
...
\westep{Ondersoek die data en beantwoord die vraag}
  Die aantal sms-boodskappe is 'n getal, wat beteken die data is kwantitatief en diskreet.
}
\end{wex}

\begin{wex}{Kwalitatief of kwantitatief data}
...
\Definition{Gemiddelde}{Die gemiddelde word gedefinieer as die some van 'n stel data waardes, gedeel deur die aantal waardes in die som. 'n Horisontale strepie oor 'n veranderlike is die notasie wat gebruik word vir die gimiddelde van stel datawaardes. Die formule vir die gemiddelde van 'n datastel $\{x_1,
  x_2, \ldots, x_n\}$ is
  \begin{align*}
...
Die gemiddelde word soms die rekenkundige gemiddelde.
...
{Wat is die gemiddelde van die datastel $\{10;\ 20;\ 30;\ 40;\ 50\}$?}
{
  ...
  \westep{Deel die som deur die getal datapunte in die stel om die gimiddelde te kry}
...
\subsection{Mediaan}
\Definition{Mediaan}
{Die mediaan van 'n datastel is die waarde van die sentrale of middelste datapunt wanneer die datastel georden word van die kleinste tot die grootste waarde. Presies die helfte van die datawaardes is kleiner as die mediaan en die ander helfte is groter as die mediaan.}
...
{What is the median of $\{10;\ 14;\ 86;\ 2;\ 68;\ 99;\ 1\}$?}
{
  ...
  Daar is $7$ waardes in die datastel. Aangesien daar 'n onewe aantal datawaardes is, sal die mediaan gelyk wees aan die waarde in die middelste, dus $4^{\mathrm{de}}$ posisie. Die waarde in die $4^{\mathrm{th}}$ posisie is $14$ en dus is $14$ die mediaan van die datastel.
}
\end{wex}
...
{Wat is die mediaan van $\{11;\ 10;\ 14;\ 86;\ 2;\ 68;\ 99;\ 1\}$?}
{
  ...
  Daar is $8$ waardes in die datastel. Omdat daar 'n ewe aantal datawaardes is, sal die mediaan halfpad tussen die twee waardes in die middel wees. Dit is naamlik die $4^{\mathrm{th}}$ en $5^{\mathrm{th}}$ posisies. Die waarde in die 
  $4^{\mathrm{th}}$ posisie is $11$ en die waarde in die $5^{\mathrm{th}}$ posisie is
...
Om die modus te bereken, tel ons doodeenvoudig die aantal kere wat elke datawaarde in die datastel voorkom en vind so die waarde wat die meeste kere voorkom.
...
\begin{exercises}{}{
    ...
    \item  1. ’n Eksperiment is onderneem in die skool en $50$ leerders is gevra om te raai hoeveel lekkers daar in ’n bottel is. Die volgende raaiskote word aangeteken:
      \\
      \begin{center}
        \begin{tabular}{|c|c|c|c|c|c|c|c|c|c|} \hline
      ...
      \begin{enumerate}[noitemsep, label=\textbf{(\alph*)} ]
      \item
        Trek ’n gegroepeerde frekwensietabel op en gebruik die volgende intervalle
        $10 < x \leq 20$;\ $20 < x \leq 30$;\ $30 < x \leq 40$;\ 
        $40 < x \leq 50$;and \ $50 < x \leq 60$.
      \item (b) Trek ’n histogram om die frekwensietabel van die gegroepeerde data voor te stel.
      \end{enumerate}
    \end{enumerate}
\practiceinfo
\par 
...
Ons beramings van maatstawe van sentrale neiging sal verander as ons data groepeer omdat ons sekere inligting verloor wanneer ons data in klasse indeel. As ons slegs die gegroepeerde data het om mee te werk, het ons nie meer die gemete waardes van die data tot dieselfde vlak van akkuraatheid as vantevore nie. Die beste wat ons kan doen is om te aanvaar dat die waardes gegroepeer is in die middel van elke klas. As ons terugkyk na die vorige voorbeeld , sien ons ons het begin met ’n datastel van leerders se hoogtes
\begin{align*}
...
Die gemiddelde van hierdie data is $151,8$ en die mediaan is $152$. Die modus is $132$, maar onthou dat daar probleme is met die berekening van die modus van kontinue kwantitatiewe data. Na groepering van die data, het ons nou die datastel hieronder aangetoon. Let daarop dat elke datawaarde geplaas word in die middel van die klas en dat die aantal kere wat elke datawaarde herhaal word presies ooreenstem met die telling in elke klas. 
\begin{align*}
  \{&135;\ 135;\ 135;\ 135;\ 135;\ 135;\ 135;\ 145;\ 145;\ 145;\ 145;\ 145;\ 155;\ 155;\ 155;\\
    &155;\ 155;\ 155;\ 155;\ 165;\ 165;\ 165;\ 165;\ 165;\ 165;\ 165;\ 165;\ 165;\ 175;\ 175\}
\end{align*}
Die groepering verander die maatstawe van sentrale neiging aangesien elke datawaarde nou hanteer word asof dit geleë is in die middel van die klas waarin dit geplaas is. Die gemiddelde is nou $153$, die mediaan is $155$ en die modus is $165$. Dit is eintlik ’n beter benadering van die modus aangesien die groepering getoon het in watter klas die meeste leerderlengtes val. 
...
{Vind die variasiewydte van die volgende datastel:
  ...
  \westep{Vind die minimumwaarde}
  Die kleinste waarde in die datastel is $1$.

  \westep{Vind die maksimumwaarde}
  Die grootste waarde in die datastel is $10$.

  \westep{Trek die minimumwaarde af van die maksimumwaarde}
...
\Definition{Persentiele}{The $p^{\mathrm{th}}$ persentiel is die waarde, v , wat die datastel in twee verdeel op so ’n manier dat p persent van die waardes in die datastel minder is as v en $100-p$ persent groter is as v. Persentiele kan lê in die variasiewydte $0 \leq
  p \leq 100$.}

Om persentiele behoorlik te verstaan, moet ons onderskei tussen drie verskillende aspekte van ’n datapunt: sy waarde, sy rangorde (plek in die stel) en sy persentiel.
\begin{itemize}
...
\par
 ...
 Let daarop dat die rangorde die volgorde van die datapunte beskryf, van die kleinste tot die grootste. Byvoorbeeld, $13,0$ is by die $40^{\mathrm{th}}$ persentiel aangesien daar $2$ waardes is wat minder is as $13,0$ en $3$ waardes wat groter is as $13,0$. 
  \begin{equation*}
    \frac{2}{2+3} = 0,4 = 40\%
  \end{equation*}
% \end{example}

In die algemeen kan ons sê die formule vir die vind van die $p^{\mathrm{de}}$ persentiel in ’n geordende datastel met $n$ waardes, is: 
\begin{equation*}
...
Soms is die rangorde nie ’n heelgetal nie wat beteken die persentiel lê tussen twee waardes in die datastel. Die konvensie is om die waarde te neem halfpad tussen die twee waardes aangedui deur die rangorde.
 ...
 Die figuur hieronder toon die verwantskap tussen die rangorde en die persentiel grafies. Ons het reeds met drie persentiele te doen gekry: die mediaan ($50$ ste persentiel), die minimum ($0^{\mathrm{de}}$ persentiel) en die maksimum
...
{Pas die persentielformule toe en bepaal die minimum, maksimum en mediaanwaardes van die volgende datastel. 
  ...
  Heel eerste moet ons die datastel sorteer van die kleinste tot die grootste:
    ...
    Die maksimumwaarde is die laaste waarde in die geordende datastel en dit is ekwivalent aan die $100^{\mathrm{th}}$
    ...
    \begin{align*}
      r &= \frac{p}{100}\left(n-1\right)+1 \\
        ...
        &= 9
    \end{align*}
    Dit bevestig die maksimumwaarde is die laaste $9^{\mathrm{th}}$) waarde in die lys, naamlik $45$.

    \westep{Vind die mediaan}

    Die mediaan is ekwivalent aan die $50^{\mathrm{th}}$ persentiel. Met gebruik van die formule met $p=50$ en $n=9$, vind ons die rangorde van die mediaanwaarde as
    \begin{align*}
      r &= \frac{50}{100}\left(n-1\right)+1 \\
        ...
        &= 5
    \end{align*}
    Dit bevestig die mediaanwaarde is die middelste $5^{\mathrm{th}}$ waarde in die gesorteerde datastel, naamlik  $19$. 
}
\end{wex}

\Definition{Kwartiele}{Die kwartiele is die drie datawaardes wat die gesorteerde datastel in vier groepe verdeel, waar elk van die groepe ’n gelyke aantal datawaardes bevat. Die mediaan  ($50^{\mathrm{th}}$
  persentiel) is die tweede kwartiel. Die $25^{\mathrm{th}}$ persentiel word ook die onderste (laer) kwartiel genoem ($Q1$), en die $75^{\mathrm{th}}$ ersentiel, die boonste (ho\"er) kwartiel.
  quartile ($Q3$).}
...
{Bepaal die kwartiele van die volgende datastel:
    ...
    Met gebruik van die persentielformule, vind ons die rangordes van die $25^{\mathrm{th}}$,
    $50^{\mathrm{th}}$ en $75^{\mathrm{th}}$ persentiele as:
    \begin{align*}
    ...
    Vir die $25^{\mathrm{th}}$ persentiel is die rangorde $3,75$, tussen die $3^{\mathrm{rd}}$ en $4^{\mathrm{th}}$ waardes. Aangesien beide van hierdie waardes gelyk is aan 
    $7$, is die $25^{\mathrm{th}}$ persentiel $7$.

    Die rangorde vir die $50^{\mathrm{th}}$ persentiel (die mediaan) is $6,5$, halfpad tussen die  $6^{\mathrm{th}}$ en $7^{\mathrm{th}}$ waardes. Die $6^{\mathrm{th}}$ waarde is
    $11$ en die $7^{\mathrm{th}}$ waarde is $12$, wat beteken die mediaan is
    \(\frac{11+12}{2} = 11,5\).

    Die rangrode vir die $75^{\mathrm{th}}$ persentiel is die rangorde $9,25$, halfpad tussen die
    $9^{\mathrm{th}}$ en $10^{\mathrm{th}}$ waardes. Dus die $75^{\mathrm{th}}$ persentiel is
    \(\frac{31+35}{2} = 33\).
  }
\end{wex}
...
\vspace {8pt}\\
    ...
    \item In watter interval is die $30^{\mathrm{th}}$ persentiel van die datastel?
    \end{enumerate}
}{
  \westep{Bereken die gemiddelde}
 ...
 \mbox{gemiddelde } &=  \frac{
  ...
  $100$ leerders is om die rangorde van die $25^{\mathrm{th}}$, $50^{\mathrm{th}}$ en
  $75^{\mathrm{th}}$ persentiele te vind:
  \begin{align*}
  ...
  \westep{ Vind die $30^{\mathrm{th}}$ persentiel}

  Gebruik dieselfde metode as vir die kwartiele om die rangorde van die $30^{\mathrm{th}}$ persentiel te vind.
  \begin{align*}
  ...
  in die eerste vier intervalle , l\^e die $30^{\mathrm{th}}$ persentiel in die vierde interval $40 \leq x < 50$.
}
\end{wex}
...
$100^{\mathrm{th}}$ persentiel en die $0^{\mathrm{th}}$ persentiel (dit wil sê tussen die maksimum en die minimum waardes in die datastel).

\Definition{nterkwartielwydte}{Die interkwartielwydte is ’n maatstaf van spreiding wat bereken word deur die onderste (eerste) kwartiel ($Q1$) van die boonste (hoër) kwartiel ($Q3$). af te trek. Dit gee die wydte van die middelste helfte van die datastel.
}
...
\section{Kombinasie van verskillende maatstawe}
...
\par
Die vyf-getal opsomming bestaan uit die minimumwaarde, die maksimumwaarde en die drie kwartiele. Ons kan ook sê dit bestaan uit die $0^{\mathrm{th}}$,
$25^{\mathrm{th}}$, $50^{\mathrm{th}}$, $75^{\mathrm{th}}$, $100^{\mathrm{th}}$ persentiele.
...
\begin{figure}[t]
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw (3.5, 2.5) node[anchor=west] {($100^{\mathrm{th}}$ persentiel)};
      \draw (3.5, 1) node[anchor=west] {($75^{\mathrm{th}}$ persentiel)};
      \draw (3.5, 0) node[anchor=west] {($50^{\mathrm{th}}$ persentiel)};
      \draw (3.5, -1) node[anchor=west] {($25^{\mathrm{th}}$ persentiel)};
      \draw (3.5, -2.5) node[anchor=west] {($0^{\mathrm{th}}$ persentiel)};
      \draw[decoration={brace,amplitude=0.5em},decorate] (-0.7,-1) -- (-0.7,1);
      \draw (-0.7,0) node[anchor=east,xshift=-0.2cm] {interkwartiel wydte};
      \draw[decoration={brace,amplitude=0.5em},decorate] (-4.5,-2.5) -- (-4.5,2.5);
      \draw (-4.5,0) node[anchor=east,xshift=-0.2cm] {data wydte};
    \end{tikzpicture}
  \end{center}
...
{Trek ’n mond-en-snor grafiek van die volgende datastel:
  ...
  Die derde kwartiel lê tussen die $9^{\mathrm{th}}$ and $10^{\mathrm{th}}$ waardes en dit gee
 ...
 Dit gee die data vir die vyf-getal opsomming en die datastel stel ons in staat om die mond-en-snor grafiek te trek.
  ...
  \begin{center}
    \begin{tikzpicture}[yscale=1.25]
      \def\mediaan{3.65}
      \def\eerste kwartiel{2.5}
      \def\derde kwartie{4.775}
      \def\ minimum{1.25}
      \def\maksimum{5.1}
    ...
    \item Gebruik die diagram hieronder om die vyf-getal opsomming te bereken:
      ...
      \item \raisebox{-2cm}{
          \begin{tikzpicture}[xscale=0.4]
            \def\mediaan{25}
            \def\eerste kwartiel{22}
            \def\derde kwartiel{28}
            \def\minimum{15}
            \def\maksimum{35}
      ...
      \item \raisebox{-2cm}{
          \begin{tikzpicture}[xscale=0.667]
            \def\mediaan{98}
            \def\eerste kwartiel{92}
            \def\derde kwartiel{100}
            \def\minimum{88}
            \def\maksimum{101}
