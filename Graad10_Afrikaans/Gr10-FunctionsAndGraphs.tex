...
%english
\begin{wex}{Skets die grafiek van 'n cosinus funskie}
...
\begin{wex}{Skets die grafiek vir 'n tangens funskie}
...
\westep{Bereken $q$ om deur die $y$-afsnit te gebruik}
...
\westep{Los die vergelykings gelyktydig op om deur vervanging te gebruik}
\begin{eqnarray*}
  2 & = &-a+q \\
    & = & q+q \\
    & = & 2q \\
...
\westep{Los die vergelkyings gelyktydig op om deur vervanging te gebruik}
\begin{eqnarray*}
  \frac{3}{2}  &=& a + q \\
               &=& a + \frac{a}{2} \\
            3  &=& 2a + a \\
...
%lots of english
 \item Skets die grafieke van die volgende trigonometriese funksies as
    ...
    \end{enumerate}
  \item As die algemene vergelykings $y=mx+c$, $y=ax^2+q$, $y=\frac{a}{x}+q$, $y=a~sin~x+q$, $y=a^x +q$ en $y=a~tan~x$ gegewe is, bereken die spesifieke vergelykings vir elkeen van die volgende grafieke:\vspace{20pt}\\
    \begin{center}
      \begin{table}[H]
