...
\itemDie hoeveelheid geld wat jy het as ’n funksie van tyd. Hier is tyd die inset vir die funksie en die uitset is die bedrag geld. Jy sal op
...
\begin{array}{cccl}\hfill {x}^{2}& \ge & 0\hfill & (\mbox{die kwadraat van ’n uitdrukking is altyd positief})\hfill \\
 \hfill a{x}^{2}& \ge & 0\hfill & (\mbox{aangesien } a>0)\hfill \\
 \hfill a{x}^{2}+q& \ge & q\hfill & (\mbox{tel $q$ weerskante by.}) \\
...
Ons sien dat $a<0$.  Dit beteken dat die grafiek ’n maksimum draaipunt het. $-1 \lt a \lt 0$, dus die grafiek word 'uitwaarts' getrek
...
\nopagebreak\noindent{}
\begin{equation*}
\begin{array}{ccc}\hfill sin~\theta & =& cos~(\theta -90)(\mbox{skuif die } cos\mbox{ grafiek na die regterkant})\hfill \\
 & \mathbf{a}\mbox{and}& \\
