...
\end{center}
\end{figure}       
Om die formule vir gradi\"ent af te lei, dink ons aan ’n lyn met koördinate $A~(x_1;y_1)$ en $B~(x_2;y_2)$ met skuinssy $AB$, soos getoon die diagram hieronder.  
...
\end{center}
\end{figure}  
Dus, gradi\"ent word bereken met die volgende formule:
...
\usefont{T1}{ppl}{m}{n}
\rput(6.184531,-0.39671874){\small$x$}
\usefont{T1}{ppl}{m}{n}
\rput(3.4045312,3.4432812){\small$y$}
\usefont{T1}{ppl}{m}{n}
\rput(4.6745315,2.3832812){\footnotesize$B(2;6)$}
\usefont{T1}{ppl}{m}{n}
% \rput(2.8245313,-0.7967188){$0$}
\usefont{T1}{ppl}{m}{n}
\rput(3.52,0.32328126){\footnotesize$A(0;2)$}
\psline[linewidth=1pt](2.34,-2.8067188)(5.04,2.2532814)
\psdots[dotsize=0.12](3.0,0.39328125)
\usefont{T1}{ppl}{m}{n}
\rput(5.75,1.6432812){\small$y=2x-2$}
\end{pspicture} 
}
...
\begin{wex}{Loodregte lyne}{Lyn $AB$ is loodreg op lyn $CD$. Vind $y$ as gegee word $A(2;-3)$, $B(-2;6)$, $C(4;3)$ en $D(7;y)$.}{
\westep{Teken 'n skets}
\begin{center}
\scalebox{1} % Change this value to rescale the drawing.
{
...
\westep{Skryf die verband neer tussen die gradi\"ente van loodregte lyne $AB en CD $}
\begin{align*}
m_{AB} \times m_{CD} &= -1\\
...
\rput(3.2945313,2.5032814){$y$}
\usefont{T1}{ppl}{m}{n}
\rput(3.8445313,0.6){\small $B(0;5)$}
\usefont{T1}{ppl}{m}{n}
% \rput(2.8545313,-1.8767188){$0$}
\usefont{T1}{ppl}{m}{n}
\rput(0.77453125,-0.13671875){\small $A(-3;3)$}
\psdots[dotsize=0.12](1.53,-0.16671875)
\psdots[dotsize=0.12](3.01,0.8332813)
\usefont{T1}{ppl}{m}{n}
\rput(5.2,1.8832812){\small $C(3;7)$}
...
\end{wex}
\vspace*{-40pt}
\begin{wex}{Gebruik die middelpuntformule}{ Die lynstuk wat $C(-2;4)$ en $D(x;y)$ verbind, het middelpunt $M(1;-3)$. Vind punt $D$.\\}{
\westep{Maak 'n skets}
\begin{center}
\scalebox{1} % Change this value to rescale the drawing.
{
