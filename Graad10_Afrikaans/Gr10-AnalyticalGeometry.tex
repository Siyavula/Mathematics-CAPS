...
\Identity{\begin{center}{$\mbox{Afstand } d=\sqrt{{({x}_{1}-{x}_{2})}^{2}+{({y}_{1}-{y}_{2})}^{2}}$}\end{center}}
\par
Note that $(x_1 - x_2)^2 = (x_2 - x_1)^2$, but remember to be consistent or you will get the wrong answer. \\
...
\begin{equation*}
\left(\frac{6-5}{2};\frac{2-1}{2}\right) = \left(\frac{1}{2};\frac{1}{2}\right)
\end{equation*}
\westep{Write the final answer}
